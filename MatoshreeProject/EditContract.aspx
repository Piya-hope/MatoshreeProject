<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="EditContract.aspx.cs" Inherits="MatoshreeProject.EditContract" %>
            ...
            <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a class="text-muted text-decoration-none" href="Contract.aspx">Contract
                            </a>
                        </li>
                        <li class="breadcrumb-item text-muted" aria-current="page" href="EditContract.aspx">Edit Contract Customer</li>
                    </ol>
                </nav>
            </div>
            <%-- Toaster --%>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6">
                                <div class="mb-2">
                                    <asp:CheckBox ID="CheckHideCustomer" runat="server" Checked="false" Text="Hide From Customer"  />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <asp:DropDownList ID="ddlCustomer" runat="server" CssClass="form-control form-select" Placeholder="Select Customer"></asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFielddlCustomer" runat="server" ErrorMessage="Select Customer" ControlToValidate="ddlCustomer" ForeColor="Red" Font-Bold="false" ValidationGroup="Customer Contract" InitialValue="0" Display="Dynamic" Font-Size="12px"></asp:RequiredFieldValidator>
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldSubject" runat="server" ErrorMessage="Enter Contract Subject" ControlToValidate="txtSubject" ForeColor="Red" Font-Bold="false" ValidationGroup="Customer Contract" Font-Size="12px"></asp:RequiredFieldValidator>
                        </div>
                        ...
                        <div class="row">
                            <div class="mb-2">
                                <div class="input-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredContractValue" runat="server" ErrorMessage="Enter Contract Value" ControlToValidate="txtContractValue" ForeColor="Red" Font-Bold="false" ValidationGroup="Customer Contract" Font-Size="12px"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <asp:DropDownList ID="ddlContracttype" runat="server" CssClass="form-control form-select" Placeholder="Select Contract Type"></asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredddlContracttype" runat="server" ErrorMessage="Select Contract Type" ControlToValidate="ddlContracttype" ForeColor="Red" Font-Bold="false" ValidationGroup="Customer Contract" Font-Size="12px"></asp:RequiredFieldValidator>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <div class="mb-2">
                                    ...
                                    <asp:TextBox ID="txtEndDate" CssClass="form-control" Style="display: inline-block;" runat="server" placeholder="Enter End Date" ReadOnly="true"></asp:TextBox>
                        ...
                        <div class="mb-2">
                            <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="btn btn-sm btn-success" ValidationGroup="Customer Contract" OnClick="btnUpdate_Click" />
                            &nbsp;&nbsp;
                                ...
                                <div class="p-20">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12  text-end mt-3">
                                            ...
                                            <asp:LinkButton ID="Linkbtnprint" runat="server" CssClass="btn btn-sm btn-outline-dark" title="Print"> <iconify-icon icon="ph:printer"></iconify-icon></asp:LinkButton>
                                            &nbsp
                                      <asp:LinkButton ID="Linkbtnpdf" runat="server" CssClass="btn btn-sm btn-outline-danger" title="PDF" OnClick="Linkbtnpdf_Click"><iconify-icon icon="fa:file-pdf-o"></iconify-icon></asp:LinkButton>
                                            &nbsp 
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="table-responsive h-25">
                                                        <table class="table table-bordered" id="tblcontract" runat="server" visible="false">
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblfirstname" runat="server" Text="Contact Firstname" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lbllastname" runat="server" Text="Contact Lastname" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblnewpassurl" runat="server" Text="Set New Password Url" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblresetpassurl" runat="server" Text="Reset Password Url" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblemail" runat="server" Text="Contact Email" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblclientcompany" runat="server" Text="Client Company" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblphoneno" runat="server" Text="Client Phonenumber" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblclientcountry" runat="server" Text="Client Country" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblclientcity" runat="server" Text="Client City" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblclientzip" runat="server" Text="Client Zip" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblclientstate" runat="server" Text="Client State" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblclientaddress" runat="server" Text="Client Address" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblclientvatnumber" runat="server" Text="Client Vat Number" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblgstno" runat="server" Text="GST No" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblcontractid" runat="server" Text="Contract ID" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblcontractsub" runat="server" Text="Contract Subject" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblcontractdesc" runat="server" Text="Contract Description" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblcontractstartdate" runat="server" Text="Contract Date Start" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblcontractenddate" runat="server" Text="Contract Date End" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblkcontractvalue" runat="server" Text="Contract Value" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lbllogourl" runat="server" Text="Logo Url" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblCRMUrl" runat="server" Text="CRM Url" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lnlAdminUrl" runat="server" Text="Admin Url" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblMaindomain" runat="server" Text="Main Domain" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <asp:Label ID="lblEmailSignatuer" runat="server" Text="Email Signature" CssClass="form-label"></asp:Label>
                                                                </td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td class="text-left">
                                                                    <%--<asp:Label ID="Label27" runat="server" Text="clear" CssClass="form-label"></asp:Label>--%>
                                                                </td>
                                                                <td class="text-right">
                                                                    <asp:LinkButton ID="Linkclear" runat="server" Font-Size="12px" Text="{clear}" OnClick="Linkclear_Click"></asp:LinkButton>
                                                                </td>
                                                            </tr>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                            <div class="mb-2">
                                               ...
                                               <div class="mb-2">
                                           <asp:Label ID="lblCustomerFilename" runat="server" Text="" ForeColor="Blue" Font-Size="12px"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                                            <div class="mb-2">
                                                                ...
                                                                <asp:TextBox ID="txtNewStartDate" type="date" CssClass="form-control" Style="display: inline-block;" runat="server" placeholder="Enter New Start Date"></asp:TextBox>
