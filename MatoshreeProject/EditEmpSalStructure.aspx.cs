...
namespace MatoshreeProject
{
    ...
    public partial class EditEmpSalStructure : System.Web.UI.Page
    {
        ...
        public void ViewComponent()
        {
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                ...
                cmd.Parameters.AddWithValue("@StaffID", lblEmpID1.Text);
        ...
        public void GetProductDetails()
        {
            try
            {
                ...
                lblEmpID1.Text = StaffID;

                using (SqlConnection UserCon = new SqlConnection(strconnect))
                {
                    SqlCommand cmd = new SqlCommand("SP_GETDetailsStaffID", UserCon);
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        txtName.Text = dt.Rows[0]["StaffName"].ToString();
        ...
        protected void btnCalculateStructure_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (GridViewRow gridviedrow in GridViewComponent.Rows)
                {
                    ...
                    AmountAnnual = AnnualSalary * (Percentage / 100);
                    decimal roundedYearSal = Math.Round(Amount, 2);
                    lblAmountYr1.Text = Convert.ToString(roundedYearSal);
        ...
        protected void btnDeleteAnnualComp_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                GridViewRow row = (GridViewRow)btn.NamingContainer;
                int rowindex = Convert.ToInt32(row.RowIndex);
                string ComponentsID = ((Label)rows[rowindex].FindControl("lblCompnentsID1")).Text;
        ...
        {
            Response.Redirect("EmployeeSalDetails.aspx", true);
        }
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(strconnect))
                {
                    foreach (GridViewRow gridviedrow in GridViewComponent.Rows)
                    {
                        ...
                        cmd.Parameters.AddWithValue("@StaffID", lblEmpID1.Text);
                        cmd.Parameters.AddWithValue("@StaffDesignation", txtDepartment.Text);
                ...
                using (SqlConnection con1 = new SqlConnection(strconnect))
                {
                    foreach (GridViewRow gvrow in GridViewEmpCompansion.Rows)
                    {
                        ...
                        cmd1.Parameters.AddWithValue("@StaffID", lblEmpID1.Text);
                        cmd1.Parameters.AddWithValue("@StaffDesignation", lblDesignation.Text);
                ...
                using (SqlConnection con2 = new SqlConnection(strconnect))
                {
                    ...
                    Label lblAmounts2 = GridViewEmpCompansion.FooterRow.FindControl("lblAmounts2") as Label;
                    cmd2.Parameters.AddWithValue("@StaffID", lblEmpID1.Text);
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(strconnect))
                {
                    foreach (GridViewRow gridviedrow in GridViewComponent.Rows)
                    {
                        ...
                        SqlCommand cmd = new SqlCommand("SP_UpdateSalaryEmpComponent", con);
                        cmd.Connection = con;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@StaffID", lblEmpID1.Text);
                        cmd.Parameters.AddWithValue("@StaffDesignation", txtDepartment.Text);
                ...
                using (SqlConnection con1 = new SqlConnection(strconnect))
                {
                    foreach (GridViewRow gvrow in GridViewEmpCompansion.Rows)
                    {
                        ...
                        SqlCommand cmd1 = new SqlCommand("SP_UpdateSalaryEmpContribution", con1);
                        cmd1.Connection = con1;
                        cmd1.CommandType = CommandType.StoredProcedure;
                        cmd1.Parameters.AddWithValue("@StaffID", lblEmpID1.Text);
                        cmd1.Parameters.AddWithValue("@StaffDesignation", lblDesignation.Text);
                ...
                using (SqlConnection con2 = new SqlConnection(strconnect))
                {
                    SqlCommand cmd2 = new SqlCommand("SP_UpdateSalaryGrandTotal", con2);
                    cmd2.Connection = con2;
                    cmd2.CommandType = CommandType.StoredProcedure;
                    ...
                    if (i < 0)
                    {
                        ...
                        Response.Redirect("~/EmployeeSalDetails.aspx?edit1=" + edit + "", false);
