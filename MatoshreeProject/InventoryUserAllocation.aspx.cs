...
{
    public partial class InventoryUserAllocation : System.Web.UI.Page
    {
        ...
        protected void bindDepo()
        {
            try
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                {
                    ...
                    ddlDepo1.DataSource = ds.Tables[0];
                    ddlDepo1.DataTextField = "DepoName";
                    ddlDepo1.DataValueField = "DepoID";
                    ddlDepo1.DataBind();
                    ddlDepo1.Items.Insert(0, new System.Web.UI.WebControls.ListItem("Select Depo", "0"));
                }
            }
            catch (Exception ex)
            {
        ...
        public void Clear()
        {
            ...
            ddlDepo1.SelectedIndex = 0;
        }

        protected DataTable ViewStaffDetails()
        {
            DataTable table = new DataTable();
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                using (SqlDataAdapter ad = new SqlDataAdapter("SP_ViewStaffDetails", con))
                {
                    ad.Fill(table);
                    GridInventoryStaff.DataSource = table;
                    GridInventoryStaff.DataBind();
                }
            }
            return table;
        }

        protected DataTable ViewInvenoryStaffAllocationDetails()
        {
            DataTable table = new DataTable();
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                using (SqlDataAdapter ad = new SqlDataAdapter("SP_ViewInventoryDepoStaffAllocation", con))
                {
                    ad.Fill(table);
                    GridViewinventoryStaffMapping.DataSource = table;
                    GridViewinventoryStaffMapping.DataBind();
                }
            }
            return table;
        }

        public DataTable ViewInvenoryAllocationDetailsByStaff()
        {
            DataTable dt = new DataTable();
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                using (SqlDataAdapter ad = new SqlDataAdapter("SP_ViewInventoryDepoAllocationByStaff", con))
                {
                    ad.SelectCommand.CommandType = CommandType.StoredProcedure;
                    ad.SelectCommand.Parameters.AddWithValue("@DepoID", ddlDepo1.SelectedItem.Value);
                    ad.Fill(dt);
                    GridViewinventoryStaffMapping.DataSource = dt;
                    GridViewinventoryStaffMapping.DataBind();
                }
            }
            return dt;
        ...
        public DataTable ViewInvenoryAllocationDetailsByStatus()
        {
            DataTable dt = new DataTable();
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                using (SqlDataAdapter ad = new SqlDataAdapter("SP_ViewInventoryDepoStaffAllocationBystatus", con))
                {
                    ad.SelectCommand.CommandType = CommandType.StoredProcedure;
        ...
        public void StaffOperationPermission()
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(strconnect))
                {
                    ...
                    command.Parameters.AddWithValue("@SubModule", "UserDepoAllocation");
                    DataTable dt = new DataTable();
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (Globalview == "True")
                        {
                            bindDepo();
                            ViewStaffDetails();
                            ViewInvenoryStaffAllocationDetails();
        ...
        protected void GridInventoryStaff_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ViewInvenoryAllocationDetailsByStatus();
            }
            catch (Exception ex)
            {
                using (SqlConnection DeviceCon = new SqlConnection(strconnect))
        ...
        protected void GridViewinventoryStaffMapping_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    Label lblInventoryStaffName1 = (Label)e.Row.FindControl("lblInventoryStaffName1");
                    Label lblInventoryStaffPhonNo1 = (Label)e.Row.FindControl("lblInventoryStaffPhonNo1");
                    Label lblInventoryStaffEmail1 = (Label)e.Row.FindControl("lblInventoryStaffEmail1");
                    ...
                    Label lblInventoryStaffRole1 = (Label)e.Row.FindControl("lblInventoryStaffRole1");
                    if (lblInventoryStatus.Text == "True")
                    {
                        lblInventoryDepoName1.ForeColor = System.Drawing.Color.Blue;
                        lblInventoryStaffName1.ForeColor = System.Drawing.Color.Blue;
                        lblInventoryStaffPhonNo1.ForeColor = System.Drawing.Color.Blue;
                        lblInventoryStaffEmail1.ForeColor = System.Drawing.Color.Blue;
                        lblInventoryStaffRole1.ForeColor = System.Drawing.Color.Blue;
                    ...
                    else
                    {
                        ...
                        lblInventoryStaffName1.ForeColor = System.Drawing.Color.Red;
                        lblInventoryStaffPhonNo1.ForeColor = System.Drawing.Color.Red;
                        lblInventoryStaffEmail1.ForeColor = System.Drawing.Color.Red;
                        lblInventoryStaffRole1.ForeColor = System.Drawing.Color.Red;
        ...
        protected void lnkbtnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                DataTable dt = ViewInvenoryStaffAllocationDetails();
                if (dt != null && dt.Rows.Count > 0)
                {
                    Response.Clear();
                    Response.Buffer = true;
                    Response.ContentType = "application/ms-excel";
                    Response.AddHeader("Content-Disposition", "attachment;filename=StaffAllocationDtails.xls" + DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss") + ".xls");
        ...
        protected void Btn_Allocate_Click(object sender, EventArgs e)
        {
            try
            {
                foreach (GridViewRow gvrow in GridInventoryStaff.Rows)
                {
                    CheckBox chkInvStaff = (CheckBox)gvrow.FindControl("chkInvDepo");

                    if (chkInvStaff != null && chkInvStaff.Checked)
                    {
                        string MapID = GridInventoryStaff.DataKeys[gvrow.RowIndex].Value.ToString();
                        Label lblInventoryStaffID1 = (Label)gvrow.FindControl("lblInventoryStaffID1");

                        using (SqlConnection con = new SqlConnection(strconnect))
                        {
                            SqlCommand cmd = new SqlCommand("SP_AllocationStaffInventoryDepo", con);
                            cmd.Connection = con;
                            cmd.CommandType = CommandType.StoredProcedure;
                            ...
                            cmd.Parameters.AddWithValue("@StaffID", lblInventoryStaffID1.Text); // Assuming ddlProjects is declared in your markup
                            cmd.Parameters.AddWithValue("@Status", "true");
                            cmd.Parameters.AddWithValue("@StaffStatus", "true");
                            ...
                            if (Result > 0)
                            {
                                ...
                                lblMesDelete.Text = "Depo Allocated To Staff";
                            ...
                            else
                            {
                                Toasteralert.Visible = false;
                                deleteToaster.Visible = true;
                                lblMesDelete.Text = "Already Depo Allocated To Staff";
                ...
                foreach (GridViewRow gvrow in GridInventoryStaff.Rows)
                {
                    ...
                    if (chkInvStaff != null && chkInvStaff.Checked)
                    {
                        ...
                        using (SqlConnection con = new SqlConnection(strconnect))
                        {
                            ...
                            cmd.Parameters.AddWithValue("@DepoName", ddlDepo.SelectedItem.Text);
                            cmd.Parameters.AddWithValue("@DepoID", ddlDepo.SelectedItem.Value);
                            cmd.Parameters.AddWithValue("@StaffID", lblInventoryStaffID1.Text);
                            cmd.Parameters.AddWithValue("@Status", "false");
                            cmd.Parameters.AddWithValue("@StaffStatus", "false");
                            ...
                            if (Result > 0)
                            {
                                Toasteralert.Visible = false;
                                deleteToaster.Visible = true;
                                lblMesDelete.Text = "Depo Deallocated To Staff";
                              }
                            else
                            {
                                Toasteralert.Visible = false;
        ...
        protected void Btn_Search_Click(object sender, EventArgs e)
        {
            try
            {
                string Deponame = ddlDepo1.SelectedItem.Text;
                ...
                {
                    ViewInvenoryAllocationDetailsByStaff();
                }
        ...
        protected void linkbtnPDF_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
                {
                    ...
                    _document.Open();
                    _pdfPTable.SetWidths(new float[] { 4f, 11f, 11f, 12f, 11f, 11f, 14f, 8f });
                    ...
                    _fontStyle = FontFactory.GetFont("Arial", 14f, 2);
                    _pdfPCell = new PdfPCell(new Phrase("InventoryUserAllocationList", _fontStyle));
                    _pdfPCell.Colspan = 5;
                    ...
                    _Vhrlist = ViewInvenoryStaffAllocationDetails();
                    #region "Table Header"
                    ...
                    _fontStyle = FontFactory.GetFont("Tahoma", 9f, 1, BaseColor.WHITE);
                    _pdfPCell = new PdfPCell(new Phrase("PhoneNumber", _fontStyle));
                    _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                    _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                    _pdfPCell.BackgroundColor = BaseColor.GRAY;
                    _pdfPCell.ExtraParagraphSpace = 2;
                    ...
                    string PDFFileName = string.Format("InventoryUserAllocationList_" + dTime.ToString("dd/MM/yyyy HH:mm") + ".pdf");
                    Response.Clear();
