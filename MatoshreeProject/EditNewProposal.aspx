<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="EditNewProposal.aspx.cs" Inherits="MatoshreeProject.EditNewProposal" %>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                <h5 class="font-weight-medium mb-0">Edit Proposal</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-muted" aria-current="page" href="NewProposal.aspx">Edit Proposal</li>
                    </ol>
                </nav>
            </div>
            <%-- Toaster --%>
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 border-right">
                            ...
                            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
                                ...
                                <div class="mb-2">
                                    ...
                                    <asp:Label ID="lblInitialNumber" runat="server" Text="-" Font-Bold="true" CssClass="form-control text-purple" Visible="false"></asp:Label>
                                    <asp:Label ID="lblProposalID" runat="server" Text="" Font-Bold="true" CssClass="form-control text-purple" Visible="false"></asp:Label>
                                        ...
                                        <asp:GridView ID="GridProposal" runat="server" ScrollBars="Both" CssClass="table border table-bordered table-hover" AutoGenerateColumns="false" CellPadding="4"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-Width="60px">
                                                    ...
                                                    <FooterTemplate>
                                                        <asp:TextBox ID="txtRate" runat="server" Text="" CssClass="form-control" Placeholder="Rate" Font-Size="12px" Width="80px" AutoPostBack="true" OnTextChanged="txtRate_TextChanged1"></asp:TextBox>
                                                    </FooterTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                            ...
                                            <div class="row">
                                                <asp:Table ID="Table3" runat="server" CssClass="col-md-12 col-sm-12 col-lg-12">
                                                    <asp:TableRow ID="TableRow4" runat="server" class="mb-2">
                                                        ...
                                                        <asp:TableCell CssClass="col-md-2 col-sm-2 col-lg-2">
                                                            <asp:TextBox ID="txtDiscount1" Text="- 0.00" runat="server" AutoPostBack="true" OnTextChanged="txtDiscount1_TextChanged1" TextMode="Number" CssClass="form-control" placeholder="0.00" BorderColor="Blue" ValidationGroup="di"></asp:TextBox>
                                                        </asp:TableCell>
                                                        <asp:TableCell CssClass="col-md-2 col-sm-2 col-lg-2">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        ...
                        <div class="mb-2">
                            <asp:Button ID="btn_SubmitProposal" runat="server" Text="Update" CssClass="btn btn-sm btn-success" OnClick="btn_SubmitProposal_Click" ValidationGroup="Proposal" />
                            &nbsp;&nbsp;
