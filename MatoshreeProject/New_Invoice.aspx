<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="New_Invoice.aspx.cs" Inherits="MatoshreeProject.New_Invoice" %>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                <h5 class="font-weight-medium mb-0">New Invoice</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a class="text-muted text-decoration-none" href="Chart_List_Invoice.aspx">Invoices</a>
                        </li>
                        <li class="breadcrumb-item text-muted" aria-current="page" href="#">New Invoice</li>
                    </ol>
                </nav>
            </div>
            <%-- Toaster --%>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 border-right">
                            ...
                            <asp:Label ID="lblEstimateData" runat="server" Text="" Visible="false"></asp:Label>
                            <hr />
                            <asp:UpdatePanel ID="UpdatePanelddlState" runat="server">
                                <ContentTemplate>
                                    <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
                                        ...
                                        <div class="mb-2">
                                            <asp:RequiredFieldValidator ID="rfv_Customer" runat="server" ControlToValidate="ddlCustomers" ErrorMessage="Select Customer" ForeColor="Red" InitialValue="0" Display="Dynamic" ValidationGroup="Invoice1" Font-Size="12px"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
                                        <div class="mb-2">
                                            <asp:Label ID="lblProjects" runat="server" Text="Project" CssClass="form-label"></asp:Label>&nbsp;<span style="color: #FF0000">*</span>
                                    ...
                                    <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
                                        <asp:LinkButton ID="btnCopyAddresslink" runat="server" CssClass="btn btn-sm btn-outline-info" OnClick="btnCopyAddresslink_Click" ValidationGroup="copy1"><i class="ti ti-edit"></i></asp:LinkButton>
                                        <hr />
                                        <div class="row">
                            ...
                            <div id="Estmate1" runat="server" visible="false">
                                <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
                                    <div class="mb-2">
                                        <asp:Label runat="server" Text="Estimate Number" Font-Bold="true" CssClass="form-label"></asp:Label>&nbsp;<span style="color: #FF0000">*</span>
                                        <asp:Label ID="Label1" runat="server" Text="-" Font-Bold="true" CssClass="form-control text-primary" ReadOnly="true" Visible="false"></asp:Label>
                                        <asp:TextBox ID="txtEstimateNumber" runat="server" CssClass="form-control text-primary" ReadOnly="true"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfv_EstimateNumber" ControlToValidate="txtEstimateNumber" Display="Dynamic" runat="server" ErrorMessage="Enter Estimate Number" ForeColor="Red" ValidationGroup="Invoice1" Font-Size="12px"></asp:RequiredFieldValidator>
                                    </div>
                            ...
                            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
                                <div class="mb-2">
                                    <asp:Label runat="server" Text="Invoice Number" Font-Bold="true" CssClass="form-label"></asp:Label>&nbsp;<span style="color: #FF0000">*</span>
                                    <asp:Label ID="lblInitialNumber" runat="server" Text="-" Font-Bold="true" CssClass="form-control text-purple"></asp:Label>
                                    <asp:TextBox ID="txtInvoiceNumber" runat="server" CssClass="form-control text-purple" ReadOnly="true"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfv_InvoiceNumber" ControlToValidate="txtInvoiceNumber" Display="Dynamic" runat="server" ErrorMessage="Enter Invoice Number" ForeColor="Red" ValidationGroup="Invoice1" Font-Size="12px"></asp:RequiredFieldValidator>
                                </div>
                            ...
                            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
                                <div class="row">
                                    <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                                        <div class="mb-2">
                                            <asp:Label ID="lblInvoiceDate" runat="server" Text="Invoice Date" CssClass="form-label"></asp:Label>&nbsp;<span style="color: #FF0000">*</span>
                                            <asp:TextBox ID="txtInvoiceDate" type="date" CssClass="form-control" Style="display: inline-block;" runat="server"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="rtxt_InvoiceDueDate" ControlToValidate="txtInvoiceDate" Display="Dynamic" runat="server" ErrorMessage="Select Invoice Date" ForeColor="Red" ValidationGroup="Invoice1" Font-Size="12px"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                                        <div class="mb-2">
                        ...
                        <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                            ...
                            &nbsp;
                            <div class="row">
                                <asp:Label ID="lbl_PaymentMode" runat="server" Text="Allowed payment modes for this invoice" CssClass="form-label"></asp:Label>
                                <br />
                                <div class="mb-2">
                                    <asp:CheckBox ID="Cbx_Bank" Text="&nbsp;Bank" runat="server" Font-Size="12px" CssClass="text-dark" />&nbsp;&nbsp;
                                        <asp:CheckBox ID="Cbx_Cash" Text="&nbsp;Cash" runat="server" Font-Size="12px" CssClass="text-dark" />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
                                    <div class="mb-2">
                                        <asp:CheckBox ID="chkReminder" Text="" runat="server" />
                                        <asp:Label ID="Label3" runat="server" Text="Prevent sending overdue reminders for this invoice" CssClass="form-label"></asp:Label>&nbsp;
                                    </div>
                                </div>
                            </div>
                            <br />
                            <div class="row">
                                <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                                    ...
                                    <div class="mb-2">
                                        <asp:RequiredFieldValidator ID="rfv_Currency" runat="server" ControlToValidate="ddlCurrency" ErrorMessage="Select Currency" InitialValue="0" ForeColor="Red" Display="Dynamic" ValidationGroup="Invoice16" Font-Size="12px"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                                    <div class="mb-2">
                                        <asp:Label ID="lblSalesAgent" runat="server" Text="Sales Agent" CssClass="form-label"></asp:Label>&nbsp;<span style="color: #FF0000">*</span>
                                        <asp:DropDownList ID="ddlSalesAgent" runat="server" CssClass="form-control form-select" AutoPostBack="true" OnSelectedIndexChanged="ddlSalesAgent_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="mb-2">
                                        <asp:RequiredFieldValidator ID="RequiredFieldSalesAgent" runat="server" ControlToValidate="ddlSalesAgent" ErrorMessage="Sales Agent" InitialValue="0" ForeColor="Red" Display="Dynamic" ValidationGroup="Invoice1" Font-Size="12px"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                                    <div class="mb-2">
                                        <asp:Label ID="lblDiscountType" runat="server" Text="Discount Type" CssClass=" " Visible="false"></asp:Label>
                                        <asp:DropDownList ID="ddlDiscountType" runat="server" CssClass="form-control form-select" Visible="false">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderStyle-Width="130px">
                                                    ...
                                                    <FooterTemplate>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="rfv_InvoiceItem" ControlToValidate="txtItem" Display="Dynamic" runat="server" ErrorMessage="Select Item" ForeColor="Red"  Font-Size="12px"></asp:RequiredFieldValidator>
                                                    </FooterTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderStyle-Width="180px" ItemStyle-Width="200px">
                                                    ...
                                                    <FooterTemplate>
                                                        <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" Text="" CssClass="form-control" Placeholder="Long Description" Font-Size="12px"></asp:TextBox>
                                                         <asp:RequiredFieldValidator ID="rfv_InvoiceItemDescription" ControlToValidate="txtDescription" Display="Dynamic" runat="server" ErrorMessage="Select Item" ForeColor="Red"  Font-Size="12px"></asp:RequiredFieldValidator>
                                                    </FooterTemplate>
                                                </asp:TemplateField>
                                                 <asp:TemplateField>
                                                    <HeaderTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="GSTAmt" SortExpression="Tax1Amount" HeaderStyle-Font-Size="12px" HeaderStyle-Font-Bold="true">
                                                    ...
                                                    <FooterTemplate>
                                                        <asp:TextBox ID="txtTax1Rate1F" runat="server" Text="" CssClass="form-control" Placeholder="Rate" Font-Size="12px"></asp:TextBox>
                                                    </FooterTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderStyle-Width="120px">
                                                    <HeaderTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="GST2Amt" SortExpression="Tax2Amount" HeaderStyle-Width="90px" HeaderStyle-Font-Size="12px" HeaderStyle-Font-Bold="true">
                                                    ...
                                                    <FooterTemplate>
                                                        <asp:TextBox ID="txtTax2Rate1F" runat="server" Text="" CssClass="form-control" Placeholder="Rate"  Font-Size="12px"></asp:TextBox>
                                                    </FooterTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <FooterTemplate>
                                                        <asp:LinkButton ID="btnAddInvoiceItem" runat="server" CssClass="btn btn-sm btn-rounded btn-info" Text="" CausesValidation="true" OnClick="btnAddInvoiceItem_Click" TabIndex="9" ValidationGroup="ItemInvoice"><i class="ti ti-check"></i></asp:LinkButton>
                                                    </FooterTemplate>
                                                </asp:TemplateField>
                                            </Columns>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        ...
                        <div class="mb-2">
                            <asp:Button ID="btn_SubmitInvoice" runat="server" Text="Save" CssClass="btn btn-sm btn-primary" ValidationGroup="Invoice1" OnClick="btn_SubmitInvoice_Click" />
                            &nbsp;&nbsp;
                             <asp:Button ID="btnSaveAsDraft" runat="server" Text="Save As Draft" CssClass="btn btn-sm btn-dark" ValidationGroup="Draft" OnClick="btnSaveAsDraft_Click" />
                            &nbsp;&nbsp;
