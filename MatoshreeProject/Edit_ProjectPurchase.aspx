<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="Edit_ProjectPurchase.aspx.cs" Inherits="MatoshreeProject.Edit_ProjectPurchase" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <!-- Date pickper-->
    <link href="AMatrix/DatePicker/jquery.datepick.css" rel="stylesheet" />
    <!-- Datepcker js -->
    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script>
    <script src="AMatrix/DatePicker/jquery.plugin.js"></script>
    <script src="AMatrix/DatePicker/jquery.datepick.js"></script>
    <script>
        $(function () {
            $('#txtPurchaseDate').datepick();
        });
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <h5 class="font-weight-medium  mb-0">Edit Project Purchase</h5>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item text-muted" aria-current="page" href="Edit_ProjectPurchase.aspx">Edit Project Purchase</li>
            </ol>
        </nav>
        <br />
            ...
            <div class="row">
                <div class="col-md-5 col-sm-5 col-lg-5">
                    <div id="Div1" runat="server" visible="true">
                        <div class="card">
                            <div class="card-body">
                                <asp:Label ID="lbltestPurchase" runat="server" Text="" Visible="false"></asp:Label>
                                <asp:Label ID="lblBillNoretrive" runat="server" Text="" CssClass="" Visible="false"></asp:Label>
                                <div class="mb-2">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldPurchase" runat="server" ErrorMessage="Enter Purchase Name" ControlToValidate="txtPurchaseName" ForeColor="Red" Font-Bold="false" ValidationGroup="Purchase" Font-Size="12px"></asp:RequiredFieldValidator>
                                </div>
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                    <asp:Label ID="lblPurchaseDate" runat="server" Text="Purchase Date" CssClass="form-label"></asp:Label>&nbsp;<span style="color: #FF0000">*</span>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredPurchaseDate" runat="server" ErrorMessage="Enter Purchase Date" ControlToValidate="txtPurchaseDate" ForeColor="Red" Font-Bold="false" ValidationGroup="Purchase" Font-Size="12px"></asp:RequiredFieldValidator>
                                </div>
                                <div class="mb-2">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanelddlState" runat="server">
                                        <ContentTemplate>
                                            <div class="mb-2">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredCustomer" runat="server" ErrorMessage="Select Customer" ControlToValidate="ddlCustomer" ForeColor="Red" Font-Bold="false" ValidationGroup="Purchase" InitialValue="0" Display="Dynamic" Font-Size="12px"></asp:RequiredFieldValidator>
                                            </div>
                                            <div class="mb-2">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredProject" runat="server" ErrorMessage="Select Project" ControlToValidate="ddlProject" ForeColor="Red" Font-Bold="false" ValidationGroup="Purchase" InitialValue="0" Display="Dynamic" Font-Size="12px"></asp:RequiredFieldValidator>
                                            </div>
                                            <div class="mb-2">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredTender" runat="server" ErrorMessage="Select Tender" ControlToValidate="ddlTenderNumber" ForeColor="Red" Font-Bold="false" ValidationGroup="Purchase" InitialValue="0" Display="Dynamic" Font-Size="12px"></asp:RequiredFieldValidator>
                                            </div>
                                            <div class="mb-2">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Select WorkOrder" ControlToValidate="ddlWorkOrderNumber" ForeColor="Red" Font-Bold="false" ValidationGroup="Purchase" InitialValue="0" Display="Dynamic" Font-Size="12px"></asp:RequiredFieldValidator>
                                            </div>
                                                ...
                                                <div class="mb-2">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <asp:Label ID="lblGstNo1" runat="server" Text="" Font-Size="12px"></asp:Label>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <asp:Label ID="lblVenAddress" runat="server" Text="Address:" CssClass="form-label"></asp:Label>
                                                            <asp:Label ID="lblVenAddress1" runat="server" Text="" Font-Size="12px"></asp:Label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="mb-2">
                                    <asp:Button ID="btnUpdatePurchase" runat="server" Text="Update" CssClass="btn btn-sm btn-success" ValidationGroup="Purchase" OnClick="btnUpdatePurchase_Click" />
                                    &nbsp;&nbsp;
                ...
                <div class="col-md-7 col-sm-7 col-lg-7">
                    <div id="itemtable" runat="server" visible="true">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-lg-12">
                                        <asp:Label ID="Label1" runat="server" Text="" CssClass="form-label" Visible="false"></asp:Label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-lg-12">
                                                <asp:GridView ID="GridExpensesFile" runat="server" ScrollBars="Both" CssClass="table border table-responsive table-bordered table-hover text-nowrap align-content-center" AutoGenerateColumns="false" CellPadding="4" Style="width: 100%"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField Visible="false">
                                                            <HeaderTemplate>
                                                                <asp:Label ID="lblExpensesFileId" runat="server" Text="FileName" CssClass="form-label" Visible="false"></asp:Label>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
