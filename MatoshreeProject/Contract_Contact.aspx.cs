...
{
    public partial class Contract_Contact : System.Web.UI.Page
    {
        ...
        //------------------------Employee ID-------------------------------//
        public DataTable BindGVContractContact(int UserID)
        {
            DataTable table = new DataTable();
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                SqlCommand cmd = new SqlCommand("SP_ViewContractPartnerByEmpID", con);
                ...
                ViewState["ContractPartnerData"] = table;
            }
            return table;
        }

        public void BindContractPartnerCountsbyEmpID(int UserID)
        {
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                SqlCommand command = new SqlCommand("SP_ContractsPartnerCountByEmpID", con);
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        lblActiveContractCount.Text = reader["ActiveContractsCount"].ToString();
                        lblExpiredContractCount.Text = reader["ExpiredContractsCount"].ToString();
                        lblAboutExpiredContractCount.Text = reader["AboutToExpireContractsCount"].ToString();
                        lblRecentContractCount.Text = reader["RecentlyAddedContractsCount"].ToString();
                    }
                }
        ...
        //-----------------------------------------------------------------------//
        public void BindContractPartnerCounts()
        {
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                SqlCommand command = new SqlCommand("SP_ContractsPartnerCount", con);
                command.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable BindGVContractContact()
        {
            ...
            try
            {
                ...
                {                  
                    SqlCommand cmd = new SqlCommand("SP_ViewContractPartner", UserCon);
                    cmd.CommandType = CommandType.StoredProcedure;
                    SqlDataAdapter adpt = new SqlDataAdapter(cmd);
                    adpt.Fill(dt);
                    GridviewContract1.DataSource = dt;
                    GridviewContract1.DataBind();
                    ViewState["ContractPartnerData"] = dt;
                }
                return dt;
            }
            catch (Exception ex)
        ...
        public void BindContractspartnerByTypeChart()
        {
            try
            {
                using (SqlConnection con1 = new SqlConnection(strconnect))
                {
                    SqlCommand command1 = new SqlCommand("SP_ViewContractPartnerDetailsLineChart", con1);
                    command1.CommandType = CommandType.StoredProcedure;
                    Series series1 = Chart2.Series["ContractsByType"];
                    con1.Open();
                    SqlDataReader rdr1 = command1.ExecuteReader();
                    while (rdr1.Read())
                    {
                        series1.Points.AddXY(rdr1["Contractype"].ToString(), rdr1["ContractValue"]);
                    }
        ...
        public void StaffOperationPermission()
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(strconnect))
                {
                    ...
                    command.Parameters.AddWithValue("@SubModule", "Partner Contract");
                    DataTable dt = new DataTable();
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (Globalview == "True")
                        {
                            BindGVContractContact();
                            BindContractPartnerCounts();
                            BindContractspartnerByTypeChart();
                        ...
                        {
                            BindGVContractContact(UserId);
                            BindContractPartnerCountsbyEmpID(UserId);
                            BindContractspartnerByTypeChart();
        ...
        public void GetMessageFromModules()
        {
            try
            {
                ...
                if (MSGdata == "fgsave123q" && EdidDATA == null)
                {
                    ...
                    lblMessage.Text = "Contract Partner Details Save Successfully";
                }
                else if (EdidDATA == "xcvfedit" && MSGdata == null)
                {
                    Toasteralert.Visible = true;
                    lblMessage.Text = "Contract Partner Details Edit Successfully";
                }
        ...
        protected void btnNewContractCustomer_Click(object sender, EventArgs e)
        {
            Response.Redirect("New_ContractContact.aspx");
        }

        protected void LinkEditContract_Click1(object sender, EventArgs e)
        {
            try
            {
                string ID;
                ...
                Response.Redirect("~/Edit_ContractContact.aspx?ID=" + ID + "", false);
            }
            catch (Exception ex)
            {
                using (SqlConnection DeviceCon = new SqlConnection(strconnect))
        ...
        protected void lnkbtnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    DataTable dt = BindGVContractContact();
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        Response.Clear();
                        Response.Buffer = true;
                        Response.ContentType = "application/ms-excel";
                        Response.AddHeader("Content-Disposition", "attachment;filename=Contract_Partner_Details.xls");
                        Response.Charset = " ";
                        ...
                        foreach (DataRow row in dt.Rows)
                        {
                            ...
                            newRow["Partner"] = row["PartnerName"];
                ...
                {
                    DataTable dt = (DataTable)ViewState["ContractPartnerData"];
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        Response.Clear();
                        Response.Buffer = true;
            ...
            try
            {
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    ...
                    using (SqlConnection UserCon = new SqlConnection(strconnect))
                    {
                        ...
                        SqlCommand cmd = new SqlCommand("SP_ViewContractPartnerStatus1", con);
                        cmd.CommandType = CommandType.StoredProcedure;
                        SqlDataAdapter adpt = new SqlDataAdapter(cmd);
                        adpt.Fill(dt);
                        GridviewContract1.DataSource = dt;
            ...
            try
            {
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    ...
                    using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
                    {
                        ...
                        _fontStyle = FontFactory.GetFont("Arial", 14f, 2);
                        _pdfPCell = new PdfPCell(new Phrase("ContractPartnerList", _fontStyle));
                        _pdfPCell.Colspan = 6;
                        ...
                        _Vhrlist = BindGVContractContact();
                        #region "Table Header" 
                        ...
                        _fontStyle = FontFactory.GetFont("Tahoma", 9f, 1, BaseColor.WHITE);
                        _pdfPCell = new PdfPCell(new Phrase("Partner", _fontStyle));
                        _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                        _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                        _pdfPCell.BackgroundColor = BaseColor.GRAY;
                        _pdfPCell.ExtraParagraphSpace = 2;
                        ...
                        foreach (DataRow row in _Vhrlist.Rows)
                        {
                            ...
                            _pdfPCell = new PdfPCell(new Phrase(row["PartnerName"].ToString(), _fontStyle));
                            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                            _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                            _pdfPCell.BackgroundColor = BaseColor.WHITE;
                            _pdfPCell.ExtraParagraphSpace = 1;
                        ...
                        string PDFFileName = string.Format("ContractPartnerList_" + dTime.ToString("dd/MM/yyyy HH:mm") + ".pdf");
                        Response.Clear();
                ...
                else if (RoleType == Designation)
                {
                    ...
                    using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
                    {
                        ...
                        DataTable _Vhrlist = new DataTable();
                        _Vhrlist = (DataTable)ViewState["ContractPartnerData"]; ;
                        #region "Table Header" 
        ...
        protected void btnDeleteContract_Click1(object sender, EventArgs e)
        {
            try
            {
                RoleType = Session["LoginType"].ToString();
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    using (SqlConnection UserCon = new SqlConnection(strconnect))
                    {
                        ...
                        ID = ((Label)rows[rowindex].FindControl("lblContracttypeID1")).Text;
                        SqlConnection con = new SqlConnection(strconnect);
                        SqlCommand cmd = new SqlCommand("SP_DeleteContractPartnerDetails1", con);
                        cmd.CommandType = CommandType.StoredProcedure;
                        ...
                        if (i < 0)
                        {
                            ...
                            lblMesDelete.Text = "Contract Partner Details Deleted Successfully";
                            BindGVContractContact();
                            BindContractPartnerCounts();
                            BindContractspartnerByTypeChart();
                        }
                        else
                        {
                            Toasteralert.Visible = false;
                            deleteToaster.Visible = true;
                            lblMesDelete.Text = "Contract Partner Details Not Deleted Successfully";
                        }            
                    }
                }
                else if (RoleType == Designation)
                {
                    using (SqlConnection UserCon = new SqlConnection(strconnect))
                    {
                        ...
                        ID = ((Label)rows[rowindex].FindControl("lblContracttypeID1")).Text;
                        SqlConnection con = new SqlConnection(strconnect);
                        SqlCommand cmd = new SqlCommand("SP_DeleteContractPartnerDetails1ForEmpID", con);
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@id", ID);
                        cmd.Parameters.AddWithValue("@add_by", UserName);
                        cmd.Parameters.AddWithValue("@UserID", UserId);
            ...
            try
            {
                foreach (GridViewRow gridviedrow in GridviewContract1.Rows)
                {
                    ...
                    if (status == "True")
                    {
                        ...
                        lblPartnerName1.ForeColor = Color.Black;
