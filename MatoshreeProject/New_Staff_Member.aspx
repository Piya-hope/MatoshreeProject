<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="New_Staff_Member.aspx.cs" Inherits="MatoshreeProject.New_Staff_Member1" EnableEventValidation="false" ValidateRequest="false" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                <h5 class="font-weight-medium mb-0">New Staff</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a class="text-muted text-decoration-none" href="Setup_StaffDetails.aspx">Staff Details
                            </a>
                        </li>
                        <li class="breadcrumb-item text-muted" aria-current="page" href="#">New Staff</li>
                    </ol>
                </nav>
            </div>
            <%-- Toaster --%>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                            <div class="mb-2">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please Enter E-mail" Display="Dynamic" ControlToValidate="txt_Email" ForeColor="Red" ValidationGroup="Save" Font-Size="12px"></asp:RequiredFieldValidator>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                            <div class="mb-2">
                                                ...
                                                <asp:TextBox ID="txt_Phone" runat="server" Placeholder="Enter the phone " CssClass="form-control" MaxLength="10"></asp:TextBox>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                            <div class="mb-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <asp:LinkButton ID="LinkBtnEyesPassword" runat="server" CssClass="btn btn-sm btn-purple" ForeColor="Black"><i class="ti ti-eye"></i></asp:LinkButton>
                                                    <asp:LinkButton ID="LinkbtnResetPassword" runat="server" ForeColor="Black" ValidationGroup="String" CssClass="btn btn-sm btn-secondary" OnClick="LinkbtnResetPassword_Click"><iconify-icon icon="mdi:circle-arrows" class="icon-section"></iconify-icon></asp:LinkButton>
                                                </div>

                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_Password" ForeColor="Red" Display="Dynamic" ErrorMessage="Enter Password." ValidationGroup="Save" Font-Size="12px" />
                                            </div>

                                        </div>
                                        <br />
                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                            <asp:CheckBox ID="CheckBoxSendEmail" runat="server" Text="Send welcome email" CssClass=" font-bold" AutoPostBack="true" OnCheckedChanged="CheckBoxSendEmail_CheckedChanged" />
                                        </div>
                                        <br />
                                ...
                                <div class="p-20">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanelddlState" runat="server">
                                        <ContentTemplate>
                                            <div class="row">
                                                <div class="mb-2">
                                                    <asp:Label ID="Label11" runat="server" Text="Role" CssClass="form-label"></asp:Label>&nbsp;<span id="ctlRole" style="color: red;">*</span>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldRoleType" runat="server" ControlToValidate="ddlRoleType" ErrorMessage="Select Role"
                                                        Display="Dynamic" ForeColor="Red" ValidationGroup="Save" InitialValue="0" Font-Size="12px"></asp:RequiredFieldValidator>
                                                </div>
                                            </div>
                                            <hr />
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-lg-12">
                                                    <div class="mb-2">
                                                        <asp:GridView ID="GridRole" AutoGenerateColumns="false" CssClass="table table-bordered table-responsive" runat="server" OnRowDataBound="GridRole_RowDataBound" ShowHeaderWhenEmpty="true" Style="width: 100%">
                                                            <Columns>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="mb-2">
                                        ...
                                        <asp:Button ID="btn_Close" runat="server" Text="Clear" CssClass="btn btn-sm btn-danger" OnClick="btn_Close_Click" />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <asp:Label ID="lblStaffID" runat="server" Text="0" Visible="false"></asp:Label>

                                <asp:Button ID="btn_New_Item" runat="server" Text="New Note" CssClass="btn btn-sm btn-primary col-sm-2" ValidationGroup="note" OnClick="btn_New_Item_Click1" />
                                ...
                                <br />
                                    <br />
                                    <asp:TextBox ID="txt_Note_description" runat="server" TextMode="MultiLine" CssClass="form-control" Visible="false"></asp:TextBox>
                                    <br />
                                ...
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="mb-2">
                                        <div class="table-responsive">
                                            <asp:GridView ID="GridViewNote" AutoGenerateColumns="false" CssClass="table table-bordered table-responsive" runat="server" Style="width: 100%" ShowHeaderWhenEmpty="true">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Note" HeaderStyle-Font-Size="12px">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblNote" Text='<%#Eval("Note")%>' runat="server" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="AddedForm" HeaderStyle-Font-Size="12px">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblAddedForm" Text='<%#Eval("Createby")%>' runat="server" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="DateAdded" HeaderStyle-Font-Size="12px">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDateAdded" Text='<%#Eval("CreateDate","{0:dd/MM/yyyy}")%>' runat="server" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="mb-2">
                                    <asp:Label ID="Label12" runat="server" Text="LogIn Status" CssClass="form-label"></asp:Label>
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12">
                            <div class="table-responsive">
                                <asp:GridView ID="GridStaffLogIn" AutoGenerateColumns="false" CssClass="table table-bordered table-responsive" runat="server" OnRowDataBound="GridStaffLogIn_RowDataBound" Style="width: 100%" ShowHeaderWhenEmpty="true">
                                    <Columns>
                                        <asp:TemplateField HeaderText="ID" HeaderStyle-Font-Size="12px">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRowNumber" Text='<%# Container.DataItemIndex + 1 %>' runat="server" Visible="false" Font-Size="12px" />
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-lg-12">
                                <div class="mb-2">
                                    <div class="table-responsive">
                                        <asp:GridView ID="GridStaffProject" AutoGenerateColumns="false" CssClass="table table-bordered table-responsive" runat="server" OnRowDataBound="GridStaffProject_RowDataBound" Style="width: 100%" ShowHeaderWhenEmpty="true">
                                            <Columns>
                                                <asp:TemplateField HeaderText="ID" HeaderStyle-Font-Size="12px">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="View" HeaderStyle-Font-Size="12px">
                                                    <ItemTemplate>
                                                        <asp:Button ID="btnDisAllocateProject" runat="server" Text="DeAllocate" CssClass="btn btn-sm btn-danger" OnClick="btnDisAllocateProject_Click" Visible="false" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
