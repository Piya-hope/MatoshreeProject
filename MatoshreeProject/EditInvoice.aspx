<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="EditInvoice.aspx.cs" Inherits="MatoshreeProject.EditInvoice" %>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                    <h5 class="font-weight-medium mb-0">Edit Invoice</h5>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a class="text-muted text-decoration-none" href="Chart_List_Invoice.aspx">Invoice
                                </a>
                            </li>
                            <li class="breadcrumb-item text-muted" aria-current="page" href="EditInvoice.aspx">Edit Invoice</li>
                        </ol>
                    </nav>
                </div>
                <%-- Toaster --%>
            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <asp:Label ID="lblSAveAS" runat="server" Text="" Visible="false"></asp:Label>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-lg-6 border-right">
                                ...
                                <asp:Label ID="lblInvID" runat="server" Text="" Visible="false"></asp:Label>
                                <hr />
                                <asp:UpdatePanel ID="UpdatePanelddlState" runat="server">
                                    <ContentTemplate>
                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                            ...
                                            <div class="mb-2">
                                                <asp:RequiredFieldValidator ID="rfv_Customer" runat="server" ControlToValidate="ddlCustomers" ErrorMessage="Select Customer" ForeColor="Red" Display="Dynamic" ValidationGroup="updateInvoice" Font-Size="12px"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                            <div class="mb-2">
                                            ...
                                            <div class="mb-2">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlProjects" ErrorMessage="Select Project" ForeColor="Red" Display="Dynamic" ValidationGroup="updateInvoice" Font-Size="12px"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                ...
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="mb-2">
                                        ...
                                        <asp:Label ID="lblInitialNumber" runat="server" Text="-" Font-Bold="true" CssClass="form-control text-purple col-1 col-md-1" ReadOnly="true" Visible="false"></asp:Label>
                                        <asp:TextBox ID="txtInvoiceNumber" runat="server" CssClass="form-control text-purple col-md-11" ReadOnly="true"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfv_InvoiceNumber" ControlToValidate="txtInvoiceNumber" Display="Dynamic" runat="server" ErrorMessage="Please Enter Invoice Number" ForeColor="Red" ValidationGroup="updateInvoice" Font-Size="12px"></asp:RequiredFieldValidator>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                            <div class="mb-2">
                                                ...
                                                <asp:RequiredFieldValidator ID="rtxt_InvoiceDueDate" ControlToValidate="txtInvoiceDate" Display="Dynamic" runat="server" ErrorMessage="Please Select Invoice Date" ForeColor="Red" ValidationGroup="updateInvoice" Font-Size="12px"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                            <div class="mb-2">
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-lg-6">
                                        <div class="mb-2">
                                            <asp:Label ID="lblCurrency" runat="server" Text="Currency" CssClass="form-label"></asp:Label><span class="text-danger"> *</span>
                                        ...
                                        <div class="mb-2">
                                            <asp:RequiredFieldValidator ID="rfv_Currency" runat="server" ControlToValidate="ddlCurrency" ErrorMessage="Please Select Currency..." InitialValue="0" ForeColor="Red" Display="Dynamic" ValidationGroup="updateInvoice" Font-Size="12px"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-lg-6">
                                        <div class="mb-2">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-lg-12">
                                        <div class="alert alert-warning" role="alert" id="msgdiv" runat="server" visible="false">
                                            <asp:Label ID="lblMsg1" runat="server" Text="" Visible="false" Font-Bold="false" Font-Size="12px" ForeColor="Red"></asp:Label>
                                        </div>
                                        <div class="alert alert-info" role="alert" id="SuccessDiv1" runat="server" visible="false">
                                            <asp:Label ID="lblMsg" runat="server" Text="" Visible="false" Font-Bold="false" Font-Size="12px" ForeColor="Blue"></asp:Label>
                                        </div>
            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12">
                            <div class="mb-2">
                                <asp:Button ID="btn_UpdateInvoice" runat="server" Text="Update" CssClass="btn btn-sm btn-success" ValidationGroup="updateInvoice1" OnClick="btn_UpdateInvoice_Click" />
                                &nbsp;&nbsp;
                           
                               <asp:Button ID="btnClose" runat="server" Text="Cancel" CssClass="btn btn-sm btn-danger" ValidationGroup="Clear" OnClick="btnClose_Click" />
                                &nbsp;&nbsp;

                             <asp:Button ID="btnConvertDraft" runat="server" Text="Saved" CssClass="btn btn-sm btn-info" ValidationGroup="draft1" OnClick="btnConvertDraft_Click" />
                                &nbsp;&nbsp;
                            </div>
                        </div>
                    </div>
