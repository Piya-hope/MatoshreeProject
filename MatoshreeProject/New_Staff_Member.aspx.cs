...
{
    public partial class New_Staff_Member1 : System.Web.UI.Page
    {
                ...
                using (SqlConnection con1 = new SqlConnection(strconnect))
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        foreach (GridViewRow gridviedrow in GridViewNote.Rows)
                        {
                            ...
                            Button btnEditNote = (Button)gridviedrow.FindControl("btnEditNote");
                            Button btnDeleteNote = (Button)gridviedrow.FindControl("btnDeleteNote");
        ...
        public void GetRolePagesPermission()
        {
            try
            {
        ...
        public void ClearAll()
        {
            try
            {
                ...
                ddlDeptStaffName.SelectedIndex = 0;
        ...
        protected void btn_Save_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("SP_SaveStaffDetails", con);
                    cmd.Connection = con;
                    cmd.CommandType = CommandType.StoredProcedure;
                    ...
                    cmd.Parameters.AddWithValue("@AdminId", RoleAdmin);
                    ...
                    if (count > 0)
                    {
                        foreach (GridViewRow gvrow in GridRole.Rows)
                        {
                            ...
                            using (SqlConnection con1 = new SqlConnection(strconnect))
                            {
                                SqlCommand cmd1 = new SqlCommand("SP_SaveStaffWebAccess", con);
                                cmd1.Connection = con;
                    ...
                    if (Result > 0)
                    {
                        ...
                        Response.Redirect("~/Setup_StaffDetails.aspx?svd1=" + save + "", false);
                        ClearAll();
                    }
                    else
                    {
                        ...
                        lblMesDelete.Text = "Staff Details already Available";
        ...
        protected void btn_Close_Click(object sender, EventArgs e)
        {
            ...
            {
                ClearAll();
                // Response.Redirect("Setup_Staff.aspx");
            }
            catch (Exception ex)
            {
                using (SqlConnection DeviceCon = new SqlConnection(strconnect))
        ...
        protected void btnDeleteNote_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Note = ((Label)rows[rowindex].FindControl("lblNote")).Text;
                if (tableID == "")
                {
