...
namespace MatoshreeProject
{
    public partial class Tender : System.Web.UI.Page
    {
        ...
        public void TenderCountEmpID(int UserID)
        {
            try
            {
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetTenderNotPublishCountBYEmpID", con);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@EmpID", UserID);
                    int NotPublishedCount = (int)command.ExecuteScalar();

                    lblNotPublishCount.Text = Convert.ToString(NotPublishedCount);
                }

                using (SqlConnection con1 = new SqlConnection(strconnect))
                {
                    con1.Open();
                    SqlCommand command = new SqlCommand("SP_GetTenderPublishCountByEmpID", con1);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@EmpID", UserID);
                    int PublishCount = (int)command.ExecuteScalar();

                    lblPublishCount.Text = Convert.ToString(PublishCount);
                }

                using (SqlConnection con2 = new SqlConnection(strconnect))
                {
                    con2.Open();
                    SqlCommand command = new SqlCommand("SP_GetTenderAllocatedCountEmpID", con2);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@EmpID", UserID);
                    int AllocatedCount = (int)command.ExecuteScalar();

                    lblAllocateCount.Text = Convert.ToString(AllocatedCount);
                }

                using (SqlConnection con2 = new SqlConnection(strconnect))
                {
                    con2.Open();
                    SqlCommand command = new SqlCommand("SP_GetTenderCancelCountEmpID", con2);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@EmpID", UserID);
        ...
        public void TenderCount()
        {
            try
            {
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetTenderNotPublishCount", con);
                    command.CommandType = CommandType.StoredProcedure;
                    int NotPublishedCount = (int)command.ExecuteScalar();
                ...
                {
                    con1.Open();
                    SqlCommand command = new SqlCommand("SP_GetTenderPublishCount", con1);
                    command.CommandType = CommandType.StoredProcedure;
                    int PublishCount = (int)command.ExecuteScalar();
                ...
                {
                    con2.Open();
                    SqlCommand command = new SqlCommand("SP_GetTenderAllocatedCount", con2);
                    command.CommandType = CommandType.StoredProcedure;
                    int AllocatedCount = (int)command.ExecuteScalar();
                ...
                {
                    con2.Open();
                    SqlCommand command = new SqlCommand("SP_GetTenderCancelCount", con2);
                    command.CommandType = CommandType.StoredProcedure;
                    int CanceledCount = (int)command.ExecuteScalar();
        ...
        public DataTable ViewTenderDetailsByEmpID(int UserID)
        {
            ...
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                SqlCommand cmd = new SqlCommand("SP_TenderDetailsByEmpID", con);
        ...
        //--------------------------------------------------------------------------------//
        public DataTable ViewTenderDetails()
        {
            DataTable table = new DataTable();
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                using (SqlDataAdapter ad = new SqlDataAdapter("SP_TenderDetails", con))
                {
                    ad.Fill(table);
                    GridTender.DataSource = table;
                    GridTender.DataBind();
        ...
        public void GetMessageFromModules()
        {
            try
            {
                ...
                if (MSGdata == "fgsave123q" && EdidDATA == null)
                {
                    ...
                    lblMessage.Text = "Tender Details Save Successfully";
                }
                else if (EdidDATA == "xcvfedit" && MSGdata == null)
                {
                    Toasteralert.Visible = true;
                    lblMessage.Text = "Tender Details Edit Successfully";
                }
        ...
        protected void Btn_Visibility_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    ...
                    using (SqlConnection con = new SqlConnection(strconnect))
                    {
                        using (SqlDataAdapter ad = new SqlDataAdapter("[SP_TenderDetailsVisibility]", con))
                        {
                            ad.Fill(table);
                            GridTender.DataSource = table;
                            GridTender.DataBind();
        ...
        protected void lnkbtnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    DataTable dt = ViewTenderDetails();
