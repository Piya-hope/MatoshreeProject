    ...
    public partial class Staff_Expenses : System.Web.UI.Page
    {
        ...
        public void ExpensesCount()
        {
            try
            {
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetTotalAmountStaffExpenses", con);
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetRegularTypeStaffExpenses", con);
                    command.CommandType = CommandType.StoredProcedure;
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetReimbursementTypeStaffExpenses", con);
                    command.CommandType = CommandType.StoredProcedure;
        ...
        public void ExpensesCountByEmpID(int UserID)
        {
            try
            {
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetTotalAmountStaffExpensesbyEmpID", con);
                    command.CommandType = CommandType.StoredProcedure;
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetRegularTypeStaffExpensesByEmpID", con);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@EmpID", UserID);
                    double totalRegularCount = (double)command.ExecuteScalar();
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetReimbursementTypeStaffExpensesbyEmpID", con);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@EmpID", UserID);
                    double totalReimbursementCount = (double)command.ExecuteScalar();
        ...
        //-----------------------------Partner By EmpID--------------------------------------//
        public DataTable ViewStaffExpensesDetailsByEmpID(int UserID)
        {
            DataTable table = new DataTable();
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                SqlCommand cmd = new SqlCommand("SP_ViewStaffExpensesDetailsByEmpID", con);
                cmd.CommandTimeout = 600;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@EmpID", UserID);
                SqlDataAdapter ad = new SqlDataAdapter(cmd);
                ad.Fill(table);
                GridStaffExpenses.DataSource = table;
                GridStaffExpenses.DataBind();
                ViewState["Datastaff"] = table;
            }
            return table;
        }

        public DataTable ViewStaffExpensesDetails()
        {
            DataTable table = new DataTable();
           using (SqlConnection con = new SqlConnection(strconnect))
            {
                using (SqlDataAdapter ad = new SqlDataAdapter("SP_ViewStaffExpensesDetails", con))
                {
                    ad.Fill(table);
                    GridStaffExpenses.DataSource = table;
                    GridStaffExpenses.DataBind();
        ...
        public void StaffOperationPermission()
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(strconnect))
                {
                    ...
                    command.Parameters.AddWithValue("@SubModule", "Staff Expenses");
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (Globalview == "True")
                        {
                            ...
                            if (Edit == "True")
                            {
                                GridStaffExpenses.Columns[8].Visible = true;
                            }
                            else
                            {
                                GridStaffExpenses.Columns[8].Visible = false;
                            }

                            if (Delete == "True")
                            {

                                GridStaffExpenses.Columns[9].Visible = true;
                            }
                            else
                            {
                                GridStaffExpenses.Columns[9].Visible = false;
                            }
                        }
                        else if (View == "True")
                        {
                            ViewStaffExpensesDetailsByEmpID(UserId);
        ...
        public void GetMessageFromModules()
        {
            try
            {
                ...
                if (MSGdata == "fgsave123q" && EdidDATA == null)
                {
                    ...
                    lblMessage.Text = "Staff Expenses Details Save Successfully";
                }
                else if (EdidDATA == "xcvfedit" && MSGdata == null)
                {
                    Toasteralert.Visible = true;
                    lblMessage.Text = "Staff Expenses Details Edit Successfully";
                }
        ...
        protected void btnDeleteOfficeExpenses_Click(object sender, EventArgs e)
        {
            try
            {
                RoleType = Session["LoginType"].ToString();
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    ...
                    string tableID;
                    var rows = GridStaffExpenses.Rows;
                    LinkButton btn = (LinkButton)sender;
                    GridViewRow row = (GridViewRow)btn.NamingContainer;
                    int rowindex = Convert.ToInt32(row.RowIndex);
                    tableID = ((Label)rows[rowindex].FindControl("lblExp_id1")).Text;

                    SqlCommand cmd = new SqlCommand("SP_DeleteStaffExpenses", DeviceCon);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Exp_id", tableID);
                    ...
                    if (i < 0)
                    {
                        ...
                        lblMesDelete.Text = "Staff Expenses Details Deleted Successfully";
                        GridStaffExpenses.EditIndex = -1;
                        ViewStaffExpensesDetails();
                    }
                    else
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Staff Expenses Details Not Deleted Successfully";
                    }
                }
                else if (RoleType == Designation)
                {
                    ...
                    SqlCommand cmd = new SqlCommand("SP_DeleteStaffExpensesForEmpID", DeviceCon);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Exp_id", tableID);
                    cmd.Parameters.AddWithValue("@CreatedBy", UserName);
                    cmd.Parameters.AddWithValue("@UserID", UserId);
        ...
        protected void btnEditOfficeExpenses_Click(object sender, EventArgs e)
        {
            try
            {
                string ID;
                ...
                Response.Redirect("~/Edit_Staff_Expenses.aspx?ID=" + ID + "", false);
            }
            catch(Exception ex)
            {
                using (SqlConnection DeviceCon = new SqlConnection(strconnect))
            ...
            try
            {
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    ...
                    using (SqlConnection UserCon = new SqlConnection(strconnect))
                    {
                        ...
                        SqlCommand cmd = new SqlCommand("SP_ViewStaffExpensesDetailsStatus", con);
                        cmd.CommandType = CommandType.StoredProcedure;
                        SqlDataAdapter adpt = new SqlDataAdapter(cmd);
                        adpt.Fill(dt);
                        GridStaffExpenses.DataSource = dt;
                        GridStaffExpenses.DataBind();
        ...
        protected void GridStaffExpenses_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                foreach (GridViewRow gridviedrow in GridStaffExpenses.Rows)
                {  // string  Status = Convert.ToString(e.Row.Cells[8].Text);
                    ...
                    //Label lblExpenses_Type1 = (Label)gridviedrow.FindControl("lblExp_Payment1");
                    ...
                    if (status == "True")
                    {
                        ...
                        lblExpenses_Type1.ForeColor = System.Drawing.Color.Black;
                        lblExp_id1.ForeColor = System.Drawing.Color.Blue;
                    }
                    else
                    {
                        ...
                        lblExp_id1.ForeColor = System.Drawing.Color.Red;
        ...
        protected void btnRecordStaffExpense_Click(object sender, EventArgs e)
        {
            Response.Redirect("New_Staff_Expenses.aspx");
        }
        ...
        protected void lnkbtnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    DataTable dt = ViewStaffExpensesDetails();
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        Response.Clear();
                        Response.Buffer = true;
                        Response.ContentType = "application/ms-excel";
                        Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "StaffExpensesDetails " + DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss") + ".xls"));
            ...
            try
            {
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    ...
                    using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
                    {
                        ...
                        _document.Open();
                        _pdfPTable.SetWidths(new float[] { 4f, 10f, 11f, 9f, 10f, 11f, 14f, 11f });//column width in doc       
                                                                                                   //----Header PDF--------------------------//
                                                                                                   //Company Logo
                        ...
                        _fontStyle = FontFactory.GetFont("Arial", 14f, 2);
                        _pdfPCell = new PdfPCell(new Phrase("StaffExpenses", _fontStyle));
                        _pdfPCell.Colspan = 5;
                        ...
                        _Vhrlist = ViewStaffExpensesDetails();
                        #region "Table Header"
                        ...
                        //_fontStyle = FontFactory.GetFont("Tahoma", 9f, 1, BaseColor.WHITE);
                        _pdfPCell = new PdfPCell(new Phrase("Expenses", _fontStyle));
                        _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                        _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                        //_pdfPCell.BackgroundColor = BaseColor.GRAY;
                        _pdfPCell.ExtraParagraphSpace = 2;
                        ...
                        //_fontStyle = FontFactory.GetFont("Tahoma", 9f, 1, BaseColor.WHITE);
                        _pdfPCell = new PdfPCell(new Phrase("ExpenseType", _fontStyle));
                        _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                        _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                        //_pdfPCell.BackgroundColor = BaseColor.GRAY;
                        _pdfPCell.ExtraParagraphSpace = 2;
                        ...
                        foreach (DataRow row in _Vhrlist.Rows)
                        {
                            ...
                            _pdfPCell = new PdfPCell(new Phrase(row["Exp_Type"].ToString(), _fontStyle));
                            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                            _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                            _pdfPCell.BackgroundColor = BaseColor.WHITE;
                            _pdfPCell.ExtraParagraphSpace = 1;
                        ...
                        string PDFFileName = string.Format("StaffExpenses_" + dTime.ToString("dd/MM/yyyy HH:mm") + ".pdf");
                        Response.Clear();
                ...
                else if (RoleType == Designation)
                {
                    ...
                    using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
                    {
                        ...
                        DataTable _Vhrlist = new DataTable();
                        _Vhrlist = (DataTable)ViewState["Datastaff"];
                        #region "Table Header"
                        ...
                        foreach (DataRow row in _Vhrlist.Rows)
                        {
                            ...
                            _pdfPCell = new PdfPCell(new Phrase(row["Exp_StaffName"].ToString(), _fontStyle));
                            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                            _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                            _pdfPCell.BackgroundColor = BaseColor.WHITE;
                            _pdfPCell.ExtraParagraphSpace = 1;
