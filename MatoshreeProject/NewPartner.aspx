<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="NewPartner.aspx.cs" Inherits="MatoshreeProject.NewPartner" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                <h5 class="font-weight-medium mb-0">New Patner</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-muted" aria-current="page" href="NewPartner.aspx">New Patner</li>
                    </ol>
                </nav>
            </div>
            <%-- Toaster --%>
            ...
            <div class="col-md-9 col-sm-9 col-lg-9">
                <div class="card">
                    <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                            <div class="mb-2">
                                                ...
                                                <asp:TextBox ID="txtCompany" runat="server" CssClass="form-control" placeholder=" Enter Partner Name"></asp:TextBox>
                                                <asp:RequiredFieldValidator runat="server" Display="Dynamic" ControlToValidate="txtCompany" ErrorMessage="Enter Partner Name" ForeColor="Red" ValidationGroup="Validate" Font-Size="12px"></asp:RequiredFieldValidator>
                                            </div>
                                            <div class="mb-2">
                                                ...
                                                <asp:RequiredFieldValidator ID="rfv_Phone" runat="server" Display="Dynamic" ControlToValidate="txtPhone" ErrorMessage="Enter Phone Number" ForeColor="Red" ValidationGroup="Validate" Font-Size="12px"></asp:RequiredFieldValidator>
                                        ...
                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                            <div class="mb-2">
                                                <asp:Label ID="lblEmail" for="Email" runat="server" Text="Email" Font-Bold="true" CssClass="form-label"></asp:Label>&nbsp;<span style="color: #FF0000">*</span>
                                                <asp:TextBox ID="txtEmail" runat="server" name="Email" CssClass="form-control" placeholder="Enter Email"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="rfv_Email" runat="server" ErrorMessage="Enter Email" Display="Dynamic" ControlToValidate="txtEmail" ForeColor="Red" ValidationGroup="Validate" Font-Size="12px"></asp:RequiredFieldValidator>
                                                <asp:RegularExpressionValidator ID="regExpvalEmail" runat="server" ErrorMessage="Invalid Email address" ControlToValidate="txtEmail" Display="Dynamic" ForeColor="Red" ValidationGroup="Validate" ValidationExpression="^\S+@\S+$"></asp:RegularExpressionValidator>
                                            </div>
                                            <div class="mb-2">
                                                ...
                                                <asp:TextBox ID="txtAltphone" runat="server" name="Altphone" CssClass="form-control" placeholder="Enter Alternative Phone Number" MaxLength="10"></asp:TextBox>
                                            ...
                                            <div class="mb-2">
                                                <asp:Label ID="lblpartner" runat="server" Text="Type of Partner" Font-Bold="true" CssClass="form-label"></asp:Label>
                                                <asp:DropDownList ID="ddlPartner" runat="server" CssClass="form-select" ValidationGroup="Validate">
                        ...
                        <div class="mb-2">
                            <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-sm btn-primary" ValidationGroup="Validate" OnClick="btnSave_Click" />
                            <asp:Button ID="btnclear" runat="server" Text="Clear" CssClass="btn btn-sm btn-danger" ValidationGroup="Validate1" OnClick="btnclear_Click" />
                        </div>
                    </div>
                </div>
            </div>
