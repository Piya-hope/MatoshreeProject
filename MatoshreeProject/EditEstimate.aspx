<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="EditEstimate.aspx.cs" Inherits="MatoshreeProject.EditEstimate" %>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                    <h5 class="font-weight-medium mb-0">Edit Estimate</h5>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a class="text-muted text-decoration-none" href="Estimates_Home.aspx">Estimate
                                </a>
                            </li>
                            <li class="breadcrumb-item text-muted" aria-current="page" href="EditEstimate.aspx">Edit Estimate</li>
                        </ol>
                    </nav>
                </div>
                <%-- Toaster --%>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-lg-6 border-right">
                                ...
                                <asp:Label ID="lblEstimateID" runat="server" Text="" Visible="false"></asp:Label>
                                <hr />
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12">
                            <div class="col-md-12 col-sm-12 col-lg-12">
                                <div class="mb-2">
                                    <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="btn btn-sm btn-success" ValidationGroup="Invoice1" OnClick="btnUpdate_Click" />
                                    &nbsp;&nbsp;
                             <asp:Button ID="btnClear" runat="server" Text="Cancel" CssClass="btn btn-sm btn-danger" ValidationGroup="Clear" OnClick="btnClear_Click" />
                                    &nbsp;&nbsp;
