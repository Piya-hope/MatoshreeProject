...
{
    public partial class Project_Purchase : System.Web.UI.Page
    {
        ...
        public void ExpensesCount()
        {
            try
            {
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetTotalProjectPurchaseCount", con);
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetRegularTypeProjectPurchase", con);
                    command.CommandType = CommandType.StoredProcedure;
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetReimbursementTypeProjectPurchase", con);
                    command.CommandType = CommandType.StoredProcedure;
        ...
        public void ExpensesCountByEmpID(int UserID)
        {
            try
            {
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetTotalProjectPurchaseCountbyEmpID", con);
                    command.CommandType = CommandType.StoredProcedure;
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetRegularTypeProjectPurchaseByEmpID", con);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@EmpID", UserID);
                    double totalRegularCount = (double)command.ExecuteScalar();
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetReimbursementTypeProjectPurchasebyEmpID", con);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@EmpID", UserID);
                    double totalReimbursementCount = (double)command.ExecuteScalar();
        ...
        //-----------------------------ViewProjectPurchase By EmpID--------------------------------------//
        public DataTable ViewProjectPurchaseEmpID(int UserID)
        {
            DataTable table = new DataTable();
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                SqlCommand cmd = new SqlCommand("SP_ViewProjectPurchaseExpensesDetailsEmpID", con);
        ...
        public DataTable ViewProjectPurchase()
        {
           ...
           using (SqlConnection con = new SqlConnection(strconnect))
            {
                using (SqlDataAdapter ad = new SqlDataAdapter("SP_ViewProjectPurchaseExpensesDetails", con))
                {
                    ad.Fill(table);
                    GridProjectPurchase.DataSource = table;
                    GridProjectPurchase.DataBind();
                ...
                using (SqlConnection con = new SqlConnection(strconnect))
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (Globalview == "True")
                        {
                            ...
                            if (Edit == "True")
                            {
                                GridProjectPurchase.Columns[9].Visible = true;
                            }
                            else
                            {
                                GridProjectPurchase.Columns[9].Visible = false;
                            }

                            if (Delete == "True")
                            {
                                GridProjectPurchase.Columns[10].Visible = true;
                            }
                            else
                            {
                                GridProjectPurchase.Columns[10].Visible = false;
                            }
                        }
                        else if (View == "True")
                        {
                            ViewProjectPurchaseEmpID(UserId);
        ...
        public void GetMessageFromModules()
        {
            try
            {
                ...
                if (MSGdata == "fgsave123q" && EdidDATA == null)
                {
                    ...
                    lblMessage.Text = "Project Purchase Details Save Successfully";
                }
                else if (EdidDATA == "xcvfedit" && MSGdata == null)
                {
                    Toasteralert.Visible = true;
                    lblMessage.Text = "Project Purchase Details Edit Successfully";
                }
        ...
        protected void BTN_Visibility_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    ...
                    using (SqlConnection con = new SqlConnection(strconnect))
                    {
                        using (SqlDataAdapter ad = new SqlDataAdapter("SP_ViewProjectPurchaseVisibility", con))
                        {
                            ad.Fill(table);
                            GridProjectPurchase.DataSource = table;
                            GridProjectPurchase.DataBind();
        ...
        protected void GridProjectPurchase_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                foreach (GridViewRow gridviedrow in GridProjectPurchase.Rows)
                {
                    ...
                    if (Status1 == "True")
                    {
                        lblPur_id1.ForeColor = Color.Black;
                        lblPur_Name1.ForeColor = Color.Black;
                        lblPur_Customer1.ForeColor = Color.Black;
                        lblPur_Project1.ForeColor = Color.Black;
                        lblPur_Date1.ForeColor = Color.Blue;
                        lblExpenses_Type1.ForeColor = Color.Blue;                       
                    }
                    else
                    {

                        lblPur_id1.ForeColor = Color.Red;
                        lblPur_Name1.ForeColor = Color.Red;
                        lblPur_Customer1.ForeColor = Color.Red;
                        lblPur_Project1.ForeColor = Color.Red;
                        lblPur_Date1.ForeColor = Color.Red;
                        lblExpenses_Type1.ForeColor = Color.Red;
                    }
                }
        ...
        protected void linkPur_Name1_Click(object sender, EventArgs e)
        {
            //try
            //{
            //    string Name;
            ...
            //    Name = ((Label)rows[rowindex].FindControl("lblPur_Name1")).Text;

            //    Response.Redirect("~/SingleProduct_PurchaseExpences.aspx?Name=" + Name, false); //Rdy456
            //}
            //catch (Exception ex)
            //{
            //    using (SqlConnection DeviceCon = new SqlConnection(strconnect))
        ...
        protected void lnkbtnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataTable dt = (DataTable)ViewState["PurchaseData"];
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        Response.Clear();
                        Response.Buffer = true;
            ...
            try
            {
                ...
                else if (RoleType == Designation)
                {
                    ...
                    using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
                    {
                        ...
                        DataTable _Vhrlist = new DataTable();
                        _Vhrlist = (DataTable)ViewState["PurchaseData"];
                        #region "Table Header"
