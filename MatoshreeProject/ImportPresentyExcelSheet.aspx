<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="ImportPresentyExcelSheet.aspx.cs" Inherits="MatoshreeProject.ImportPresentyExcelSheet" %>
                       ...
                       <h5 >Import Presenty Sheet</h5>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item text-muted" aria-current="page" href="ImportPresentyExcelSheet.aspx">PresentyExcelSheet</li>
                        ...
                        <div class="card  bg-primary-subtle 
                            ...
                            <div class="card-body">
                                 <asp:Label ID="lbl1" Text="1.Your Excel Data Should be in the format below.The first line of your Excel file should be the column headers as in the table example. Also make sure that your file is UTF-8 to
                                     avoid unnecessary encoding problems." runat="server" Font-Size="12px" CssClass="form-label text-primary"></asp:Label>
                                <br />
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                                        <asp:GridView ID="GridLeaveAnalysis" runat="server" ScrollBars="Both" CssClass="table border table-hover table-bordered text-nowrap align-content-center" AutoGenerateColumns="false" CellPadding="4" Style="width: 100%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="StaffName" HeaderText="StaffName" HeaderStyle-Font-Size="12px" />
                                                <asp:BoundField DataField="Email" HeaderText="Email" HeaderStyle-Font-Size="12px" />
                                                <asp:BoundField DataField="InTime" HeaderText="InTime" HeaderStyle-Font-Size="12px" />
                                                <asp:BoundField DataField="OutTime" HeaderText="OutTime" HeaderStyle-Font-Size="12px" />
                                                <asp:BoundField DataField="LateTime" HeaderText="LateTime" HeaderStyle-Font-Size="12px" />
                                                <asp:BoundField DataField="TotalHRS" HeaderText="TotalHRS" HeaderStyle-Font-Size="12px" />
                                                <asp:BoundField DataField="Remark" HeaderText="Remark" HeaderStyle-Font-Size="12px" />
                                            </Columns>
                                        </asp:GridView>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6">
                                        <div class="mb-2">
                                            <asp:Button ID="btnImport" runat="server" Text="Import" CssClass="btn btn-sm btn-primary" OnClick="btnImport_Click" ValidationGroup="Import" />
                                            &nbsp;&nbsp;
