<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="Contract_Vendor.aspx.cs" Inherits="MatoshreeProject.Contract_Vendor" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var GridContractVendor = $("#GridContractVendor").prepend($("<thead></thead>").append($("#GridContractVendor").find("tr:first"))).DataTable(
                {
                    "responsive": true,
                    "scrollY": "400px",
                    "scrollX": "80%",
    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item text-muted" aria-current="page" href="Contract_Vendor.aspx">Contract Vendor </li>
            </ol>
        </nav>
        <%-- BreadCrumbs --%>
        <br />
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                ...
                <h5 class="fs-5 mt-3 mb-3">Contract Vendor Summary</h5>
                <div class="row">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-auto">
                                        <span class="text-success display-6">
                                            <iconify-icon icon="material-symbols-light:contract-edit-outline-rounded" class="aside-icon"></iconify-icon>
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">
                        <div class="card">
                            <div class="card-body">
                               ...
                               <%--  <asp:Chart ID="Chart2" runat="server" Height="400" Width="500" ImageLocation="~/charts_2/chart_9_0.png" ImageStorageMode="UseImageLocation">--%>
                                ...
                                <asp:Chart ID="Chart2" runat="server" Height="400" Width="500">
                                    ...
                                    <ChartAreas>
                                        <asp:ChartArea Name="ChartArea">
                                            <AxisX Title="Contract Type Vendor" TitleForeColor="blue" IntervalOffset="Auto"></AxisX>
        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <h5 class="font-weight-medium mt-3 mb-3">View Contract Vendor Details</h5>
                    <hr />
                    <div class="row">
                        <div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
                            ...
                            <asp:GridView ID="GridContractVendor" runat="server" ScrollBars="Both" CssClass="table table-bordered table-hover" AutoGenerateColumns="false" CellPadding="4" Style="width: 100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="12px">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnDeleteContractVendor" runat="server" CommandName="Delete" CssClass="btn btn-sm btn-outline-danger" OnClick="btnDeleteContractVendor_Click1"><i class="ti ti-trash"></i></asp:LinkButton>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                        </EditItemTemplate>
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
