...
namespace MatoshreeProject
{
    public partial class EditInvoice : System.Web.UI.Page
    {
        ...
        //        cmd.Connection = conn;
        //        cmd.CommandType = CommandType.StoredProcedure;
        //        cmd.Parameters.AddWithValue("@BelongTo", "Invoice");
        //        using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
        //        {
        //            DataSet ds = new DataSet();
        //            sda.Fill(ds);
        ...
        public void Clear()
        {
           ...
           //ddlDiscountType.SelectedIndex = -1;
            ...
            RadioButtonListQty.ClearSelection();
        ...
        public void GetInvoiceDetailsByID()
        {
            try
            {
                string constr = ConfigurationManager.ConnectionStrings["DBConnection"].ConnectionString;

                Invoiceid = HttpUtility.UrlDecode(Request.QueryString["ID"]);
                lblInvID.Text = Invoiceid;
                SqlConnection UserCon = new SqlConnection(constr);
                SqlCommand cmd = new SqlCommand("SP_GetInvoiceByID", UserCon);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                SqlDataAdapter sda = new SqlDataAdapter(cmd);
                cmd.Parameters.AddWithValue("@ID", lblInvID.Text);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                if (dt.Rows.Count > 0)
                {
                    ...
                    CustAddress(CustID);
                    txtInvoiceDate.Attributes["value"] = DateTime.Parse(dt.Rows[0]["InvoiceDate"].ToString()).ToString("yyyy-MM-dd");
                    ...
                    reminder = dt.Rows[0]["reminder"].ToString();
                    ...
                    GetItemTax(txtInvoiceNumber.Text);
                    InvoiceTaxName(txtInvoiceNumber.Text);
                    ...
                    char[] arr = { '₹' };
                    string adj1  = adj.Trim(arr).ToString();
                    TxtAdjustment1.Text = adj1;
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < dt2.Rows.Count; i++)
                        {
                            ...
                            using (SqlConnection contax2 = new SqlConnection(strconnect))
                            {
                                ...
                                {
                                    TaXcount2 = Convert.ToInt32(dttax2.Rows[0]["Tax2Amount"]);
                                    TAXCount2.Text = Convert.ToString(dttax2.Rows[0]["Tax2Amount"]);
                                }
                                else
                                {
                                    TaXcount2 = Convert.ToInt32(0);
        ...
        protected void btn_UpdateInvoice_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Discount_Type", "disctnull");//ddlDiscountType.SelectedItem.Text
                cmd.Parameters.AddWithValue("@Admin_Note", txtAdminNote.Text);
                cmd.Parameters.AddWithValue("@Status", "Partially Paid");
                ...
                if (Result < 0)
                {
                    ...
                    Response.Redirect("~/Chart_List_Invoice.aspx?edit1=" + edit + "", false);
                ...
                else
                {
                    ...
                    lblMesDelete.Text = "Invoice Details Not Edit Successfully";
                }
        ...
        {
            Response.Redirect("Chart_List_Invoice.aspx", true);
        }
        ...
        protected void btnConvertDraft_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConnection con = new SqlConnection(strconnect);  // db connect
                SqlCommand cmd = new SqlCommand("SP_ConvertToSaveInvoice", con);
                cmd.Connection = con;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@SaveAS", lblSAveAS.Text);
                cmd.Parameters.AddWithValue("@InvoiceID", lblInvID.Text);
                ...
                if (i < 0)
                {
                    Toasteralert.Visible = false;
                    deleteToaster.Visible = true;
                    lblMesDelete.Text = "Invoice Details Save Successfully";
                ...
                else
                {
                    Toasteralert.Visible = false;
                    deleteToaster.Visible = true;
                    lblMesDelete.Text = "Invoice Details Not Save Successfully";
                }              
                Clear();
                con.Close();
            }
