<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="MatoshreeProject.ResetPassword" %>
...
<head runat="server">
    ...
    <title>Matoshree Interior | Reset Password</title>
                            ...
                            <div class="card-body">
                                ...
                                <div class="position-relative text-center my-4">
                                    <p class="mb-0 fs-4 px-3 d-inline-block bg-white text-dark z-index-5 position-relative">
                                        <asp:Label ID="lblTitle" runat="server" Text="Reset Password" ForeColor="Black"></asp:Label>
                                    </p>
                                ...
                                <form id="form1" runat="server">
                                    ...
                                    <div class="mb-2">
                                        <div class="mb-2">
                                            ...
                                            <asp:TextBox ID="txtPassword" runat="server" placeholder="Enter Password" CssClass="form-control" TextMode="Password" TabIndex="20"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiPassword" runat="server" ErrorMessage="Enter Password" ControlToValidate="txtPassword" ForeColor="Red" Font-Bold="false" ValidationGroup="ConfirmPass"  Font-Size="12px"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="mb-2">
                                        <div class="mb-2">
                                            <asp:Label ID="lblConfirmPassword" runat="server" Text="Repeat Password" CssClass="form-label"></asp:Label>
                                            <asp:TextBox ID="txtConfirmPassword" runat="server" placeholder="Enter Repeat Password" CssClass="form-control" TabIndex="23" TextMode="Password"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredConfirm" runat="server" ErrorMessage="Enter Repeat Password" ControlToValidate="txtConfirmPassword" ForeColor="Red" Font-Bold="false" ValidationGroup="ConfirmPass"  Font-Size="12px"></asp:RequiredFieldValidator>
                                            <br />
                                            <asp:CompareValidator ID="CompareValidaConfirmPassword" runat="server" ControlToCompare="txtPassword" ControlToValidate="txtConfirmPassword" ErrorMessage="Password does not match." ForeColor="Red" Font-Bold="false" ValidationGroup="ConfirmPass"></asp:CompareValidator>
                                        </div>
                                    </div>
                                      <asp:Button ID="btnResetPassword" runat="server" Text="Reset Password" CssClass="btn btn-primary btn-sm w-100 py-8 mb-3" ValidationGroup="ConfirmPass" OnClick="btnResetPassword_Click" />
