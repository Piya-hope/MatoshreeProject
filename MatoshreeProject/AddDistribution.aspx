<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="AddDistribution.aspx.cs" Inherits="MatoshreeProject.AddDistribution" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                <h5 class="font-weight-medium mb-0">New Distribution</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-muted" aria-current="page" href="AddDistribution.aspx">New Distribution</li>
                    </ol>
                </nav>
            </div>
            <%-- Toaster --%>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                                <div class="row">
                                    <asp:Label ID="lblDistID" runat="server" Text="" Visible="false"></asp:Label>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-lg-3">
                                        <div class="mb-2">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Select Staff" ControlToValidate="ddlStaff" ForeColor="Red" Font-Bold="false" ValidationGroup="Inventory" InitialValue="0" Display="Dynamic" Font-Size="12px"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
    ...
    <script>
        function SelectAllCheckboxes(checkbox) {
            var gridView = document.getElementById('<%= GridProduct.ClientID %>');
