<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="NewVendor.aspx.cs" Inherits="MatoshreeProject.NewVendor" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                <h5 class="font-weight-medium mb-0">New Vendor</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-muted" aria-current="page" href="NewVendor.aspx">New Vendor</li>
                    </ol>
                </nav>
            </div>
            <%-- Toaster --%>
            ...
            <div class="col-md-3 col-sm-3 col-lg-3">
                <div class="card">
                    <div class="card-body">
                       <h5>Add Vendor</h5>
                        <hr />
                        <a class="sidebar-linkcard-title" href="NewVendor.aspx">Profile</a>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                            <asp:UpdatePanel ID="UpdatePanelddlState" runat="server">
                                                <ContentTemplate>
                                                    <h6>Billing Address&nbsp;&nbsp;<asp:Button ID="btnCopyVendorInfo" runat="server" Text="Same as Vendor Info" CssClass="btn btn-outline-info btn-sm" OnClick="btnCopyVendorInfo_Click1" ValidationGroup="Copy" /></h6>
                                                    <hr />
