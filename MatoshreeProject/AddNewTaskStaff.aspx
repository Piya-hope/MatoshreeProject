<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="AddNewTaskStaff.aspx.cs" Inherits="MatoshreeProject.AddNewTaskStaff" ValidateRequest="false" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                <h5 class="font-weight-medium mb-0">New Task</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a class="text-muted text-decoration-none" href="TaskDetailsStaff.aspx">Task
                            </a>
                        </li>
                        <li class="breadcrumb-item text-muted" aria-current="page" href="AddNewTaskStaff.aspx">New Task</li>
                    </ol>
                </nav>
            </div>
            <%-- Toaster --%>
                    ...
                    <div class="card shadow-lg border-dark">
                        <div class="card-body">
                            ...
                            <div class="form-group mb-2">
                                ...
                                &nbsp;&nbsp;
                                <asp:CheckBox ID="Cbx_Cash" Text="&nbsp;Billable" runat="server" Font-Bold="true" Checked="true" Font-Size="13px" />
                            ...
                            <div class="form-group mb-2">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator_Rate" runat="server" ErrorMessage="Enter the Subject" Display="Dynamic" ControlToValidate="txt_Subject" ForeColor="Red" ValidationGroup="NEWTASK" Font-Size="12px"></asp:RequiredFieldValidator>
                            </div>
                            <div class="row">
                                <div class="form-group mb-2">
                                    <asp:Label ID="lbl_Hourly_Rate" runat="server" Text="Hourly Rate" CssClass="form-label"></asp:Label>
                                    <asp:TextBox ID="txt_Hourly_Rate" runat="server" CssClass="form-control" placeholder="Hourly Rate" TextMode="Number"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-lg-6 mb-2">
                                    <div class="form-group mb-2">
                                        ...
                                        <asp:TextBox ID="txt_Start_Date" type="date" CssClass="form-control" Style="display: inline-block;" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-lg-6 mb-2">
                                    <div class="form-group mb-2">
                                        ...
                                        <asp:TextBox ID="txt_Due_Date" type="date" CssClass="form-control" Style="display: inline-block;" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-lg-6 mb-2">
                                    ...
                                    <div class="mb-2">
                                        <asp:DropDownList ID="ddl_Reapet_Every" CssClass="form-control form-select" runat="server" OnSelectedIndexChanged="ddl_Reapet_Every_SelectedIndexChanged" AutoPostBack="true">
                                            <asp:ListItem Text="Nothing Selected" Value="0"></asp:ListItem>
                                            ...
                                            <asp:ListItem Text="1 Year" Value="7"></asp:ListItem>
                                            <asp:ListItem Text="Custom" Value="8"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-lg-6">
                                    <asp:TextBox ID="txtselectcustom" runat="server" CssClass="form-control" type="number" Visible="false"></asp:TextBox>
                                </div>
                                <div class="col-md-6 col-sm-6 col-lg-6">
                                    <asp:DropDownList ID="ddldays" CssClass="form-control form-select" Height="32px" runat="server" Visible="false">
                            ...
                            <div class="row">
                                <div class="mb-2">
                                    <asp:Label ID="Lblselect" runat="server" Text="Events On (Leave blank for never)" Font-Bold="true" CssClass="form-label"></asp:Label>
                                    <asp:TextBox ID="txtevent" type="date" CssClass="form-control" Style="display: inline-block;" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <br />
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6">
                                    ...
                                    <div class="table-responsive" style="height: 273px; width: 100%;">
                                        <asp:GridView ID="gvStaffList" runat="server" CssClass="table table-bordered table-hover" AutoGenerateColumns="false" ShowHeader="false" ShowHeaderWhenEmpty="false" EmptyDataText="Not Data Found" Style="width: 100%">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="chkRows" runat="server" CssClass="listCheckbox" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="lblStaffID" runat="server" Text='<%# Bind("Staff_ID") %>' Font-Size="12px" Visible="false"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                                ...
                                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6">
                                    ...
                                    <div class="table-responsive" style="height: 273px; width: 100%;">
                                        <asp:GridView ID="GridFollower" runat="server" CssClass="table table-bordered table-hover" AutoGenerateColumns="false" ShowHeader="false" ShowHeaderWhenEmpty="false" Style="width: 100%">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="chkRows" runat="server" CssClass="listCheckbox" />
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblStaff1" runat="server" Text='<%# Bind("First_Name") %>' Font-Size="12px"></asp:Label>
                                                        <asp:Label ID="lblStaffID1" runat="server" Text='<%# Bind("Staff_ID") %>' Font-Size="12px" Visible="false"></asp:Label>
                            ...
                            <div class="row">
                                ...
                                <br />
                                <div>
                                    <%-- <textarea id="default" runat="server"  ></textarea>--%>
                            ...
                            <div class="form-group mb-2">
                                <asp:Button ID="btnSaveTask" runat="server" Text="Save" CssClass="btn btn-sm btn-primary" ValidationGroup="NEWTASK" OnClick="btnSaveTask_Click" />
                                &nbsp;&nbsp;
