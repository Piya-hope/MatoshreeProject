<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="EditLeaveManagement.aspx.cs" Inherits="MatoshreeProject.EditLeaveManagement" %>
            ...
            <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-muted" aria-current="page" href="EditLeaveManagement.aspx">Edit Leave Management</li>
                    </ol>
                </nav>
            </div>
           <%-- Toaster --%>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-lg-12  col-xs-12">
                <div id="ExpDiv" runat="server" visible="true">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title" style="color: blue">Edit  Leave Management</h5>
                            <hr />
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-lg-6  col-xs-6">
                                    <div class="mb-2">
                                        ...
                                        <%--<asp:TextBox ID="txtlDepartment" runat="server" Font-Size="12px" placeholder="Enter Department" class="form-control"></asp:TextBox>--%>
                            ...
                            <div class="row">
                                <center>
                                    <div class="mb-2">
                                        <asp:Button ID="btnUpdateLM" runat="server" Text="Update"  OnClick="btnUpdateLM_Click" CssClass="btn btn-success btn-sm "  />
                                        &nbsp;&nbsp;
                                        <asp:Button ID="btnClose" runat="server" Text="Cancel" OnClick="btnClose_Click" CssClass="btn btn-danger  btn-sm"  />
                                    </div>
                             </center>
                        </div>
                     </div>
