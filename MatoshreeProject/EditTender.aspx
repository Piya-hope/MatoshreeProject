<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="EditTender.aspx.cs" Inherits="MatoshreeProject.EditTender" %>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                    <h5 class="font-weight-medium mb-0">Edit Tender</h5>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item text-muted" aria-current="page" href="#">Edit Tender</li>
                        </ol>
                    </nav>
                </div>
                <%-- Toaster --%>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-lg-6 border-right">
                                ...
                                <asp:Label ID="lbltenderid" runat="server" Text="" CssClass=" " Visible="false"></asp:Label>
                                <hr />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-2">
                                            ...
                                            <asp:TextBox ID="txtTenderNumber" runat="server" CssClass="form-control text-purple" ReadOnly="true" placeholder="Enter Tender Number"></asp:TextBox>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-2">
                                            ...
                                            <asp:TextBox ID="txttendername" runat="server" CssClass="form-control" placeholder="Enter Tender Number"></asp:TextBox>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-lg-12">
                                                <div class="mb-2">
                                                    ...
                                                    <asp:TextBox ID="txtaddressline2" runat="server" name="StreetLocation2" CssClass="form-control"></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="col-md-6  col-sm-6 col-lg-6">
                                        <div class="mb-2">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ControlToValidate="ddlStatus" ErrorMessage="Select Status" ForeColor="Red" Display="Dynamic" InitialValue="0" ValidationGroup="Tender1" Font-Size="12px"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="mb-2">
                                            <asp:Label ID="lblprebidMeetadd" runat="server" Text="Pre-bid Meeting Address" CssClass="form-label"></asp:Label>
                                    ...
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="mb-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <asp:Button ID="Btn_Upload" runat="server" Text="Upload" CssClass="btn btn-primary font-medium rounded-end" OnClick="Btn_Upload_Click" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-lg-12">
                                        <asp:GridView ID="GridTenderFile" runat="server" ScrollBars="Both" CssClass="table border table-bordered table-hover table-responsive text-nowrap align-content-center" AutoGenerateColumns="false" CellPadding="4" Style="width: 100%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                        <asp:Label ID="DocumentType" runat="server" Text="FileName" CssClass="form-label"></asp:Label>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="12px">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btnDeleteTender" runat="server" ForeColor="Red" OnClientClick="return confirm('Are you sure you want to delete?')" CausesValidation="false" OnClick="btnDeleteTender_Click"><i class="ti ti-trash"></i></asp:LinkButton>
                                                    </ItemTemplate>
                                                    <EditItemTemplate>
                                                    </EditItemTemplate>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-lg-12">
                                        ...
                                        <asp:GridView ID="GridTenderQue" runat="server" ScrollBars="Both" CssClass="table border table-bordered table-responsive table-hover text-nowrap align-content-center" AutoGenerateColumns="false" CellPadding="4" Style="width: 100%"
                                            ClientIDMode="Static" ShowHeader="false" EmptyDataText="No Records Found" ShowHeaderWhenEmpty="True" EmptyDataRowStyle-ForeColor="Red" EmptyDataRowStyle-HorizontalAlign="Center" Font-Bold="false">
                                            <Columns>
                                                <asp:TemplateField Visible="false">
                                                    <HeaderTemplate>
                                                        <asp:Label ID="lblTenderQueID" runat="server" Text="FileName" CssClass=" " Visible="false"></asp:Label>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="12px">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btnDeleteTenderQue" runat="server" ForeColor="Red" OnClientClick="return confirm('Are you sure you want to delete?')" CausesValidation="false" OnClick="btnDeleteTenderQue_Click"><i class="ti ti-trash"></i></asp:LinkButton>
                                                    </ItemTemplate>
                                                    <EditItemTemplate>
                                                    </EditItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-lg-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="GridCalculate" runat="server" ScrollBars="Both" CssClass="table border table-bordered table-hover" AutoGenerateColumns="false" CellPadding="4" Style="width: 100%"
                                                ClientIDMode="Static" Font-Bold="false" HeaderStyle-BackColor="#f8f9fa" HeaderStyle-Font-Bold="true" ShowFooter="true" DataKeyNames="ID">
                                                <Columns>
                                                    <asp:TemplateField Visible="false">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-Width="50px">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="lblRate1" runat="server" Text="" Font-Bold="false" Font-Size="12px"></asp:Label>
                                                        </ItemTemplate>
                                                        <FooterTemplate>
                                                    ...
                                                    <asp:TemplateField>
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnDeleteItemCal" runat="server" CommandName="Delete" CssClass="btn btn-sm btn-rounded btn-danger" ValidationGroup="DelItemTender" Text="" OnClientClick="return confirm('Are you sure you want to delete?')" CausesValidation="false" OnClick="btnDeleteItemCal_Click" Visible="false"><i class="ti ti-trash"></i></asp:LinkButton>
                                                        </ItemTemplate>
                                                        <FooterTemplate>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12">
                            ...
                            <div class="mb-2">
                                <asp:Button ID="Btn_Update" runat="server" Text="Update" CssClass="btn btn-sm btn-success" ValidationGroup="Tenderupdate" OnClick="Btn_Update_Click" />
                                &nbsp;&nbsp;                         
