<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="EditPaymentRequest.aspx.cs" Inherits="MatoshreeProject.EditPaymentRequest" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                <h5 class="font-weight-medium mb-0">Edit Payment Request</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-muted" aria-current="page" href="EditPaymentRequest.aspx">Edit Payment Request</li>
                    </ol>
                </nav>
            </div>
            <%-- Toaster --%>
        ...
        <div class="row">
            <div class="col-md-5 col-sm-5 col-lg-5 col-xl-5">
                <div class="card">
                    <div class="card-body">
                        <asp:Label ID="lblMisID" runat="server" Text="" CssClass="form-label" Visible="false"></asp:Label>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            <asp:Label ID="lblbillno" runat="server" Text="Expenses BillNo" CssClass="form-label"></asp:Label>
                            &nbsp;<span style="color: #FF0000">*</span>
                            <asp:TextBox ID="txtBillno" CssClass="form-control" Style="display: inline-block;" runat="server" placeholder="Enter Expenses BillNo"></asp:TextBox>
                        ...
                        <div class="mb-2">
                            <asp:Button ID="btnEditMiscellaneous" runat="server" Text="Update" CssClass="btn btn-success btn-sm" ValidationGroup="Expense" OnClick="btnEditMiscellaneous_Click" />
                            &nbsp;&nbsp;
                            <asp:Button ID="btnClose" runat="server" Text="Cancel" CssClass="btn btn-danger btn-sm" OnClick="btnClose_Click" />
                        </div>
                    </div>
                </div>
            </div>
                                                    ...
                                                    <asp:GridView ID="GridExpensesFile" runat="server" ScrollBars="Both" CssClass="table border table-responsive table-bordered table-hover text-nowrap align-content-center" AutoGenerateColumns="false" CellPadding="4" Style="width: 100%"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="12px">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="btnDeleteExpensesFile" runat="server" ForeColor="Red" OnClientClick="return confirm('Are you sure you want to delete?')" OnClick="btnDeleteExpensesFile_Click"><i class="ti ti-trash"></i></asp:LinkButton>
                                                                </ItemTemplate>
                                                                <EditItemTemplate>
                                                                </EditItemTemplate>
