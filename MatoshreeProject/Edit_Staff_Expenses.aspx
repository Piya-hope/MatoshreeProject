<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="Edit_Staff_Expenses.aspx.cs" Inherits="MatoshreeProject.Edit_Staff_Expenses" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                <h5 class="font-weight-medium  mb-0">Edit Staff Expenses</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-muted" aria-current="page" href="Edit_Staff_Expenses.aspx">Edit Staff Expenses</li>
                    </ol>
                </nav>
            </div>
                ...
                <div id="Div1" runat="server" visible="true">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lblMisID" runat="server" Text="" CssClass="" Visible="false"></asp:Label>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                ...
                                <asp:TextBox ID="txtExpensesDate" runat="server" CssClass="form-control" placeholder="Enter ExpensesDate" Text=""></asp:TextBox>
                            ...
                            <div class="mb-2">
                                ...
                                <asp:TextBox ID="txtBillno" CssClass="form-control" runat="server" placeholder="Enter Expenses Bill Number"></asp:TextBox>
                            ...
                            <div class="mb-2">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFielddlddlStaff" runat="server" ErrorMessage="Select Staff" ControlToValidate="ddlStaff" ForeColor="Red" Font-Bold="false" ValidationGroup="Expense" InitialValue="0" Display="Dynamic" Font-Size="12px"></asp:RequiredFieldValidator>
                            </div>
                            <div class="mb-2">
