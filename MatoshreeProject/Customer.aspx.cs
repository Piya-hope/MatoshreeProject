...
namespace MatoshreeProject
{
    public partial class Customer : System.Web.UI.Page
    {
        ...
        public DataTable CustomerDetailReport()
        {
            DataTable table = new DataTable();
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                SqlCommand cmd = new SqlCommand("SP_CustomerDetailReport", con);
        ...
        public DataTable CustomerDetailReportByEmpID(int UseID)
        {
            DataTable table = new DataTable();
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                SqlCommand cmd = new SqlCommand("SP_CustomerDetailReportbyEmpID", con);
        ...
        public DataTable ViewCustomerDetailsByEmpID(int UseID)
        {
            ...
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                SqlCommand cmd = new SqlCommand("SP_CustomerDetailsbyEmpID", con);
                cmd.CommandTimeout = 600;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@EmpID", UseID);
                SqlDataAdapter ad = new SqlDataAdapter(cmd);
        ...
        public void CustomerCountByEmpID(int UseID)
        {
            try
            {
                //-------------TotalCount----------------------//
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetTotalCustomerCountbyEmpID", con);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@EmpID", UseID);
                    int totalVendorsCount = (int)command.ExecuteScalar();

                    lblTotalCustmerCount.Text = Convert.ToString(totalVendorsCount);
                }
                ...
                {
                    con1.Open();
                    SqlCommand command = new SqlCommand("SP_GetActiveCustomerCountbyEmpID", con1);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@EmpID", UseID);
                    int activeVendorsCount = (int)command.ExecuteScalar();

                    lblActiveCustmerCount.Text = Convert.ToString(activeVendorsCount);
                }
                ...
                {
                    con2.Open();
                    SqlCommand command = new SqlCommand("SP_GetInActiveCustomerCountbyEmpID", con2);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@EmpID", UseID);
                    int inactiveVendorsCount = (int)command.ExecuteScalar();

                    lblInActiveCustomersCount.Text = Convert.ToString(inactiveVendorsCount);
                }
            }
            catch (Exception ex)
            {
        ...
        public DataTable ViewCustomerDetails()
        {
            ...
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                using (SqlDataAdapter ad = new SqlDataAdapter("SP_CustomerDetails", con))
                {
                    ad.Fill(table);
                    GridCustomer.DataSource = table;
                    GridCustomer.DataBind();
        ...
        public void CustomerCount()
        {
            try
            {
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetTotalCustomerCount", con);
                    command.CommandType = CommandType.StoredProcedure;
                    int totalVendorsCount = (int)command.ExecuteScalar();
                ...
                {
                    con1.Open();
                    SqlCommand command = new SqlCommand("SP_GetActiveCustomerCount", con1);
                    command.CommandType = CommandType.StoredProcedure;
                    int activeVendorsCount = (int)command.ExecuteScalar();
                ...
                {
                    con2.Open();
                    SqlCommand command = new SqlCommand("SP_GetInActiveCustomerCount", con2);
                    command.CommandType = CommandType.StoredProcedure;
                    int inactiveVendorsCount = (int)command.ExecuteScalar();
              ...
              string MSGdata  = HttpUtility.UrlDecode(Request.QueryString["svd1"]);
               string EdidDATA = HttpUtility.UrlDecode(Request.QueryString["edit1"]);
                if (MSGdata == "fgsave123q" && EdidDATA == null)
                {
                    ...
                    lblMessage.Text = "Customer Details Save Successfully";
                }
                else if (EdidDATA == "xcvfedit" && MSGdata == null)
                {
                    Toasteralert.Visible = true;
                    lblMessage.Text = "Customer Details Edit Successfully";
                }
            ...
            try
            {
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    using (SqlConnection DeviceCon = new SqlConnection(strconnect))
                    {
                        UserId = Convert.ToInt32(Session["UserID"]);
                        UserName = Session["UserName"].ToString();
                        var rows = GridCustomer.Rows;
                        Button Btn = (Button)sender;
                        GridViewRow row = (GridViewRow)Btn.NamingContainer;
                        int rowindex = Convert.ToInt32(row.RowIndex);
                        Button id = ((Button)rows[rowindex].FindControl("btnStatus"));
                        string ID = ((Label)rows[rowindex].FindControl("lblID1")).Text;
                        if (id.Text.Equals("Active"))
                        {
                            SqlCommand cmd = new SqlCommand("SP_UpdateCustomerStatus", DeviceCon);
                            cmd.CommandType = CommandType.StoredProcedure;
                            cmd.Parameters.AddWithValue("@Cust_ID", ID);
                            cmd.Parameters.AddWithValue("@Status", "False");//Session
                            cmd.Parameters.AddWithValue("@UserName", UserName);//Session
                            ...
                            if (Result < 0)
                            {
                                ...
                                lblMesDelete.Text = "Customer Inactive Successfully";
                            }
                            else
                            {
                                Toasteralert.Visible = false;
                                deleteToaster.Visible = true;
                                lblMesDelete.Text = "Customer Active Successfully";
                            }
                        }
                        else
                        {
        ...
        {
            foreach (GridViewRow gridviedrow in GridCustomer.Rows)
            {
                ...
                Label lblStatusShow1 = (Label)gridviedrow.FindControl("lblStatusShow1");
                Label lblSClientName1 = (Label)gridviedrow.FindControl("lblSClientName1");
                Label lblCust_Type1 = (Label)gridviedrow.FindControl("lblCust_Type1");
                ...
                if (status == "True")
                {
                    ...
                    lblProjectName1.ForeColor = Color.Blue;
                    lblDescription1.ForeColor = Color.Blue;
                    lblStatusShow1.ForeColor = Color.Blue;
                    lblCust_Type1.ForeColor = Color.Blue;
                ...
                else
                {
                    ...
                    lblProjectName1.ForeColor = Color.Red;
                    lblDescription1.ForeColor = Color.Red;
                    lblStatusShow1.ForeColor = Color.Red;
                    lblCust_Type1.ForeColor = Color.Red;
        ...
        protected void btnDeletecust_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    ...
                    SqlCommand cmd = new SqlCommand("SP_DeleteCustomer", DeviceCon);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Cust_ID", ID);
                    ...
                    if (i < 0)
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Customer Details Deleted Successfully";
                        ViewCustomerDetails();
                        CustomerCount();
                    }
                    else
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Customer Details Not Deleted";
                    }
                }
                else if (RoleType == Designation)
                {
                    ...
                    SqlConnection DeviceCon = new SqlConnection(strconnect);
                    SqlCommand cmd = new SqlCommand("SP_DeleteCustomerForEmpID", DeviceCon);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Cust_ID", ID);
                    cmd.Parameters.AddWithValue("@Created_by", UserName);
                    cmd.Parameters.AddWithValue("@UserID", UserId);
        ...
        protected void lnkbtnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    DataTable dt = CustomerDetailReport();
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        ...
                        dtExport.Columns.Add("Cust_Type");
                        ...
                        foreach (DataRow row in dt.Rows)
                        {
                            ...
                            newRow["Company"] = row["Cust_Name"];
                            newRow["Email"] = row["Cust_Email"];
                            newRow["Phone"] = row["Cust_Phone"];
                            newRow["Cust_Type"] = row["Cust_Type"];
            ...
            try
            {
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    ...
                    using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
                    {
                        ...
                        _document.Open();
                        _pdfPTable.SetWidths(new float[] { 4f, 11f, 8f, 11f, 9f, 9f, 11f, 9f, 11f, 16f, 16f });//column width in doc       
                                                                                                               //----Header PDF--------------------------//
                                                                                                               //Company Logo
                        ...
                        _fontStyle = FontFactory.GetFont("Arial", 14f, 2);
                        _pdfPCell = new PdfPCell(new Phrase("Customerlist", _fontStyle));
                        _pdfPCell.Colspan = 8;
                        ...
                        foreach (DataRow row in _Vhrlist.Rows)
                        {
                            ...
                            _pdfPCell = new PdfPCell(new Phrase(row["Cust_Phone"].ToString(), _fontStyle));
                            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                            _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                            _pdfPCell.BackgroundColor = BaseColor.WHITE;
                            _pdfPCell.ExtraParagraphSpace = 1;
                        ...
                        string PDFFileName = string.Format("Customerlist_" + dTime.ToString("dd/MM/yyyy HH:mm") + ".pdf");
                        Response.Clear();
