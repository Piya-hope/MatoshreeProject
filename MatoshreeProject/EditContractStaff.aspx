<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="EditContractStaff.aspx.cs" Inherits="MatoshreeProject.EditContractStaff" %>
            ...
            <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-muted" aria-current="page" href="EditContractStaff.aspx">Edit Contract Staff</li>
                    </ol>
                </nav>
            </div>
            <%-- Toaster --%>
            ...
            <div class="col-md-5 col-lg-5 col-sm-5 col-xs-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-2">
                            <asp:Label ID="lblCustomer" runat="server" Text="Staff" CssClass="form-label"></asp:Label>&nbsp;<span style="color: #FF0000">*</span>
                            <asp:DropDownList ID="ddlStaff" runat="server" CssClass="form-control form-select" Placeholder="Select Staff">
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFielddlCustomer" runat="server" ErrorMessage="Select Staff Name" ControlToValidate="ddlStaff" ForeColor="Red" Font-Bold="false" ValidationGroup="staff" InitialValue="0" Display="Dynamic" Font-Size="12px"></asp:RequiredFieldValidator>
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="row">
                            <div class="mb-2">
                                <div class="input-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Enter Contract Value" ControlToValidate="txtContractValue" ForeColor="Red" Font-Bold="false" ValidationGroup="staff" InitialValue="0" Display="Dynamic" Font-Size="12px"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="btn btn-sm btn-success" ValidationGroup="staff" OnClick="btnUpdate_Click" />
                            &nbsp;&nbsp;
                                ...
                                <div class="p-20">
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="mb-2">
                                                <asp:Label ID="lblFilename" runat="server" Text="" ForeColor="Blue" Font-Size="12px"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                                            <div class="mb-2">
                                                                ...
                                                                <asp:RequiredFieldValidator ID="reqNewStartDate" runat="server" ErrorMessage="Enter New Start Date" ControlToValidate="txtNewStartDate" ForeColor="Red" Font-Bold="false" ValidationGroup="REContract" Font-Size="12px"></asp:RequiredFieldValidator>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                                            <div class="mb-2">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                                            <div class="mb-2">
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredEnddte" runat="server" ErrorMessage="Enter New End Date" ControlToValidate="txtNewEndDate" ForeColor="Red" Font-Bold="false" ValidationGroup="REContract" Font-Size="12px"></asp:RequiredFieldValidator>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                                            <div class="mb-2">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                                            <div class="mb-2">
                                                                <div class="input-group">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredNewContractValue" runat="server" ErrorMessage="Enter New Contract Value" ControlToValidate="txtNewContractValue" ForeColor="Red" Font-Bold="false" ValidationGroup="REContract" InitialValue="0" Display="Dynamic" Font-Size="12px"></asp:RequiredFieldValidator>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                                            <div class="mb-2">
                                                                <asp:Button ID="btnRenewContract" runat="server" Text="Save" CssClass="btn btn-sm btn-primary" OnClick="btnRenewContract_Click" ValidationGroup="REContract" />
                                                                &nbsp;&nbsp;
                                                               <asp:Button ID="Btn_clear" runat="server" Text="Clear" CssClass="btn btn-sm btn-danger" OnClick="Btn_clear_Click" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
