<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="New_ContractContact.aspx.cs" Inherits="MatoshreeProject.New_ContractContact" %>
    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                 ...
                 <li class="breadcrumb-item">
                    <a class="text-muted text-decoration-none" href="Contract_Contact.aspx">Partner
                    </a>
                </li>
                <li class="breadcrumb-item text-muted" aria-current="page" href="#">New Contract Partner</li>
            </ol>
        </nav>
        </div>
            <%-- Toaster --%>
        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6">
                                <div class="mb-2">
                                    <asp:CheckBox ID="CheckHidePartner" runat="server" Checked="false" Text="Hide from Partner" CssClass=" font-bold" />
                                </div>
                            </div>
                        </div>
                        <div class="mb-2">

                            <asp:Label ID="lblContract_PartnerID" runat="server" Text=""></asp:Label>
                            <asp:Label ID="lblPartnerPdf" runat="server" Text="" Visible="false"></asp:Label>
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldSubject" runat="server" ErrorMessage="Enter Contract Subject" ControlToValidate="ddlpartnername" ForeColor="Red" Font-Bold="false" ValidationGroup="Save" InitialValue="0" Display="Dynamic"  Font-Size="12px"></asp:RequiredFieldValidator>
                        </div>
                        <div class="row">
                            <div class="mb-2">
                                <div class="input-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldContractValue" runat="server" ErrorMessage="Enter Contract Value" ControlToValidate="txtContractValue" ForeColor="Red" Font-Bold="false" ValidationGroup="Save" InitialValue="0" Display="Dynamic"  Font-Size="12px"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <div class="mb-2">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredStartDate" runat="server" ErrorMessage="Enter Contract Start Date" ControlToValidate="txtStartDate" ForeColor="Red" Font-Bold="false" ValidationGroup="Save"  Font-Size="12px"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <div class="mb-2">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldEndDate" runat="server" ErrorMessage="Enter Contract End Date" ControlToValidate="txtEndDate" ForeColor="Red" Font-Bold="false" ValidationGroup="Save"  Font-Size="12px"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-2">
                            <asp:Button ID="btnSaveProject" runat="server" Text="Save" CssClass="btn btn-sm btn-primary" OnClick="btnSaveProject_Click" ValidationGroup="Save" />
                            &nbsp;&nbsp;
            ...
            <div class="col-md-7 col-lg-7 col-sm-7 col-xs-7">
                <div class="card">
                    <div class="card-body">
                        <div  id="contractPdf"  runat="server" >
