...
{
    public partial class EditContractStaff : System.Web.UI.Page
    {
        ...
        public void BindStaffDetails()
        {
            try
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                {
                    ...
                    ddlStaff.DataBind();
                    ddlStaff.Items.Insert(0, new ListItem("Select Staff Name", "0"));
                }
            }
            catch (Exception ex)
            {
        ...
        public void Bindcontracttype()
        {
            try
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                {
                    ...
                    ddlContracttype.Items.Insert(0, new ListItem("Select Contracttype", "0"));
                }
            }
            catch (Exception ex)
            {
        ...
        public void ContractStaffByID()
        {
            try
            {
                ...
                lbltest.Text = Contractid;
                SqlConnection UserCon = new SqlConnection(constr);
                SqlCommand cmd = new SqlCommand("[SP_GetContract_StaffByID]", UserCon);
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    ddlStaff.SelectedValue = dt.Rows[0]["staffId"].ToString();
                    ddlContracttype.SelectedValue = dt.Rows[0]["contract_type"].ToString();
                    ...
                    ClientChk = dt.Rows[0]["not_visible_to_client"].ToString();
        ...
        protected void Btn_Upload_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (FileUpload1.PostedFile.FileName.Length > 1)
                {
                    ...
                    using (SqlConnection con = new SqlConnection(strconnect))
                    {
                        SqlCommand cmd = new SqlCommand("SP_UploadContractStaffAttachmentFile", con);
                        cmd.Connection = con;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@id", lbltest.Text);
                        ...
                        if (i < 0)
                        {
                            ...
                            lblMesDelete.Text = "Staff Contract Details File Upload Successfully";
                            ContractStaffByID();
                        }
                        else
                        {
                            Toasteralert.Visible = false;
                            deleteToaster.Visible = true;
                            lblMesDelete.Text = "Staff Contract Details File Not Uploaded";
                        }
                    }
                }
                else
        ...
        {          
            ...
            try
            {
                ...
                if (ddlStaff.SelectedItem.Text == "Select Project Members")
                {
        ...
        protected void LinkButtonadmin_url_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(LinkButtonadmin_url.Text));
        ...
        protected void btnRenewContract_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                try
                {
                    ...
                    {
                        RenewContractStaff = "False";//contract valid not exipred
                    }
                    else if (OldEndDate.Date == Today)
                    {
                        RenewContractStaff = "true";//renew exipred
                    }
                    else
                    {
                        RenewContractStaff = "true";//endate currendate past date
                    }
                    ...
                    if (NewEndDate.Date > NewStartDate.Date && RenewContractStaff == "true" || NewStartDate.Date == Today && RenewContractStaff == "true")
                    {
                        using (SqlConnection con = new SqlConnection(strconnect))
                        {
                            SqlCommand cmd = new SqlCommand("SP_SaveRenewContractStaff", con);
                            cmd.CommandType = CommandType.StoredProcedure;
                            ...
                            cmd.Parameters.AddWithValue("@contract_id", lbltest.Text);
                            cmd.Parameters.AddWithValue("@is_on_old_expiry_notified", RenewContractStaff);
                            cmd.Parameters.AddWithValue("@renewContractFor", "Staff");
        ...
        {
            Response.Redirect("~/Contract_Staff.aspx", false);
        }

        protected void Btn_clear_Click(object sender, EventArgs e)//renew clear
        {
            Clear();
        
        }

        protected void Linkclear_Click(object sender, EventArgs e)//pdf clear
        {
            textBox.Text = "Contract Data" + "\n";
            ViewState["Data"] = textBox.Text;
        }
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(strconnect))
                {
                    SqlCommand cmd = new SqlCommand("SP_UpdatecontractStaff", con);
                    cmd.Connection = con;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@id", lbltest.Text);
                    cmd.Parameters.AddWithValue("@description", txtDescription.Text);
                    cmd.Parameters.AddWithValue("@subject", txtSubject.Text);
                    cmd.Parameters.AddWithValue("@staffId", ddlStaff.SelectedItem.Value);
                    ...
                    cmd.Parameters.AddWithValue("@Status", RadioButtonListContract.SelectedValue);
                    cmd.Parameters.AddWithValue("@EmpID", UserId);
                    cmd.Parameters.AddWithValue("@Designation", Designation);            
                    con.Open();
                    ...
                    if (Result < 0)
                    {
                        ...
                        Response.Redirect("~/Contract_Staff.aspx?edit1=" + edit + "", false);
                    }
                    else
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Contract Details Not Edit Successfully";
                    }
