...
{
    public partial class New_ContractContact : System.Web.UI.Page
    {
        ...
        int Result;
        string result, Name;
        string trash, visible, isExpired;
        ...
        public void ClearAll()
        {
            ...
            ddlpartnername.SelectedIndex = -1;
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            string pdfFilePath = Server.MapPath("~/path/to/your/file.pdf");

            // Retrieve the filename without the path
            string pdfFileName = System.IO.Path.GetFileName(pdfFilePath);
            ...
            // End the response to prevent any further content from being sent
            Response.End();
        ...
        protected void btnSaveProject_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                try
                {
                    ...
                    using (SqlConnection con = new SqlConnection(strconnect))
                    {
                        SqlCommand cmd = new SqlCommand("SP_SaveContractPartner", con);
                        cmd.CommandType = CommandType.StoredProcedure;
                        ...
                        cmd.Parameters.AddWithValue("@not_visible_to_client", visible);
                        cmd.Parameters.AddWithValue("@add_by", UserName);
                        cmd.Parameters.AddWithValue("@is_expiry_notified", isExpired);
                        ...
                        if (i < 0)
                        {
                            ...
                            Response.Redirect("~/Contract_Contact.aspx?svd1=" + save + "", false);
                        }
                        else
                        {
