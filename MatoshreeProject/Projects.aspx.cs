    ...
    public partial class Projects : System.Web.UI.Page
    {
        ...
        public void ProjectCountByEmpID(int UserID)
        {
            try
            {
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetNotStartedProjectCountbyEmpID", con);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@EmpID", UserID);
                    int totalProjectCount = (int)command.ExecuteScalar();

                    lblNotStartedProjectCount.Text = Convert.ToString(totalProjectCount);
                }
                ...
                using (SqlConnection con1 = new SqlConnection(strconnect))
                {
                    ...
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@EmpID", UserID);
                    int activeProjectCount = (int)command.ExecuteScalar();

                    lblInProgressProjectCount.Text = Convert.ToString(activeProjectCount);
                }
                ...
                {
                    con2.Open();
                    SqlCommand command = new SqlCommand("SP_GetOnHoldProjectCountbyEmpID", con2);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@EmpID", UserID);
                    int InactiveProjectCount = (int)command.ExecuteScalar();

                    lblOnHoldProjectCount.Text = Convert.ToString(InactiveProjectCount);
                }
                ...
                {
                    con3.Open();
                    SqlCommand command = new SqlCommand("SP_GetFinishedProjectCountBYEmpID", con3);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@EmpID", UserID);
                    int InactiveProjectCount = (int)command.ExecuteScalar();

                    lblFinishedProjectCount.Text = Convert.ToString(InactiveProjectCount);
                }
            }
            catch (Exception ex)
            {
        ...
        public void ProjectCount()
        {
            try
            {
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetNotStartedProjectCount", con);
                    command.CommandType = CommandType.StoredProcedure;
                    int totalProjectCount = (int)command.ExecuteScalar();
                ...
                {
                    con2.Open();
                    SqlCommand command = new SqlCommand("SP_GetOnHoldProjectCount", con2);
                    command.CommandType = CommandType.StoredProcedure;
                    int InactiveProjectCount = (int)command.ExecuteScalar();
                ...
                {
                    con3.Open();
                    SqlCommand command = new SqlCommand("SP_GetFinishedProjectCount", con3);
                    command.CommandType = CommandType.StoredProcedure;
                    int InactiveProjectCount = (int)command.ExecuteScalar();
        ...
        public void StaffOperationPermission()
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(strconnect))
                {
                    ...
                    command.Parameters.AddWithValue("@SubModule", "PROJECTS");
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        else if (View == "True")
                        {
                            ...
                            ProjectDetailReportByEmpID(UserId);
                            GetCompanyAddress();
                            if (Create == "True")
                            {
                                addnew.Visible = true;
        ...
        public void GetMessageFromModules()
        {
            try
            {
                ...
                if (MSGdata == "fgsave123q" && EdidDATA == null)
                {
                    ...
                    lblMessage.Text = "Project Details Save Successfully";
                }
                else if (EdidDATA == "xcvfedit" && MSGdata == null)
                {
                    Toasteralert.Visible = true;
                    lblMessage.Text = "Project Details Edit Successfully";
                }
            ...
            try
            {
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    ...
                    else
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Project Details Not Deleted";
                    }
