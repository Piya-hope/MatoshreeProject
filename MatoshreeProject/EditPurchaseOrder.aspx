<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="EditPurchaseOrder.aspx.cs" Inherits="MatoshreeProject.EditPurchaseOrder" EnableEventValidation="false" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                <h5 class="font-weight-medium mb-0">Edit PurchaseOrder</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-muted" aria-current="page" href="#">Edit PurchaseOrder</li>
                    </ol>
                </nav>
            </div>
            <%-- Toaster --%>
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-6 border-right">
                                <asp:UpdatePanel ID="UpdatePanelddlState" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <asp:Label ID="lblPurchaseOrderid" runat="server" Text="" CssClass="font-14 font-bold" Visible="false"></asp:Label>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                            ...
                                            <div class="mb-2">
                                                <asp:RequiredFieldValidator ID="rfv_POName" ControlToValidate="txtPOName" Display="Dynamic" runat="server" ErrorMessage="Enter PO Name" ForeColor="Red" ValidationGroup="PurchaseOrder" Font-Size="12px"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                            <div class="mb-2">
                                                ...
                                                <asp:TextBox ID="txtPOAmount" runat="server" CssClass="form-control col-md-11" placeholder="Enter Amount"></asp:TextBox>
                                            </div>
                                            <div class="mb-2">
                                                <asp:RequiredFieldValidator ID="rfv_txtAmount" ControlToValidate="txtPOAmount" Display="Dynamic" runat="server" ErrorMessage="Enter Amount" ForeColor="Red" ValidationGroup="PurchaseOrder" Font-Size="12px"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                            <div class="mb-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <asp:Button ID="Btn_Upload" runat="server" Text="Upload" CssClass="btn btn-primary btn-sm" OnClick="Btn_Upload_Click" ValidationGroup="File" />
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable">
                                        <div class="modal-content">
                                            <div class="modal-header d-flex align-items-center">
                                                ...
                                                <asp:Button ID="btnPOCloseModalItem" runat="server" Text="" CssClass="btn-close" OnClick="btnPOCloseModalItem_Click" data-bs-dismiss="modal" aria-label="Close" />
                                            ...
                                            <div class="modal-footer mb-2">
                                                <asp:Button ID="btnPOSaveModalItem" runat="server" Text="Save" CssClass="btn btn-sm btn-primary" OnClick="btnPOSaveModalItem_Click" ValidationGroup="SavePOItem" />
                                                &nbsp;&nbsp;
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="GridProcurement" runat="server" ScrollBars="Both" CssClass="table border table-bordered table-hover text-nowrap align-content-center" AutoGenerateColumns="false" CellPadding="4" Style="width: 100%"
                                        ClientIDMode="Static" Font-Bold="false" HeaderStyle-BackColor="#f8f9fa" HeaderStyle-ForeColor="Blue" HeaderStyle-Font-Bold="true" ShowFooter="true" DataKeyNames="ID">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-Width="60px">
                                                ...
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtQty1" runat="server" Text='<%# Bind("Quantity") %>' CssClass="form-control" Placeholder="Quantity" TextMode="Number" Style="width: 60px" OnTextChanged="txtQty1_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                    ...
                                    <asp:GridView ID="GridServicesList" runat="server" ScrollBars="Both" CssClass="table border table-bordered table-hover text-nowrap align-content-center" AutoGenerateColumns="false" CellPadding="4" Style="width: 100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-Width="60px">
                                                ...
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtQtyService1" runat="server" Text='<%# Bind("Quantity") %>' CssClass="form-control" Placeholder="Quantity" TextMode="Number" Style="width: 60px" AutoPostBack="true" OnTextChanged="txtQtyService1_TextChanged"></asp:TextBox>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblQuantity1" runat="server" Text='<%# Bind("Quantity") %>' Font-Bold="false" Font-Size="12px"></asp:Label>
                                                </ItemTemplate>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12">
                            ...
                            <div class="mb-2">
                                <asp:Button ID="Btn_Update" runat="server" Text="Update" CssClass="btn btn-sm btn-success" ValidationGroup="PurchaseOrder" OnClick="Btn_Update_Click" />
                                &nbsp;&nbsp;                         
