<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="Office_Expences.aspx.cs" Inherits="MatoshreeProject.Office_Expences" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var GridOfficeExpenses = $("#GridOfficeExpenses").prepend($("<thead></thead>").append($("#GridOfficeExpenses").find("tr:first"))).DataTable(
                {
                    "responsive": true,
                    "scrollY": "300px",
                    "scrollX": "80%",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <h5 class="font-weight-medium mb-0">Office Expenses</h5>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item text-muted" aria-current="page" href="Office_Expences.aspx">Office Expenses</li>
            </ol>
        </nav>
        <br />
        <div class="row">
            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                <div class="row">
                    <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                        <div id="addnew" runat="server">
                            <asp:Button ID="btnRecordOfficeExpense" runat="server" Text="New  Expenses" CssClass="btn btn-sm btn-primary" OnClick="btnRecordOfficeExpense_Click" />
                            <hr />
                        </div>
                    </div>
                ...
                <%-- Summery strat------------%>
                <h5 class="font-weight-medium mb-0">Office Expenses Summary</h5>
                <br />
                <div class="row">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-auto">
                                        <span class="text-success display-6">
                                            <iconify-icon icon="solar-notes-broken" class="aside-icon"></iconify-icon>
                                        </span>
            ...
            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-body">
                         <h5 class="font-weight-medium mb-0">View Office Expenses Details</h5>
                        <hr />
                        <div class="row">
                        ...
                        <br />
                        <br />
                        <asp:GridView ID="GridOfficeExpenses" runat="server" ScrollBars="Both" OnRowDataBound="GridOfficeExpenses_RowDataBound" CssClass="table border table-bordered table-hover text-nowrap align-content-center" AutoGenerateColumns="false" Width="100%" CellPadding="4"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Expenses" SortExpression="Exp_Name" HeaderStyle-Font-Size="12px">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblExp_Name1" runat="server" Text='<%# Bind("Exp_Name") %>' TabIndex="6" Font-Bold="false" Visible="true" Font-Size="12px"></asp:Label>
                                ...
                                <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="12px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnEditOfficeExpenses" runat="server" CssClass="btn btn-sm btn-outline-info" OnClick="btnEditOfficeExpenses_Click"><i class="ti ti-edit"></i></asp:LinkButton>
                                    </ItemTemplate>
