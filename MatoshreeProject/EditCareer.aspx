<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="EditCareer.aspx.cs" Inherits="MatoshreeProject.EditCareer" %>
      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                <h5 class="font-weight-medium mb-0">Edit Career</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-muted" aria-current="page" href="EditCareer.aspx">Edit Career</li>
                    </ol>
                </nav>
            </div>
            <%-- Toaster --%>
            ...
            <div class="col-md-12 col-sm-12 col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div claa="row">
                            <div class="mb-2">
                                <span class="font-12"><input id="ContentPlaceHolder1_Cbx_Mail" type="checkbox" name="ctl00$ContentPlaceHolder1$Cbx_Mail"><label for="ContentPlaceHolder1_Mail">Send Mail</label></span>
                                 &nbsp;&nbsp;
                              <%--  <span class="font-14 mr-3"><input id="ContentPlaceHolder1_Cbx_Cash" type="checkbox" name="ctl00$ContentPlaceHolder1$Cbx_Cash"><label for="ContentPlaceHolder1_Cbx_Cash">Billable</label></span>

                                
                                <a id="ContentPlaceHolder1_linkAttachment" class="font-14 fa-pull-right" href="javascript:__doPostBack('ctl00$ContentPlaceHolder1$linkAttachment','')">Attach Files</a>

                            </div>--%>
                                </div>
                        </div>
                        <div class="mb-2">
                            <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="btn btn-sm btn-success" ValidationGroup="SaveValidate" OnClick="btnUpdate_Click"/>
                            <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btn btn-sm btn-danger" ValidationGroup="Validateclear" OnClick="btnCancel_Click" />
