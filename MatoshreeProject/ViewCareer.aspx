<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="ViewCareer.aspx.cs" Inherits="MatoshreeProject.ViewCareer" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                <h5 class="font-weight-medium mb-0">View Career</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-muted" aria-current="page" href="ViewCareer.aspx">View Career</li>
                    </ol>
                </nav>
            </div>
            <%-- Toaster --%>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                         ...
                         <%--    <div class="col-md-6 col-sm-6 col-lg-6">
                                <div class="mb-2">
                                    <asp:Label ID="Label1" runat="server" Text="Attach Your Resume" CssClass="form-label"></asp:Label>&nbsp;<span style="color: #FF0000">*</span>
                                    <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" placeholder="Enter Attach Your Resume"></asp:TextBox>
                                    <asp:RequiredFieldValidator runat="server" Display="Dynamic" ControlToValidate="txtEmployeement" ErrorMessage="Enter Attach Your Resume" ForeColor="Red" ValidationGroup="SaveValidate" Font-Size="12px"></asp:RequiredFieldValidator>
                                </div>
                            </div>--%>
                           <%--   <div class="col-md-6 col-sm-6 col-lg-6">
                                <div class="mb-2">
                                    <asp:HyperLink ID="hlResume" runat="server" Text="" Visible="false" NavigateUrl=""></asp:HyperLink>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <asp:Button ID="Btn_Upload" runat="server" Text="Upload" CssClass="btn btn-primary rounded-end" OnClick="Btn_Upload_Click" ValidationGroup="SaveValidate" />
                                    </div>
                             ...
                             <div class="col-md-6 col-sm-6 col-lg-6">
                              <div class="mb-2">
                                        <asp:Label ID="lblAttachment1" runat="server" Text="Attach Your Resume" CssClass="form-label" Visible="false"></asp:Label>
                                        <div class="input-group">
                                            <asp:FileUpload ID="FileUpload" runat="server" Text="" CssClass="form-control mdi-file-import" Visible="false"/>

                                         <%--   <asp:Button ID="Btn_Upload" runat="server" CssClass="btn btn-primary rounded-end"  ValidationGroup="SaveValidate" />--%>
                                            </div>
                                          <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="FileUpload" Visible="false" ErrorMessage="Attach Your Resume To upload"  ForeColor="Red" InitialValue="" Display="Dynamic" ValidationGroup="SaveValidate" Font-Size="12px" />
                        ...
                        <center>
                        <div class="mb-2">
                            <asp:Button ID="btnAccept" runat="server" Text="Accept" CssClass="btn btn-sm btn-primary" ValidationGroup="SaveValidate" OnClick="btnAccept_Click" />
                            <asp:Button ID="btnReject" runat="server" Text="Reject" CssClass="btn btn-sm btn-danger" ValidationGroup="Validateclear" OnClick="btnReject_Click" />
                              <asp:LinkButton ID="btnResumeDownload" runat="server" CausesValidation="false" CommandName="ResumeDownload" OnClick="btnResumeDownload_Click" CssClass="btn btn-sm btn-success " Visible="true">Resume  <i class="ti ti-download" ></i></asp:LinkButton>
