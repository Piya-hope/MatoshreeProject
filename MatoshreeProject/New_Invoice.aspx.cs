...
namespace MatoshreeProject
{
    public partial class New_Invoice : System.Web.UI.Page
    {
        ...
        public string GETReceiptINITIAL()
        {
            ...
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@ReceiptFor", "Invoice");
        ...
        public void Calculatefilldata()
        {
            using (SqlConnection con1 = new SqlConnection(strconnect))
            {
                ...
                com.Parameters.AddWithValue("@InvoiceNumber", txtInvoiceNumber.Text);
        ...
        public void GetTaxlistCalculationESTIMATE()
        {
            try
            {
        ...
        public void CalculatefilldataEstimate()
        {
            using (SqlConnection con1 = new SqlConnection(strconnect))
            {
                ...
                GetItemTaxEstimate(Estimate); // Sum Total Item Tax               
                GetTaxlistCalculationESTIMATE();//Total Calculation For Invoice 
            }
        }
        ...
        //------------------------------------------------------------//
        public string GetItemTaxEstimate(string Estimattteno)
        {
            string Sumtax1;
            SqlConnection conn = new SqlConnection(strconnect);
        ...
        protected void GetEstimateDetailsByID(string EstimateID)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    Estmate1.Visible = true;
                    txtEstimateNumber.Text = dt.Rows[0]["EstimateNo"].ToString();
                    txtInvoiceDate.Attributes["value"] = DateTime.Parse(dt.Rows[0]["EstimateDate"].ToString()).ToString("yyyy-MM-dd");
                    ...
                    //ddlS.SelectedItem.Text = dt.Rows[0]["Status"].ToString();
                    ...
                    GetItemTaxEstimate(txtEstimateNumber.Text);
                    GetTaxlistCalculation();
        ...
        public void Clear()
        {
            ...
            txtInvoiceNumber.Text = ReceiptNumner;
                ...
                if (Session["LoginType"] != null)
                {
                    ...
                    if (Session["LoginType"].ToString() == "Administrator")
                    {
                        ...
                        if (!this.IsPostBack)
                        {
                            ...
                            EsimateData = HttpUtility.UrlDecode(Request.QueryString["ID"]);
                            lblEstimateData.Text = EsimateData;

                            if (lblEstimateData.Text == "")
                            {
                                //Invoice Direct
                                string ReceiptNumner = GETReceiptINITIAL();
                                ...
                                txtInvoiceDate.Attributes["value"] = DateTime.Parse(Todaydate.ToString()).ToString("yyyy-MM-dd");
                            ...
                            else
                            {
                                ...
                                ddlDiscountType.Visible = false;
                                bindItem();
                                GetEstimateDetailsByID(lblEstimateData.Text);
                                CalculatefilldataEstimate();
                            }
        ...
        protected void btnSaveAsDraft_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SP_SaveInvoice", con);
                cmd.Connection = con;
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                string AddressCustomer = billaddressTo + ',' + billaddress1 + ',' + billaddress2 + ',' + billaddress3 + ',' + billaddress4 + ',' + billaddress5 + ',' + billaddress6 + ',' + billaddress7;
                string ShippAddressCustomer = shipaddressTo + ',' + shipaddressTo1 + ',' + shipaddressTo2 + ',' + shipaddressTo3 + ',' + shipaddressTo4 + ',' + shipaddressTo5 + ',' + shipaddressTo6 + ',' + shipaddressTo7;
                ...
                cmd.Parameters.AddWithValue("@Discount_Type", "distnull");//ddlDiscountType.SelectedItem.Text
                ...
                cmd.Parameters.AddWithValue("@BillingTypeID", "0"); /*ddlBillTask.SelectedItem.Value*/
                ...
                if (Result > 0)
                {
                    ...
                    Response.Redirect("~/Chart_List_Invoice.aspx?Draft1=" + Draft + "", false);
                }
                else
                {
                    Toasteralert.Visible = false;
                    deleteToaster.Visible = true;
                    lblMesDelete.Text = "New Invoice Details Draft Not Added Successfully";
                }
                Clear();
                con.Close();
            }
            ...
            if (Page.IsValid)
            {
                try
                {
                    ...
                    if (Result > 0)
                    {
                        ...
                        Response.Redirect("~/Chart_List_Invoice.aspx?svd1=" + save + "", false);
                    }
                    else
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "New Invoice Details Not Save Successfully";
                    }
                    Clear();
                    con.Close();
                }
            ...
            try
            {
                ...
                using (SqlConnection UserCon = new SqlConnection(strconnect))
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        TotalAmountTax1 = (Convert.ToDouble(SubTotal)) * (Convert.ToDouble(lblTaxValeesF.Text) / 100);
                        TotalAmountTax2 = (Convert.ToDouble(SubTotal)) * (Convert.ToDouble(lblTaxValees1AF.Text) / 100);
        ...
        protected void btnDeleteItemCal_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SqlConnection con1 = new SqlConnection(strconnect))
                {
                    SqlCommand com = new SqlCommand("SP_DeleteInvoiceItem", con1);
                    com.CommandType = CommandType.StoredProcedure;
                    com.Parameters.AddWithValue("@InvoiceNumber", txtInvoiceNumber.Text);
                    ...
                    if (i < 0)
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Invoice Item Remove Successfully";
                    }
                    else
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Invoice  Item Not Remove Successfully";
                    }
                    con1.Close();
                    Calculatefilldata();
                }
            ...
            try
            {
                if (Page.IsValid)
                {
                    ...
                    else
                    {
                        ...
                        {
                            SqlCommand cmd = new SqlCommand("SP_SaveInvoiceItemCalulation", con);
                            cmd.Connection = con;
                            cmd.CommandType = CommandType.StoredProcedure;
                            ...
                            if (Result > 0)
                            {
                                Toasteralert.Visible = false;
                                deleteToaster.Visible = true;
                                lblMesDelete.Text = "Invoice New Item Added Successfully";
                            }
                            else
                            {
                                Toasteralert.Visible = false;
        ...
        protected void txtQty1_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SqlConnection con1 = new SqlConnection(strconnect))
                {
                    SqlCommand com = new SqlCommand("SP_UpdateInvoiceItem", con1);
                    com.CommandType = CommandType.StoredProcedure;
                    com.Parameters.AddWithValue("@InvoiceNumber", txtInvoiceNumber.Text);
                    ...
                    if (i < 0)
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Invoice Item Quantity Change Successfully";
                    }
                    else
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Invoice Item Quantity Not Change Successfully";
                    }
                    con1.Close();
                    Calculatefilldata();
                }
        ...
        protected void ddlSalesAgent_SelectedIndexChanged(object sender, EventArgs e)
        {
            Calculatefilldata();
        }
            ...
            try
            {
                ...
                using (SqlConnection con1 = new SqlConnection(strconnect))
                {
                    ...
                    if (i < 0)
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Invoice Item Rate Change Successfully";
                    }
                    else
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Invoice Item Rate Not Change Successfully";
                    }
                    con1.Close();
                    Calculatefilldata();
                }
            ...
            try
            {
                ...
                using (SqlConnection con1 = new SqlConnection(strconnect))
                {
                    ...
                    if (i < 0)
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Invoice Item GST1 Change Successfully";
                    }
                    else
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Invoice Item GST1 Not Change Successfully";
                    }
                    con1.Close();
                    Calculatefilldata();
                }
            ...
            try
            {
                ...
                using (SqlConnection con1 = new SqlConnection(strconnect))
                {
                    ...
                    if (i < 0)
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Invoice Item GST2 Change Successfully";
                    }
                    else
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Invoice Item GST2 Not Change Successfully";
                    }
                    con1.Close();
                    Calculatefilldata();
                }
        ...
        // Total Sum Tax Percent of Item
        //------------------------------------------------------------//
        public string GetItemTax(string invnmber)
        {
            string Sumtax1;
            SqlConnection conn = new SqlConnection(strconnect);
            SqlCommand cmd = new SqlCommand("SP_TaxInvoiceItemTotal", conn);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@InvoiceNumber", invnmber);
            cmd.Parameters.AddWithValue("@CustID", ddlCustomers.SelectedItem.Value);
            cmd.Parameters.AddWithValue("@ProjectID", ddlProjects.SelectedItem.Value);
            cmd.Parameters.AddWithValue("@Saleagent", ddlSalesAgent.SelectedItem.Value);
            SqlDataAdapter sda = new SqlDataAdapter(cmd);
        ...
        public void TotalInvoiceCost()
        {
            try
            {
                ...
                if (DiscountCost == "%")
                {
                    double PerCost = Convert.ToDouble(txtDist);
                ...
                {
                    double AmountCost = Convert.ToDouble(txtDist);
                    DiscountItem1 = AmountCost;
                }
                else
                {
                ...
                Double INVOICETOTALAMONT1 = (SubtotalItem1 - DiscountItem1);

                Double TaxInvoiceAMOUNT = (INVOICETOTALAMONT1 * TaxTotalItem1) / 100;

                GetTaxlistCalculation();

                lbltotaltaxPer.Text = Convert.ToString("% " + TaxTotalItem1);
                lbltotalcosttax.Text = Convert.ToString("₹ " + TaxInvoiceAMOUNT);

                INVOICETOTALAMONT = INVOICETOTALAMONT1 + TaxInvoiceAMOUNT + Adjustment1;

                if (INVOICETOTALAMONT == 0)
                {
                    lbltotalAmonutInvoiceCost.Text = Convert.ToString("₹ " + "0.00");
                    TotalInvoiceAmont = '0';
                    lblAmont30.Text = "0";
                ...
                {
                    lbltotalAmonutInvoiceCost.Text = Convert.ToString("₹ " + INVOICETOTALAMONT);
                    TotalInvoiceAmont = Convert.ToDecimal(INVOICETOTALAMONT);
                    TotalInvoiceAmont = Math.Round(TotalInvoiceAmont);
                    lblAmont30.Text = Convert.ToString(TotalInvoiceAmont);
                    lbltotalAmonutInvoiceCost.Text = Convert.ToString("₹ " + TotalInvoiceAmont);
                }
            }
            catch (Exception ex)
            {
        ...
        //  SubCost of Item
        //------------------------------------------------------------//
        public void SubCostTotalInvoiceAmont()
        {
            try
            {
                SqlConnection conn = new SqlConnection(strconnect);
                SqlCommand cmd = new SqlCommand("SP_TotalCostInvoiceItem", conn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@InvoiceNumber", txtInvoiceNumber.Text);
                cmd.Parameters.AddWithValue("@CustID", ddlCustomers.SelectedItem.Value);
                cmd.Parameters.AddWithValue("@ProjectID", ddlProjects.SelectedItem.Value);
        ...
        public void GetTaxlistCalculation()
        {
            try
            {
                ...
                using (SqlConnection conn2 = new SqlConnection(strconnect))
                {
                    ...
                    double Discount = Convert.ToDouble(DiscountItem1);
                    string Taxname, Taxper, TaxAmountCost;
                    SqlCommand cmd2 = new SqlCommand("SP_TaxInvoiceItem", conn2);
                    cmd2.Connection = conn2;
                    cmd2.CommandType = CommandType.StoredProcedure;
                    cmd2.Parameters.AddWithValue("@InvoiceNumber", txtInvoiceNumber.Text);
                    cmd2.Parameters.AddWithValue("@CustID", ddlCustomers.SelectedItem.Value);
                    cmd2.Parameters.AddWithValue("@ProjectID", ddlProjects.SelectedItem.Value);
                    cmd2.Parameters.AddWithValue("@Saleagent", ddlSalesAgent.SelectedItem.Value);
                    using (SqlDataAdapter sda2 = new SqlDataAdapter(cmd2))
                    {
                        ...
                        if (dt2.Rows.Count > 0)
                        {
                            ...
                            for (int i = 0; i < dt2.Rows.Count; i++)
                            {
                                ...
                                using (SqlConnection contax = new SqlConnection(strconnect))
                                {
                                    SqlCommand cmdtax = new SqlCommand("SP_GetCountTaxNameInvoice", contax);
                                    cmdtax.Connection = contax;
                                    cmdtax.CommandType = CommandType.StoredProcedure;
                                    cmdtax.Parameters.AddWithValue("@InvoiceNumber", txtInvoiceNumber.Text);
                                    cmdtax.Parameters.AddWithValue("@TaxName", Taxname);
                                    cmdtax.Parameters.AddWithValue("@CustID", ddlCustomers.SelectedItem.Value);
                                    cmdtax.Parameters.AddWithValue("@ProjectID", ddlProjects.SelectedItem.Value);
                                    cmdtax.Parameters.AddWithValue("@Saleagent", ddlSalesAgent.SelectedItem.Value);
                                ...
                                using (SqlConnection contax2 = new SqlConnection(strconnect))
                                {
                                    SqlCommand cmdtax2 = new SqlCommand("SP_GetCountTaxName2Invoice", contax2);
                                    cmdtax2.Connection = contax2;
                                    cmdtax2.CommandType = CommandType.StoredProcedure;
                                    cmdtax2.Parameters.AddWithValue("@InvoiceNumber", txtInvoiceNumber.Text);
                                    cmdtax2.Parameters.AddWithValue("@TaxName", Taxname);
                                    cmdtax2.Parameters.AddWithValue("@CustID", ddlCustomers.SelectedItem.Value);
                                    cmdtax2.Parameters.AddWithValue("@ProjectID", ddlProjects.SelectedItem.Value);
                                    cmdtax2.Parameters.AddWithValue("@Saleagent", ddlSalesAgent.SelectedItem.Value);
