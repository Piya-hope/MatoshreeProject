      ...
      /*  string Designation = "Admin";*/ //Designation=Designation
        ...
        public void GroupCount()
        {
            try
            {
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetTotalGroupsCount", con);
                    command.CommandType = CommandType.StoredProcedure;
                    int totalVendorsCount = (int)command.ExecuteScalar();

                    lblTotalGroupCount.Text = Convert.ToString(totalVendorsCount);
                }
                ...
                {
                    con1.Open();
                    SqlCommand command = new SqlCommand("SP_GetActiveGroupsCount", con1);
                    command.CommandType = CommandType.StoredProcedure;
                    int activeVendorsCount = (int)command.ExecuteScalar();

                    lblActiveGroupCount.Text = Convert.ToString(activeVendorsCount);
                }
                ...
                {
                    con2.Open();
                    SqlCommand command = new SqlCommand("SP_GetInactiveGroupsCount", con2);
                    command.CommandType = CommandType.StoredProcedure;
                    int inactiveVendorsCount = (int)command.ExecuteScalar();

                    lblInActiveGroupCount.Text = Convert.ToString(inactiveVendorsCount);
                }
            }
            catch (Exception ex)
            {
        ...
        public DataTable ViewGroupDetails()
        {
            DataTable table = new DataTable();
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["DBConnection"].ToString()))
            {
                using (SqlDataAdapter ad = new SqlDataAdapter("SP_ViewGroupDetail", con))
                {
                    ad.Fill(table);
                    GridviewGroup1.DataSource = table;
                    GridviewGroup1.DataBind();
                }
            }
            return table;
        ...
        {
            string groupID;
            var rows = GridviewGroup1.Rows;
            LinkButton btn = (LinkButton)sender;
            GridViewRow row = (GridViewRow)btn.NamingContainer;
            int rowindex = Convert.ToInt32(row.RowIndex);
            groupID = ((Label)rows[rowindex].FindControl("lblGroupID1")).Text;
            Response.Redirect("~/Edit_Group.aspx?group=" + groupID + "", false);
        }
        ...
        protected void BTN_Visibility_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["DBConnection"].ToString()))
            {
                using (SqlDataAdapter ad = new SqlDataAdapter("SP_ViewGroupVisibility", con))
                {
                    ad.Fill(table);
                    GridviewGroup1.DataSource = table;
                    GridviewGroup1.DataBind();
        ...
        protected void GridviewGroup1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                foreach (GridViewRow gridviedrow in GridviewGroup1.Rows)
                {
                    string Status = ((Label)gridviedrow.FindControl("lblStatus")).Text;
                    Label lblGroupID1 = (Label)gridviedrow.FindControl("lblGroupID1");
                    Label lblGroupName1 = (Label)gridviedrow.FindControl("lblGroupName1");
                    Label lblColor1 = (Label)gridviedrow.FindControl("lblColor1");
                    Label lblShortdescription1 = (Label)gridviedrow.FindControl("lblShortdescription1");
                    Label lblOrder1 = (Label)gridviedrow.FindControl("lblOrder1");



                    if (Status == "True")
                    {
                        lblGroupID1.ForeColor = Color.Blue;
                        lblGroupName1.ForeColor = Color.Blue;
                        lblColor1.ForeColor = Color.Blue;
                        lblShortdescription1.ForeColor = Color.Blue;
                        lblOrder1.ForeColor = Color.Blue;

                    }
                    else
                    {

                        lblGroupID1.ForeColor = Color.Red;
                        lblGroupName1.ForeColor = Color.Red;
                        lblColor1.ForeColor = Color.Red;
                        lblShortdescription1.ForeColor = Color.Red;
                        lblOrder1.ForeColor = Color.Red;
            ...
            try
            {
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    ...
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        ...
                        dtExport.Columns.Add("Color");
                        dtExport.Columns.Add("ShortDescription");
                        dtExport.Columns.Add("Order");
                        ...
                        foreach (DataRow row in dt.Rows)
                        {
                            ...
                            newRow["ID"] = row["Group_ID"];
                            newRow["GroupName"] = row["Group_Name"];
            ...
            try
            {
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    ...
                    using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
                    {
                        ...
                        _document.Open();
                        _pdfPTable.SetWidths(new float[] { 3f, 9f, 9f, 13f, 9f, 9f, 9f, 9f });//column width in doc       
                                                                                                       //----Header PDF--------------------------//
                                                                                                       //Company Logo
                        ...
                        _fontStyle = FontFactory.GetFont("Tahoma", 9f, 1, BaseColor.WHITE);
                        _pdfPCell = new PdfPCell(new Phrase("Color", _fontStyle));
                        _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                        _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                        _pdfPCell.BackgroundColor = BaseColor.GRAY;
                        _pdfPCell.ExtraParagraphSpace = 2;
                        ...
                        _fontStyle = FontFactory.GetFont("Tahoma", 9f, 1, BaseColor.WHITE);
                        _pdfPCell = new PdfPCell(new Phrase("Shortdescription", _fontStyle));
                        _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                        _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                        _pdfPCell.BackgroundColor = BaseColor.GRAY;
                        _pdfPCell.ExtraParagraphSpace = 2;
                        ...
                        _fontStyle = FontFactory.GetFont("Tahoma", 9f, 1, BaseColor.WHITE);
                        _pdfPCell = new PdfPCell(new Phrase("Created_Date", _fontStyle));
                        _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                        _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                        _pdfPCell.BackgroundColor = BaseColor.GRAY;
                        _pdfPCell.ExtraParagraphSpace = 2;
                        ...
                        _fontStyle = FontFactory.GetFont("Tahoma", 9f, 1, BaseColor.WHITE);
                        _pdfPCell = new PdfPCell(new Phrase("Created_by", _fontStyle));
                        _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                        _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                        _pdfPCell.BackgroundColor = BaseColor.GRAY;
                        _pdfPCell.ExtraParagraphSpace = 2;
                        ...
                        foreach (DataRow row in _Vhrlist.Rows)
                        {
                            ...
                            _pdfPCell = new PdfPCell(new Phrase(row["Group_Name"].ToString(), _fontStyle));
                            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                            _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                            _pdfPCell.BackgroundColor = BaseColor.WHITE;
                            _pdfPCell.ExtraParagraphSpace = 1;
                            ...
                            _pdfPCell = new PdfPCell(new Phrase(row["Color"].ToString(), _fontStyle));
                            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                            _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                            _pdfPCell.BackgroundColor = BaseColor.WHITE;
                            _pdfPCell.ExtraParagraphSpace = 1;
                            ...
                            _pdfPCell = new PdfPCell(new Phrase(row["Shortdescription"].ToString(), _fontStyle));
                            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                            _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                            _pdfPCell.BackgroundColor = BaseColor.WHITE;
                            _pdfPCell.ExtraParagraphSpace = 1;
                            ...
                            _pdfPCell = new PdfPCell(new Phrase(row["order"].ToString(), _fontStyle));
                            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                            _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                            _pdfPCell.BackgroundColor = BaseColor.WHITE;
                            _pdfPCell.ExtraParagraphSpace = 1;
                        ...
                        string PDFFileName = string.Format("GroupList_" + dTime.ToString("dd/MM/yyyy HH:mm") + ".pdf");
                        Response.Clear();
                ...
                else if (RoleType == Designation)
                {
                    ...
                    using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
                    {
                        ...
                        _fontStyle = FontFactory.GetFont("Arial", 14f, 2);
                        _pdfPCell = new PdfPCell(new Phrase("GroupList", _fontStyle));
                        _pdfPCell.Colspan = 5;
                        _pdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT;
                        _pdfPCell.Border = 0;
                        _pdfPCell.BackgroundColor = BaseColor.WHITE;
        ...
        protected void btnDeleteGroup_Click(object sender, EventArgs e)
        {
            ...
            GridViewRow row = (GridViewRow)btn.NamingContainer;
            int rowindex = Convert.ToInt32(row.RowIndex);
            group = ((Label)rows[rowindex].FindControl("lblGroupID1")).Text;

            SqlCommand cmd = new SqlCommand("SP_DeleteGroup", DeviceCon);
