<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="Contract.aspx.cs" Inherits="MatoshreeProject.Contract" %>
    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item text-muted" aria-current="page" href="Contract.aspx">Contract Customer </li>
            </ol>
        </nav>
        <%-- BreadCrumbs --%>
        <br />
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                ...
                <h5 class="fs-5 mt-3 mb-3">Contract Customer Summary</h5>             
                   <div class="row">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-auto">
                                        <span class="text-success display-6">
                                            <iconify-icon icon="ri:contract-line" class="aside-icon"></iconify-icon>
                                        </span>
                                   </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <%--  <asp:Chart ID="Chart2" runat="server" Height="400" Width="500" ImageLocation="~/charts_2/chart_3_0.png" ImageStorageMode="UseImageLocation">--%>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="font-weight-medium mt-3 mb-3">View Contract Customer Details</h5>
                        <hr />
                        <div class="row">
                            <div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
