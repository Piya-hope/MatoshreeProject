...
{
    public partial class New_ContractStaff : System.Web.UI.Page
    {
        ...
        public DataTable GetTaskbyModuleWise()
        {
            ...
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                ...
                sqlCommand.Parameters.AddWithValue("@BelongTo", "Contract Staff");
        ...
        public void Bindcontracttype()
        {
            try
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                {
                    ...
                    ddlContracttype.Items.Insert(0, new ListItem("Select Contract Type", "0"));
                }
            }
            catch (Exception ex)
            {
        ...
        public void BindContractStaff()
        {
            try
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                {
                    ...
                    ddlStaff.DataTextField = "LastName";
        ...
        protected void btnSaveProject_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                try
                {
                    ...
                    string uploadDirectory = Server.MapPath("~/Contract_Staff_Details_Upload/");
                    string fileName;
                    string filePath;
                    ...
                    using (SqlConnection con = new SqlConnection(strconnect))
                    {
                        ...
                        using (SqlCommand UserCommand = new SqlCommand("SP_SaveContractStaff", con))
                        {
                            UserCommand.CommandType = CommandType.StoredProcedure;
                            // Parameters
                            UserCommand.Parameters.AddWithValue("@description", txtDescription.Text);
                            UserCommand.Parameters.AddWithValue("@subject", txtSubject.Text);
                            UserCommand.Parameters.AddWithValue("@staffId", ddlStaff.SelectedValue);
                            UserCommand.Parameters.AddWithValue("@datestart", txtStartDate.Text);
                            UserCommand.Parameters.AddWithValue("@dateend", txtEndDate.Text);
                            UserCommand.Parameters.AddWithValue("@contract_type", ddlContracttype.SelectedValue);
                            UserCommand.Parameters.AddWithValue("@add_by", UserName);
                            UserCommand.Parameters.AddWithValue("@trash", trash);
                            UserCommand.Parameters.AddWithValue("@FileName", fileName);
                            UserCommand.Parameters.AddWithValue("@FilePath", filePath);
                            UserCommand.Parameters.AddWithValue("@visible", visible);
                            UserCommand.Parameters.AddWithValue("@contract_value", txtContractValue.Text);
                            ...
                            if (i < 0)
                            {
                                ...
                                Response.Redirect("~/Contract_Staff.aspx?svd1=" + save + "", false);
                            }
                            else
                            {
                                Toasteralert.Visible = false;
                                deleteToaster.Visible = true;
                                lblMesDelete.Text = "Contract Staff Details Not Saved Successfully";
                            }
        ...
        {
            Response.Redirect("~/EditContractStaff.aspx", false);
            Clear();
        }
        ...
        protected void btnrenw_Click(object sender, EventArgs e)
        {
            //renewForm.Visible = true;
        }
        ...
        protected void Linkbtnpdf_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (staffName == "Select Staff Members")
                {
                    staffName = "Contract Staff Details";

                }
                else
                {
                    staffName = ddlStaff.SelectedItem.Text;

                }


                Response.AddHeader("content-disposition", "attachment; filename=" + staffName + ".pdf");
        ...
        protected void lnkbtnstaff_Firstname_Click(object sender, EventArgs e)
        {
            ViewState["Data"] = null;
            FieldsList.Add(Convert.ToString(lnkbtnstaff_Firstname.Text));
        ...
        protected void LinkButtonstaff_lastname_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(LinkButtonstaff_lastname.Text));
        ...
        protected void LinkButtonstaff_email_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(LinkButtonstaff_email.Text));
        ...
        protected void lnkbtnclientphonno_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(lnkbtnclientphonno.Text));
        ...
        protected void lnkclientcountry_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(lnkclientcountry.Text));
        ...
        protected void lnkclient_city_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(lnkclient_city.Text));
        ...
        protected void lnkbtnclient_zip_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(lnkbtnclient_zip.Text));
        ...
        protected void lnkbtnvarno_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(lnkbtnvarno.Text));
        ...
        protected void lnkbtngstno_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(lnkbtngstno.Text));
        ...
        protected void lnkbtnstaffid_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(lnkbtnstaffid.Text));
        ...
        protected void lnkbtnstaffsub_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(lnkbtnstaffsub.Text));
        ...
        protected void lnkbtnstaffdesc_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(lnkbtnstaffdesc.Text));
        ...
        protected void lnkbtnstaffstartdate_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(lnkbtnstaffstartdate.Text));
        ...
        protected void lnkbtnstaffduedate_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(lnkbtnstaffduedate.Text));
        ...
        protected void lnkbtnstaffvalue_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(lnkbtnstaffvalue.Text));
        ...
        protected void lnklogourl_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(lnklogourl.Text));
        ...
        protected void lnkbtncrmurl_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(lnkbtncrmurl.Text));
        ...
        protected void lnkbtnadminurl_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(lnkbtnadminurl.Text));
        ...
        protected void lnkbtnmaindomain_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(lnkbtnmaindomain.Text));
        ...
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(lnkbtncompanyname.Text));
        ...
        protected void lnkbtnemailsign_Click(object sender, EventArgs e)
        {
            string Name = ViewState["Data"].ToString();
            FieldsList.Add(Convert.ToString(lnkbtnemailsign.Text));
