<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="Edit_Office_Expences.aspx.cs" Inherits="MatoshreeProject.Edit_Office_Expences" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        $(function () {
            $('#txtExpensesDate').datepick();
        });
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <h5 class="font-weight-medium  mb-0">Edit Office Expenses</h5>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item text-muted" aria-current="page" href="Edit_Office_Expences.aspx">Edit Office Expenses</li>
            </ol>
        </nav>
        <br />
        ...
        <div class="row">
            ...
            <div class="col-md-5 col-sm-5 col-ld-5">
                        ...
                        <div class="card-body">
                            <asp:UpdatePanel ID="UpdatePanelddlState" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:Label ID="lblMisID" runat="server" Text="" CssClass=" font-bold" Visible="false"></asp:Label>
                                    <div class="mb-2">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredCategory" runat="server" ErrorMessage="Select Expenses Category" ControlToValidate="ddlExpensesCategory" ForeColor="Red" Font-Bold="false" ValidationGroup="Expense1" InitialValue="0" Display="Dynamic" Font-Size="12px"></asp:RequiredFieldValidator>
                                    </div>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Select Expenses SubCategory" ControlToValidate="ddlSubCategory" ForeColor="Red" Font-Bold="false" ValidationGroup="Expense1" InitialValue="0" Display="Dynamic" Font-Size="12px"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="mb-2">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Enter Expenses BillNo" ControlToValidate="txtBillno" ForeColor="Red" Font-Bold="false" ValidationGroup="Expense" Font-Size="12px"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="mb-2">
                            ...
                            <div class="mb-2">
                                <asp:Button ID="btnupdateOfficeExpense" runat="server" Text="Update" CssClass="btn btn-success btn-sm" OnClick="btnupdateOfficeExpense_Click" ValidationGroup="Expense" />
                                &nbsp;&nbsp; 
                            <asp:Button ID="btnClear" runat="server" Text="Cancel" CssClass="btn btn-danger btn-sm" OnClick="btnClear_Click " ValidationGroup="Expenseclose" />
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-lg-12">
                                                <div class="table-responsive">
                                                    <asp:GridView ID="GridViewOffice" runat="server" ScrollBars="Both" CssClass="table border table-bordered table-hover" AutoGenerateColumns="false" CellPadding="4"
