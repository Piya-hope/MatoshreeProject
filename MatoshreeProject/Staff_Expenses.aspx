<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="Staff_Expenses.aspx.cs" Inherits="MatoshreeProject.Staff_Expenses" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var GridStaffExpenses = $("#GridStaffExpenses").prepend($("<thead></thead>").append($("#GridStaffExpenses").find("tr:first"))).DataTable(
                {
                    "responsive": true,
                    "scrollY": "300px",
                    "scrollX": "80%",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <h5 class="font-weight-medium mb-0">Staff Expenses</h5>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item text-muted" aria-current="page" href="Staff_Expenses.aspx">Staff Expenses</li>
            </ol>
        </nav>
        <br />
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                <div class="row">
                    <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                        <div id="addnew" runat="server">
                            <asp:Button ID="btnRecordStaffExpense" runat="server" Text="New Expense" OnClick="btnRecordStaffExpense_Click" CssClass="btn btn-sm btn-primary" />
                            <hr />
                        </div>
                    </div>
                ...
                <%-- Summery strat------------%>
                 <h5 class="font-weight-medium mb-0">Staff Expenses Summary</h5>
                <br />
                <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-body">
                         <h5 class="font-weight-medium mb-0">View Expenses Details</h5>
                        <hr />
                        <div class="row">
                            <div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
                                <div class="bd-example">
                                    ...
                                    <asp:Button ID="btn_Visibility" runat="server" Text="Visibility" OnClick="btn_Visibility_Click" CssClass="btn btn-sm  btn btn-sm btn-outline-info" />
                        ...
                        <br />
                        <br />
                        <asp:GridView ID="GridStaffExpenses" runat="server" ScrollBars="Both" CssClass="table border table-bordered table-hover text-nowrap align-content-center" AutoGenerateColumns="false" OnRowDataBound="GridStaffExpenses_RowDataBound" Width="100%" CellPadding="4"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ID" SortExpression="ExpId" HeaderStyle-Font-Size="12px" Visible="false">
                                    <EditItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Expenses" SortExpression="ExpName" HeaderStyle-Font-Size="12px">
                                    <EditItemTemplate>
                                        <asp:Label ID="lblExp_Name" runat="server" Text='<%# Bind("Exp_Name") %>' TabIndex="6" Font-Bold="false" Font-Size="12px"></asp:Label>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblExp_Name1" runat="server" Text='<%# Bind("Exp_Name") %>' TabIndex="6" Font-Bold="false" Visible="false" Font-Size="12px"></asp:Label>
                                        <asp:LinkButton ID="linkExp_Name1" runat="server" Text='<%# Bind("Exp_Name") %>' Font-Size="12px"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Amount" SortExpression="ExpAmount" HeaderStyle-Font-Size="12px">
                                    <EditItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="StaffName" SortExpression="First_Name" HeaderStyle-Font-Size="12px" Visible="false">
                                    <EditItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="ExpensesDate" SortExpression="ExpDate" HeaderStyle-Font-Size="12px">
                                    <EditItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="ExpensesType" SortExpression="ExpType" HeaderStyle-Font-Size="12px">
                                    <EditItemTemplate>
                                        <asp:Label ID="lblExpenses_Type" runat="server" Text='<%# Bind("Exp_Type") %>' TabIndex="6" Font-Bold="false" Font-Size="12px"></asp:Label>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblExpenses_Type1" runat="server" Text='<%# Bind("Exp_Type") %>' TabIndex="6" Font-Bold="false" Font-Size="12px"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="12px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnEditOfficeExpenses" runat="server" OnClick="btnEditOfficeExpenses_Click" CssClass="btn btn-sm btn-outline-info"><i class="ti ti-edit"  ></i></asp:LinkButton>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="12px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnDeleteOfficeExpenses" runat="server" CommandName="Delete" CssClass="btn btn-sm btn-outline-danger " OnClick="btnDeleteOfficeExpenses_Click"><i class="ti ti-trash"></i></asp:LinkButton>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                    </EditItemTemplate>
                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
