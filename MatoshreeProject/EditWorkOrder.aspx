<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="EditWorkOrder.aspx.cs" Inherits="MatoshreeProject.EditWorkOrder" %>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                    <h5 class="font-weight-medium mb-0">Edit WorkOrder</h5>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item text-muted" aria-current="page" href="#">Edit WorkOrder</li>
                        </ol>
                    </nav>
                </div>
                <%-- Toaster --%>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-lg-6 border-right">
                                ...
                                <asp:Label ID="lblContactVendorid" runat="server" Text="" CssClass=" " Visible="false"></asp:Label>
                                <asp:Label ID="lblworkid" runat="server" Text="" CssClass=" " Visible="false"></asp:Label>
                                <hr />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-lg-12">
                                                        <div class="mb-2">
                                                            <asp:Label ID="lblRadioButtonstatus" runat="server" Text="Status" Font-Bold="true" CssClass="form-label"></asp:Label><span class="text-danger"> *</span>
                                                            <asp:RadioButtonList ID="RadioButtonListStatus" runat="server" TabIndex="24" Font-Size="12px">
                                ...
                                <div class="row">
                                    <div class="col-md-6  col-sm-6 col-lg-6">
                                        <div class="mb-2">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ControlToValidate="ddlStatus" ErrorMessage="Select Status" ForeColor="Red" Display="Dynamic" ValidationGroup="Tender1" Font-Size="12px"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-2">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="txtcompletiondate" ErrorMessage="Enter Completion Date" ForeColor="Red" ValidationGroup="Tender1" Font-Size="12px"></asp:RequiredFieldValidator>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-2">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator26" runat="server" ControlToValidate="ddlauthname" ErrorMessage="Select Authority Name" ForeColor="Red" ValidationGroup="Tender1" Font-Size="12px" Display="dynamic"></asp:RequiredFieldValidator>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-2">
                                    ...
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="mb-2">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator25" runat="server" ControlToValidate="txtdocumenttype" ErrorMessage="Enter Document Type" ForeColor="Red" ValidationGroup="files" Font-Size="12px"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                            <asp:GridView ID="GridWorkOrderFile" runat="server" ScrollBars="Both" CssClass="table border table-bordered table-hover table-responsive" AutoGenerateColumns="false" CellPadding="4" Style="width: 100%"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField Visible="false">
                                                        <HeaderTemplate>
                                                            <asp:Label ID="lblWorkorderID" runat="server" Text="FileName" CssClass=" " Visible="false"></asp:Label>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField Visible="false">
                                                        <HeaderTemplate>
                                                            <asp:Label ID="lblWorkorderPath" runat="server" Text="FileName" CssClass=" " Visible="false"></asp:Label>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="12px">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnDeleteWorkorderFile" runat="server" ForeColor="Red" OnClientClick="return confirm('Are you sure you want to delete?')" OnClick="btnDeleteWorkorderFile_Click"><i class="ti ti-trash"></i></asp:LinkButton>
                                                        </ItemTemplate>
                                                        <EditItemTemplate>
                                                        </EditItemTemplate>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                            <asp:GridView ID="GridWorkOrderQue" runat="server" ScrollBars="Both" CssClass="table border table-bordered table-hover table-responsive" AutoGenerateColumns="false" CellPadding="4" Style="width: 100%"
                                                ClientIDMode="Static" ShowHeader="false" EmptyDataText="No Records Found" ShowHeaderWhenEmpty="True" EmptyDataRowStyle-ForeColor="Red" EmptyDataRowStyle-HorizontalAlign="Center" Font-Bold="false" DataKeyNames="ID">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="12px">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnDeleteWorkorderQue" runat="server" ForeColor="Red" OnClientClick="return confirm('Are you sure you want to delete?')" OnClick="btnDeleteWorkorderQue_Click"><i class="ti ti-trash"></i></asp:LinkButton>
                                                        </ItemTemplate>
                                                        <EditItemTemplate>
                                                        </EditItemTemplate>
                                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    ...
                    <div class="card-body">
                                            ...
                                            <asp:GridView ID="GridCalculate" runat="server" ScrollBars="Both" CssClass="table border table-bordered table-hover text-nowrap align-content-center" AutoGenerateColumns="false" CellPadding="4" Style="width: 100%"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        ...
                                                        <FooterTemplate>
                                                            <asp:TextBox ID="txtItem" runat="server" TextMode="MultiLine" Text="" CssClass="form-control font-12" Placeholder="Description" Style="width: auto"></asp:TextBox>
                                                    ...
                                                    <asp:TemplateField>
                                                        ...
                                                        <FooterTemplate>
                                                            <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" Text="" CssClass="form-control font-12" Placeholder="Long Description" Style="width: auto"></asp:TextBox>
                                                            <asp:RequiredFieldValidator ID="rfv_txtDescription" ControlToValidate="txtDescription" Display="Dynamic" runat="server" ErrorMessage="Please Enter Description" ForeColor="Red" ValidationGroup="ItemTender" Font-Size="12px"></asp:RequiredFieldValidator>
                                                        </FooterTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-Width="60px">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtQty1" runat="server" Text='<%# Bind("Qnty") %>' CssClass="form-control font-12" Placeholder="Quantity" TextMode="Number" Style="width: 100px" Visible="false" ValidationGroup="quanty" OnTextChanged="txtQty1_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                            <asp:Label ID="lblQuantity1" runat="server" Text='<%# Bind("Qnty") %>' Font-Bold="false" Font-Size="12px" Visible="false"></asp:Label>
                                                        </ItemTemplate>
                                                        <FooterTemplate>
                                                            <asp:TextBox ID="txtQty" runat="server" Text="1" CssClass="form-control font-12" Placeholder="Quantity" TextMode="Number" Style="width: 80px"></asp:TextBox>
                                                            <asp:RequiredFieldValidator ID="rfv_Quantity" ControlToValidate="txtQty" Display="Dynamic" runat="server" ErrorMessage="Please Enter Quantity" ForeColor="Red" ValidationGroup="ItemTender" Font-Size="12px"></asp:RequiredFieldValidator>
                                                        </FooterTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField HeaderStyle-Width="80px" HeaderStyle-Font-Size="12px">
                                                        <HeaderTemplate>
                                                            <asp:Label ID="lblRate" runat="server" Text="Rate" CssClass="form-label"></asp:Label>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtRate1" runat="server" Text='<%# Bind("Rate") %>' CssClass="form-control font-12" Placeholder="Rate" TextMode="Number" Style="width: 90px" Visible="false" OnTextChanged="txtRate1_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                            <asp:Label ID="lblRate1" runat="server" Text='<%# Bind("Rate") %>' Font-Bold="false" Font-Size="12px" Visible="false"></asp:Label>
                                                        </ItemTemplate>
                                                        <FooterTemplate>
                                                            <asp:TextBox ID="txtRate" runat="server" Text="" CssClass="form-control font-12" Placeholder="Rate"></asp:TextBox>
                                                            <asp:RequiredFieldValidator ID="rfv_txtRate" ControlToValidate="txtRate" Display="Dynamic" runat="server" ErrorMessage="Please Enter Rate" ForeColor="Red" ValidationGroup="ItemTender" Font-Size="12px"></asp:RequiredFieldValidator>
                                                        </FooterTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField HeaderText="Tax1" SortExpression="Tender" HeaderStyle-Width="120px" HeaderStyle-Font-Size="12px">
                                                        <EditItemTemplate>
                                                            <asp:Label ID="lblTax1Name" runat="server" Text='<%# Bind("Tax1Name") %>' TabIndex="6" Font-Bold="false" Font-Size="12px"></asp:Label>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblTax1Name1" runat="server" Text='<%# Bind("Tax1Name") %>' TabIndex="6" Font-Bold="false" Font-Size="12px" Visible="false"></asp:Label>
                                                            <asp:DropDownList ID="ddltax11" runat="server" Text='<%# Bind("Tax1Name") %>' CssClass="form-control form-select" Visible="false" Style="width: 100px" OnSelectedIndexChanged="ddltax11_SelectedIndexChanged" AutoPostBack="true">
                                                        ...
                                                        <FooterTemplate>
                                                            ...
                                                            <asp:RequiredFieldValidator ID="rfv_ddltax1" ControlToValidate="ddltax1" Display="Dynamic" runat="server" ErrorMessage="Please Select Tax" ForeColor="Red" ValidationGroup="ItemTender" InitialValue="0" Font-Size="12px"></asp:RequiredFieldValidator>
                                                        </FooterTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Tax1Rate" SortExpression="Tender" HeaderStyle-Font-Size="12px">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtTax1Rate1" runat="server" Text='<%# Bind("Tax1Rate") %>' CssClass="form-control font-12" Placeholder="Rate" TextMode="Number" Style="width: 90px" Visible="false" OnTextChanged="txtTax1Rate1_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                        ...
                                                        <FooterTemplate>
                                                            <asp:TextBox ID="txtTax1Rate1" runat="server" Text='' CssClass="form-control  font-12" Placeholder="Rate" Style="width: 90px"></asp:TextBox>
                                                            <asp:RequiredFieldValidator ID="rfv_txtTax1Rate1" ControlToValidate="txtTax1Rate1" Display="Dynamic" runat="server" ErrorMessage="Please Enter Tax1Rate" ForeColor="Red" ValidationGroup="ItemTender" Font-Size="12px"></asp:RequiredFieldValidator>
                                                        </FooterTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField HeaderText="Tax2" SortExpression="Tender" HeaderStyle-Width="120px" HeaderStyle-Font-Size="12px">
                                                        <EditItemTemplate>
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:DropDownList ID="ddltax22" runat="server" Text='<%# Bind("Tax2Name") %>' CssClass="form-control form-select" Visible="false" Style="width: 100px" OnSelectedIndexChanged="ddltax22_SelectedIndexChanged" AutoPostBack="true">
                                                                <asp:ListItem Value="No Tax Apply" Text="No Tax Apply"></asp:ListItem>
                                                                <asp:ListItem Value="CGST" Text="CGST"></asp:ListItem>
                                                                <asp:ListItem Value="SGST" Text="SGST"></asp:ListItem>
                                                                <asp:ListItem Value="IGST" Text="IGST"></asp:ListItem>
                                                        ...
                                                        <FooterTemplate>
                                                            ...
                                                            <asp:RequiredFieldValidator ID="rfv_ddltax2" ControlToValidate="ddltax2" Display="Dynamic" runat="server" ErrorMessage="Please Select Tax" ForeColor="Red" ValidationGroup="ItemTender" Font-Size="12px"></asp:RequiredFieldValidator>
                                                        </FooterTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Tax2Rate" SortExpression="Tender" HeaderStyle-Width="90px" HeaderStyle-Font-Size="12px">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtTax2Rate1" runat="server" Text='<%# Bind("Tax2Rate") %>' CssClass="form-control" Placeholder="Rate" TextMode="Number" Style="width: 90px" Visible="false" ValidationGroup="rate" OnTextChanged="txtTax2Rate1_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                        ...
                                                        <FooterTemplate>
                                                            <asp:TextBox ID="txtTax2Rate1" runat="server" Text='' CssClass="form-control font-12" Placeholder="Rate" Style="width: 90px"></asp:TextBox>
                                                            <asp:RequiredFieldValidator ID="rfv_txtTax2Rate1" ControlToValidate="txtTax2Rate1" Display="Dynamic" runat="server" ErrorMessage="Please Enter Tax2Rate" ForeColor="Red" ValidationGroup="ItemTender" Font-Size="12px"></asp:RequiredFieldValidator>
                                                        </FooterTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:LinkButton ID="btnOption1" runat="server" Text=""><i class="ti ti-settings"></i></asp:LinkButton>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnDeleteItemCal" runat="server" CommandName="Delete" CssClass="btn btn-sm btn-rounded btn-danger" ValidationGroup="DelItemTender" Text="" OnClientClick="return confirm('Are you sure you want to delete?')" Visible="false" OnClick="btnDeleteItemCal_Click" CausesValidation="false"><i class="ti ti-trash"></i></asp:LinkButton>
                                                        </ItemTemplate>
                                                        <FooterTemplate>
                                                            <asp:LinkButton ID="btnAddTenderItem" runat="server" CssClass="btn btn-sm btn-rounded btn-info" Text="" TabIndex="9" ValidationGroup="ItemTender" OnClick="btnAddTenderItem_Click" CausesValidation="false"><i class="ti ti-check"></i></asp:LinkButton>
                                                        </FooterTemplate>
                                                    </asp:TemplateField>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6 text-sm-end">
                                ...
                                <asp:Label ID="lblsubtotal1" runat="server" Text="0.0" Font-Size="12px"></asp:Label><br />
                                <asp:Label ID="lblcgst" runat="server" Text="Total CGST Amount:₹" CssClass="form-label"></asp:Label>
                                <asp:Label ID="lblcgst1" runat="server" Text="0.0" Font-Size="12px"></asp:Label><br />
                                <asp:Label ID="lblsgst" runat="server" Text="Total SGST Amount:₹" CssClass="form-label"></asp:Label>
                                <asp:Label ID="lblsgst1" runat="server" Text="0.0" Font-Size="12px"></asp:Label><br />
                                <asp:Label ID="lbligst" runat="server" Text="Total IGST Amount:₹" CssClass="form-label"></asp:Label>
                                <asp:Label ID="lbligst1" runat="server" Text="0.0" Font-Size="12px"></asp:Label><br />
                                <asp:Label ID="lbltotaltax" runat="server" Text="Total Tax Amount:₹" CssClass="form-label"></asp:Label>
                                <asp:Label ID="lbltotaltax1" runat="server" Text="0.0" Font-Size="12px"></asp:Label><br />
                                <asp:Label ID="lbltotalamt" runat="server" Text="Grand Total Amount:₹" CssClass="form-label"></asp:Label>
                                <asp:Label ID="lbltotalamt1" runat="server" Text="0.0" Font-Size="12px"></asp:Label><br />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="col-md-12 col-sm-12 col-lg-12">
                            <div class="mb-2">
                                ...
                                <asp:TextBox ID="txtClientNote" runat="server" TextMode="MultiLine" CssClass="form-control  font-12"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-12 col-sm-12 col-lg-12">
                            <div class="mb-2">
                                <asp:Label ID="lblTermsConditions" runat="server" Text="Terms & Conditions" CssClass="form-label"></asp:Label>
                                <asp:TextBox ID="txtTermsAndConditions" runat="server" TextMode="MultiLine" CssClass="form-control  font-12"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-12 col-sm-12 col-lg-12">

                            <div class="mb-2">
                                <asp:Button ID="Btn_Update" runat="server" Text="Update" CssClass="btn btn-sm btn-success" ValidationGroup="Tender1" OnClick="Btn_Update_Click" />
                                &nbsp;&nbsp;                         
                         <asp:Button ID="Btn_Cancel" runat="server" Text="Cancel" CssClass="btn btn-sm btn-danger" ValidationGroup="Clear" OnClick="Btn_Cancel_Click" />
                            </div>
                        </div>
                    </div>
                </div>
