...
{
    public partial class New_Estimate : System.Web.UI.Page
    {
        ...
        Double DiscountItem1 = 0, Adjustment1 = 0.0, TaxTotalItem1, SubtotalItem1;
                ...
                if (Session["LoginType"] != null)
                {
                    ...
                    if (Session["LoginType"].ToString() == "Administrator")
                    {
                        ...
                        if (!this.IsPostBack)
                        {
                            ...
                            txtEstimateDate.Attributes["value"] = DateTime.Parse(Todaydate.ToString()).ToString("yyyy-MM-dd");
            ...
            try
            {
                ...
                using (SqlConnection con1 = new SqlConnection(strconnect))
                {
                    ...
                    if (i < 0)
                    {
                        ...
                        lblMesDelete.Text = "Estimate Item Remove Successfully";
                    }
                    else
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Estimate Item Not Remove Successfully";
                    }
                    con1.Close();
                    Calculatefilldata();
                }
        ...
        protected void btn_SubmitEstimate_Click1(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("SP_SaveEstimate", con);
                    cmd.Connection = con;
                    cmd.CommandType = CommandType.StoredProcedure;
                    ...
                    cmd.Parameters.AddWithValue("@Discount_Type", "");
                    ...
                    if (Result > 0)
                    {
                        ...
                        Response.Redirect("~/Estimates_Home.aspx?svd1=" + save + "", false);
                    }
                    else
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "New Estimate Details Not Save Successfully";
                    }
                    Clear();
                    con.Close();
                }
        ...
        protected void btnSaveAsDraft_Click1(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Result > 0)
                {
                    ...
                    Response.Redirect("~/Estimates_Home.aspx?Draft1=" + Draft + "", false);
                }
                else
                {
                    Toasteralert.Visible = false;
