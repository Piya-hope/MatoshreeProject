...
{
    public partial class EditNewProposal : System.Web.UI.Page
    {
        ...
        public void GetProposalDetails()
        {
            ...
            {
                string CandidateID;
                CandidateID = HttpUtility.UrlDecode(Request.QueryString["XCEEMPIDdfd"]);
                lblProposalID.Text = CandidateID;
                using (SqlConnection UserCon = new SqlConnection(strconnect))
                {
                    SqlCommand cmd = new SqlCommand("SP_ViewProposalDetails", UserCon);
                    cmd.CommandType = CommandType.StoredProcedure;
                    SqlDataAdapter sda = new SqlDataAdapter(cmd);
                    cmd.Parameters.AddWithValue("@ID", lblProposalID.Text);
                    DataTable dt = new DataTable();
                    sda.Fill(dt);
                    if (dt.Rows.Count > 0)
                    {
                        txtProposalNumber.Text = dt.Rows[0]["ProposalNo"].ToString();
                        txtSubject.Text = dt.Rows[0]["Subject"].ToString();
                        txtDate.Text = dt.Rows[0]["ProDate"].ToString();
                        txtOpenTill.Text = dt.Rows[0]["ProOpenTillDate"].ToString();
                        ddlCurrency.SelectedItem.Text = dt.Rows[0]["Currency"].ToString();
                        ddlDiscountType.SelectedItem.Text = dt.Rows[0]["DiscountType"].ToString();
                        ddlStatus.SelectedItem.Text = dt.Rows[0]["StatusName"].ToString();
                        ddlAssigned.SelectedItem.Text = dt.Rows[0]["AssignBy"].ToString();
                        txtTo.Text = dt.Rows[0]["To"].ToString();
                        txtAddress.Text = dt.Rows[0]["Address"].ToString();
                        ddlCountry.SelectedItem.Text = dt.Rows[0]["Country"].ToString();
                        ddlState.SelectedItem.Text = dt.Rows[0]["AddState"].ToString();
                        ddlDistrict.SelectedItem.Text = dt.Rows[0]["District"].ToString();
                        txtZipCode.Text = dt.Rows[0]["Zipcode"].ToString();
                        txtPhone.Text = dt.Rows[0]["Phone"].ToString();
                        txtEmail.Text = dt.Rows[0]["Email"].ToString();
                        ...
                        ddlCity.SelectedItem.Text = dt.Rows[0]["AddCity"].ToString();
                        ddlRelated.SelectedItem.Text = dt.Rows[0]["RelatedTo"].ToString();
                        string Related = ddlRelated.SelectedItem.Text;
                        GetRelatedTo(Related);
                        ddlRelatedToCast.SelectedItem.Text = dt.Rows[0]["RelatedName"].ToString();
                        ddlRelatedToCast.SelectedItem.Value = dt.Rows[0]["RelatedID"].ToString();
                        ddlProject.SelectedItem.Text = dt.Rows[0]["ProjectName"].ToString();
                        ddlProject.SelectedItem.Value = dt.Rows[0]["ProjectID"].ToString();
                    }
        ...
        public void GetRelatedTo(string Name1)
        {
            try
            {
                LeadProposal.Visible = true;
                if (ddlRelated.SelectedItem.Text == "Lead")
                {
                    lblLead.Text = "Lead";
                    LeadProposal.Visible = true;
                ...
                else if (ddlRelated.SelectedItem.Text == "Customer")
                {
        ...
        public void GetRelatedCatTo(string Name)
        {
            try
            {
               
                string ddlRelatedToCast1 = Name;
        ...
        protected void btn_SubmitProposal_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                {
                    SqlConnection con = new SqlConnection(strconnect);  // db connect
                    SqlCommand cmd = new SqlCommand("SP_UpdateNewProposal", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    ...
                    if (Result > 0)
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Proposal Details Updated Successfully";
                    ...
                    else
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Proposal Details already Updated Successfully";
                    }
        ...
        protected void txtDiscount1_TextChanged1(object sender, EventArgs e)
        {
            DiscountCount();
