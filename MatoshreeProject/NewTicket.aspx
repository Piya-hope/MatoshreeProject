<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="NewTicket.aspx.cs" Inherits="MatoshreeProject.NewTicket" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <div class="container-fluid">
            ...
            <h5 class="font-weight-medium mb-0">New Ticket</h5>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a class="text-muted text-decoration-none" href="Ticket_Details.aspx">Ticket
                        </a>
                    </li>
                    <li class="breadcrumb-item text-muted" aria-current="page" href="#">New Ticket</li>
                </ol>
            </nav>
           </div>
                <%-- Toaster --%>
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-6 border-right">
                                <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                    <div class="mb-2">
                                        ...
                                        <asp:TextBox ID="txtInitialTicket" runat="server" CssClass="form-control text-purple" ReadOnly="true"></asp:TextBox>
                                        <asp:Label ID="lblCustomerID" runat="server" Text="" Visible="false" CssClass="form-label"></asp:Label>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                    <div class="mb-2">
                                ...
                                <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                    <div class="mb-2">
                                        <asp:Label ID="lblbody" runat="server" Text="Ticket Body" CssClass="form-label"></asp:Label>
                                        ...
                                        <br />
                                        <asp:CheckBox ID="chkSendEmail" Text="&nbsp;  Send Email" runat="server" Font-Bold="true" Font-Size="13px" />
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <asp:GridView ID="GridTicketFile" runat="server" ScrollBars="Both" CssClass="table border table-bordered table-hover" AutoGenerateColumns="false" CellPadding="4" Style="width: 100%"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblTicketFileName1" runat="server" Text='<%# Bind("Tick_File") %>' CssClass="form-label" Font-Size="12px"></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                            <center>
                                <div class="mb-2">
                                    ...
                                    &nbsp;&nbsp;
                                <asp:Button ID="btnClear" runat="server" Text="Clear" OnClick="btnClear_Click1" CssClass="btn btn-sm btn-danger" />
                                </div>
                            </center>
                        </div>
                    </div>
