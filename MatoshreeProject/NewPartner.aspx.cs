        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                try
                {
                    ...
                    cmd.Parameters.AddWithValue("@Add_Identity", "Patner_Address");
                    ...
                    if (Result > 0)
                    {
                        ...
                        Response.Redirect("~/Patner.aspx?svd1=" + save + "", false);
                    }
                    else
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Partner Details Not Save Successfully";
                    }
                    Clear();
                }
                catch (Exception ex)
