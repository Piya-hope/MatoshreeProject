<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="New_Office_Expenses.aspx.cs" Inherits="MatoshreeProject.New_Office_Expenses" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <h5 class="font-weight-medium mb-0">New Office Expenses</h5>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item text-muted" href="#">Expenses</li>
                <li class="breadcrumb-item">
                    <a class="text-muted text-decoration-none" href="Office_Expences.aspx">Office Expenses
                    </a>
                </li>
                <li class="breadcrumb-item text-muted" aria-current="page" href="New_Office_Expenses.aspx">New Office Expenses</li>
            </ol>
        </nav>
        <br />
        <div class="row">
                        ...
                        <div class="card-body">
                            <asp:UpdatePanel ID="UpdatePanelddlState" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="mb-2">
                                        <%--<asp:Label ID="lblExp_ID" runat="server" Text="" Font-Bold="true" Visible="false" Font-Size="12px">--%>
                                        <asp:Label ID="lblName" runat="server" Text="Name" CssClass="form-label"></asp:Label>&nbsp;<span style="color: #FF0000">*</span>
                                        <asp:TextBox ID="txtExpenseName" runat="server" placeholder="Enter Expense Name" class="form-control font12"></asp:TextBox>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <%--<asp:RequiredFieldValidator ID="RequiredFieldNote" runat="server" ErrorMessage="Enter Expense Note" ControlToValidate="txtNote" ForeColor="Red" Font-Bold="false" ValidationGroup="Expense"  Font-Size="12px"></asp:RequiredFieldValidator>--%>
                                    </div>
                                    <div class="mb-2">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorExpenses" runat="server" ErrorMessage="Select Expenses Type" Font-Size="12px" ControlToValidate="ddlExpensesType" ForeColor="Red" Font-Bold="false" ValidationGroup="Expense" InitialValue="0" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="mb-2">
                                        ...
                                        <asp:DropDownList ID="ddlExpensesCategory" runat="server" CssClass="form-control form-select font12" Placeholder="Select Expenses Category" OnSelectedIndexChanged="ddlExpensesCategory_SelectedIndexChanged" AutoPostBack="true">
                                        </asp:DropDownList>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <asp:DropDownList ID="ddlSubCategory" runat="server" CssClass="form-control form-select" AutoPostBack="true" OnSelectedIndexChanged="ddlSubCategory_SelectedIndexChanged" Placeholder="Select Expenses SubCategory">
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Select Expenses SubCategory" ControlToValidate="ddlSubCategory" ForeColor="Red" Font-Bold="false" ValidationGroup="Expense" Font-Size="12px" InitialValue="0" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="mb-2">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <asp:TextBox ID="txtExpensesDate" type="date" CssClass="form-control font12" Style="display: inline-block;" runat="server" placeholder="Enter Expenses Date"></asp:TextBox>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <asp:TextBox ID="txtBillno" CssClass="font12 form-control" Style="display: inline-block;" runat="server" placeholder="Enter Expenses Bill Number"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Enter Expenses BillNo" ControlToValidate="txtBillno" ForeColor="Red" Font-Bold="false" Font-Size="12px" ValidationGroup="Expense"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="mb-2">
                                        <asp:Label ID="lblCurrency" runat="server" Text="Currency" CssClass="form-label"></asp:Label>
                                        <asp:TextBox ID="txtCurrency" runat="server" CssClass="font12 form-control" placeholder="INR" ReadOnly="true"></asp:TextBox>
                                    </div>
                                    <div class="mb-2">
                                        <asp:Label ID="lblPaymentMode" runat="server" Text="Payment Mode" CssClass="form-label"></asp:Label>&nbsp;<span style="color: #FF0000">*</span>
                                        <asp:DropDownList ID="ddlPaymentMode" runat="server" CssClass="form-control form-select font12">
                                            <asp:ListItem Value="0" Text="Nothing Selected"></asp:ListItem>
                                        ...
                                        <asp:RequiredFieldValidator ID="reqPaymentMode" runat="server" ErrorMessage="Select Payment Mode" ControlToValidate="ddlPaymentMode" ForeColor="Red" Font-Bold="false" Font-Size="12px" ValidationGroup="Expense" InitialValue="0" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </div>
                                    <br />
                                </ContentTemplate>
                                <Triggers>
                            ...
                            <div class="mb-2">
                                <asp:Button ID="btnSaveOfficeExpense" runat="server" Text="Next" CssClass="btn btn-sm btn-success" ValidationGroup="Expense" OnClick="btnSaveOfficeExpense_Click" />
                                <asp:Button ID="btnSaveAll" runat="server" Text="Save" CssClass="btn btn-sm btn-primary " ValidationGroup="ExpenseD" Visible="false" OnClick="btnSaveAll_Click" />
                                &nbsp;&nbsp;
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                            <div class="table-responsive">
                                                <asp:GridView ID="GridViewOffice" runat="server" ScrollBars="Both" CssClass="table border table-bordered table-hover" AutoGenerateColumns="false" CellPadding="4" Style="width: 100%"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                                <asp:Label ID="lblItem" runat="server" Text="ItemName" CssClass="font-bold" Font-Size="12px"></asp:Label>
                                                            </HeaderTemplate>
                                                            <FooterTemplate>
                                                                <%--<asp:TextBox ID="txtItem" runat="server" Text="" CssClass="form-control" Placeholder="Description"></asp:TextBox>--%>
                                                                <asp:TextBox ID="txtItem" runat="server" TextMode="MultiLine" Text="" CssClass="form-control" Placeholder="Item Name" Font-Size="12px"></asp:TextBox>
                                                                <asp:RequiredFieldValidator ID="rfv_TenderItem" ControlToValidate="txtItem" Display="Dynamic" runat="server" ErrorMessage="Please Select Item" ForeColor="Red" Font-Size="12px" ValidationGroup="ItemTender"></asp:RequiredFieldValidator>
                                                            </FooterTemplate>
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <FooterTemplate>
                                                                ...
                                                                <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" Text="" CssClass="form-control" Font-Size="12px" Placeholder="Long Description"></asp:TextBox>
                                                            </FooterTemplate>
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                                <asp:Label ID="lblRate" runat="server" Text="ItemRate" CssClass=" font-bold" Font-Size="12px"></asp:Label>
                                                            </HeaderTemplate>
                                                            <FooterTemplate>
                                                                <asp:TextBox ID="txtRate" runat="server" Text="" CssClass="form-control" Placeholder="Rate" Font-Size="12px"></asp:TextBox>
                                                            </FooterTemplate>
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtRate1" runat="server" Text='<%# Bind("Rate") %>' CssClass="form-control" Placeholder="Rate" TextMode="Number" Style="width: 150px" Visible="false" ValidationGroup="R" Font-Size="12px"></asp:TextBox>
                                                        ...
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                                <asp:Label ID="lblQuantity" runat="server" Text="Qty" CssClass="font-bold" Font-Size="12px"></asp:Label>
                                                            </HeaderTemplate>
                                                            <FooterTemplate>
                                                                <asp:TextBox ID="txtQty" runat="server" Text="1" CssClass="form-control" Placeholder="Quantity" TextMode="Number" Style="width: 60px" Font-Size="12px"></asp:TextBox>
                                                            </FooterTemplate>
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtQty1" runat="server" Text='<%# Bind("Quantity") %>' CssClass="form-control" Placeholder="Quantity" TextMode="Number" Style="width: 60px" Visible="false" ValidationGroup="Q" Font-Size="12px"></asp:TextBox>
                                                                <asp:Label ID="lblQuantity1" runat="server" Text='<%# Bind("Quantity") %>' Font-Bold="false" Font-Size="12px" Visible="true"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                                <asp:Label ID="lblAmount1" runat="server" Text="Amount" CssClass="font-bold"></asp:Label>
                                                            </HeaderTemplate>
                                                            <FooterTemplate>
                                                                <asp:Label ID="lblTotalAmount" runat="server" Text="Amount" CssClass="form-label"></asp:Label>
                                                            </FooterTemplate>
                                                            <ItemTemplate>
                                                                <%--<asp:TextBox ID="txtAmount11" runat="server" Text='<%# Bind("Amount") %>' CssClass="form-control" Placeholder="Amount"  ValidationGroup="R"></asp:TextBox>--%>
                                                        ...
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                                <asp:LinkButton ID="btnOption" runat="server" Text="" ValidationGroup="setting" CausesValidation="false"><i class="ti ti-settings"></i></asp:LinkButton>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
                                                            ...
                                                            <FooterTemplate>
                                                                <asp:LinkButton ID="btnAddBillPaymentRequestItem" runat="server" CausesValidation="false" CssClass="btn btn-sm btn-rounded btn-info" Text="" TabIndex="9" OnClick="btnAddBillPaymentRequestItem_Click" ValidationGroup="ItemTender"><i class="ti ti-check"></i></asp:LinkButton>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                        ...
                                        <div class="row">
                                            <asp:Table ID="Table2" runat="server" CssClass="col-md-12 col-sm-12 col-lg-12  font-bold">
                                                <asp:TableRow ID="TableRow3" runat="server">
                                                    ...
                                                    <asp:TableCell CssClass="col-md-3 col-sm-3 col-lg-3">
                                                        <asp:Label ID="lblSubTotalCost" runat="server" Text="0" CssClass="form-control" Font-Bold="false"></asp:Label>
                                                    </asp:TableCell>
                                                </asp:TableRow>
                                            </asp:Table>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                            <asp:GridView ID="GridExpensesFile" runat="server" ScrollBars="Both" CssClass="table border table-bordered table-hover text-nowrap align-content-center" AutoGenerateColumns="false" CellPadding="4" Style="width: 100%"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField Visible="false">
                                                        <HeaderTemplate>
                                                            <asp:Label ID="lblExpensesFileId" runat="server" Text="FileName" Font-Size="12px" CssClass=" font-bold" Visible="false"></asp:Label>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:Label ID="lblExpensesFileName" runat="server" Text="FileName" CssClass="font-bold" Font-Size="12px"></asp:Label>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
