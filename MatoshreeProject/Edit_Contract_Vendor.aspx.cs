...
{
    public partial class Edit_Contract_Vendor : System.Web.UI.Page
    {
        ...
        SqlDataReader dr;
        int Result;
        string Trashchk, Status, ClientChk;
        string isExpired, RenewContractExpired;
        string result;
        string file1;
        string Contractid;

        string visible, trash;
        ...
        public void ContractVendorByID()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("[SP_GetContract_VendorByID]", UserCon);
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    lblVenderFilename.Text = dt.Rows[0]["Contract_FileName"].ToString();
                    ...
                    Trashchk = dt.Rows[0]["trash"].ToString();
            ...
            if (Page.IsValid)
            {
                try
                {
                    ...
                    if (NewEndDate.Date > NewStartDate.Date && RenewContractExpired == "true" || NewStartDate.Date == Today && RenewContractExpired == "true")
                    {
                        using (SqlConnection con = new SqlConnection(strconnect))
                        {
                            SqlCommand cmd = new SqlCommand("SP_SaveRenewContract", con);
                            cmd.CommandType = CommandType.StoredProcedure;
                            ...
                            cmd.Parameters.AddWithValue("@renewContractFor", "Vender");
        ...
        protected void Btn_Upload_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (FileUpload1.PostedFile.FileName.Length > 1)
                {
                    ...
                    using (SqlConnection con = new SqlConnection(strconnect))
                    {
                        SqlCommand cmd = new SqlCommand("SP_UploadContractVenderAttachmentFile", con);
                        cmd.Connection = con;
                        cmd.CommandType = CommandType.StoredProcedure;
                        ...
                        if (i < 0)
                        {
                            Toasteralert.Visible = false;
                            deleteToaster.Visible = true;
                            lblMesDelete.Text = "Vendor Contract Details File Upload Successfully";
                            ContractVendorByID();
                        }
                        else
                        {
        ...
        protected void Linkbtnpdf_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Vendername = "Contract Vender Details";
        ...
        protected void btnUpdateContact_Vendor_Click1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(strconnect))
                {
                    SqlCommand cmd = new SqlCommand("SP_UpdateContract_Vendor", con);
                    cmd.Connection = con;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@id", lbltest.Text);
                    ...
                    if (Result < 0)
                    {
                        ...
                        Response.Redirect("~/Contract_Vendor.aspx?edit1=" + edit + "", false);
                    }
                    else
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Vendor Contract Details Not Edit Successfully";
                    }
                }
            }
            catch (Exception ex)
        ...
        {
            Response.Redirect("~/Contract_Vendor.aspx", false);
        }
