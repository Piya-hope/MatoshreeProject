<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="New_Vender_Contact.aspx.cs" Inherits="MatoshreeProject.New_Vender_Contact"  EnableEventValidation="false" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
              <h5 class="font-weight-medium mb-0">New Contact</h5>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a class="text-muted text-decoration-none" href="#">Vendor</a></li>
                <li class="breadcrumb-item">
                    <a class="text-muted text-decoration-none" href="EditVendor.aspx">EditVendor
                    </a>
                </li>
                <li class="breadcrumb-item text-muted" aria-current="page" href="#">New Contact</li>
            </ol>
        </nav>
        <br />
        <div class="row">
            ...
            <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <asp:Label ID="lblVendorID1" runat="server" Text="" Visible="false"></asp:Label>
                        ...
                        <div class="mb-2">
                            ...
                            <asp:RegularExpressionValidator ID="Phone" runat="server" ControlToValidate="txt_Phone" Font-Bold="false" ValidationGroup="add" ErrorMessage="Invalid Mobile No" ValidationExpression="^{1}[0-9]{10}$" ForeColor="Red"></asp:RegularExpressionValidator>
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            <asp:CheckBox ID="CheckBPrimary" runat="server" Text="Primary contact" Checked="true" CssClass="form-check" /><br />
                            <asp:CheckBox ID="CheckBoxwelcome" runat="server" Text="Do not send welcome email" CssClass="form-check" AutoPostBack="true" OnCheckedChanged="CheckBoxwelcome_CheckedChanged"/><br />
                            <asp:CheckBox ID="CheckBoxpassword" runat="server" Text="Send SET password email" CssClass="form-check" />
                        </div>
                        ...
                        <hr />
                        <div class="mb-2">
                            <asp:Button ID="btnSaveVenderContacts" runat="server" Text="Save" CssClass="btn btn-sm btn-primary" ValidationGroup="add" OnClick="btnSaveVenderContacts_Click" />
                            &nbsp;&nbsp;
                            <asp:Button ID="btnClearVenderContacts" runat="server" Text="Clear" CssClass="btn btn-sm btn-danger" OnClick="btnClearVenderContacts_Click" />
                        </div>
                    </div>
