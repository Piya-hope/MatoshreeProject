...
namespace MatoshreeProject
{
    public partial class WorkorderReport : System.Web.UI.Page
    {
        ...
        public void BindTenderNumber()
        {
            try
            {
                ...
                using (SqlDataAdapter sda1 = new SqlDataAdapter(cmd))
                {
                    ...
                    ddltenderNumber.Items.Insert(0, new System.Web.UI.WebControls.ListItem("Select Tender Number", "0"));
        ...
        public DataTable ViewWorkorderDetails()
        {
            ...
            {
                SqlCommand cmd =new SqlCommand("SP_ViewWorkOrderDetails", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandTimeout = 120;
                SqlDataAdapter ad = new SqlDataAdapter(cmd);                            
                    ad.Fill(table);
                    GridWorkorderReport.DataSource = table;
                    GridWorkorderReport.DataBind();
        ...
        public void Clear()
        {
            try
            { 
            GridWorkorderReport.DataSource = null;
            GridWorkorderReport.DataBind();
            GridWorkorderReport.EmptyDataText = "No Records found";

            txtStartDate.Text = string.Empty;
            txtEndDate.Text = string.Empty;
            ddlCustomer.SelectedIndex = 0;
            ddlProject.SelectedIndex = 0;
            ddltenderNumber.SelectedIndex = 0;
            }
            catch(Exception ex)
            {
                using (SqlConnection UserCon = new SqlConnection(strconnect))
        ...
        protected void btnSearchRerort_Click(object sender, EventArgs e)
        {
            try 
            {
                ...
                if(ddltenderNumber.SelectedItem.Value == "0")
                {
                    tenderNumber = null;
                }
                else
                {
                    tenderNumber = ddltenderNumber.SelectedItem.Text;
                }
                ...
                {
                    SqlCommand cmd = new SqlCommand("SP_ViewWorkOrderReport", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandTimeout = 120;
                    cmd.Parameters.AddWithValue("@Customer", customer);
                    cmd.Parameters.AddWithValue("@Project", project);
                    cmd.Parameters.AddWithValue("@TenderNumber", tenderNumber);
                    ...
                    DataTable dt = new DataTable();
                    sda.Fill(dt);
                    GridWorkorderReport.DataSource = dt;
                    GridWorkorderReport.DataBind();
        ...
        protected void linkbtnPDF_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
                {
                    ...
                    _document.Open();
                    _pdfPTable.SetWidths(new float[] { 4f, 13f, 10f, 11f, 11f, 11f, 11f, 13f, 10f, 12f, 10f, 12f, });
                    ...
                    _fontStyle = FontFactory.GetFont("Arial", 14f, 2);
                    _pdfPCell = new PdfPCell(new Phrase("WorkOrderReportList", _fontStyle));
                    _pdfPCell.Colspan = 8;
                    ...
                    _fontStyle = FontFactory.GetFont("Tahoma", 9f, 1, BaseColor.WHITE);
                    _pdfPCell = new PdfPCell(new Phrase("Authority", _fontStyle));
                    _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                    _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                    _pdfPCell.BackgroundColor = BaseColor.GRAY;
                    _pdfPCell.ExtraParagraphSpace = 2;
                    ...
                    foreach (DataRow row in _Vhrlist.Rows)
                    {
                        ...
                        _pdfPCell = new PdfPCell(new Phrase(row["AuthorityName"].ToString(), _fontStyle));
                        _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                        _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                        _pdfPCell.BackgroundColor = BaseColor.WHITE;
                        _pdfPCell.ExtraParagraphSpace = 1;
                    ...
                    string PDFFileName = string.Format("WorkOrderReportList_" + dTime.ToString("dd/MM/yyyy HH:mm") + ".pdf");
                    Response.Clear();
