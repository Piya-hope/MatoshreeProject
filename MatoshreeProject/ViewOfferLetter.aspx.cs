...
namespace MatoshreeProject
{
    public partial class ViewOfferLetter : System.Web.UI.Page
    {
        ...
        Decimal ComponentTotal, ContributionTotal;
        ...
        public DataTable ViewComponent()
        {
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                ...
                cmd.Parameters.AddWithValue("@Cand_No", lblcandno.Text);
        ...
        public void GetCondidateDetails()
        {
            try
            {
                ...
                lblCandid.Text = CandidateID;
                using (SqlConnection UserCon = new SqlConnection(strconnect))
                {
                    SqlCommand cmd = new SqlCommand("SP_ViewCandidateDetailsById", UserCon);
                    cmd.CommandType = CommandType.StoredProcedure;
                    SqlDataAdapter sda = new SqlDataAdapter(cmd);
                    cmd.Parameters.AddWithValue("@id", lblCandid.Text);
                    DataTable dt = new DataTable();
                    sda.Fill(dt);
                    if (dt.Rows.Count > 0)
                    {
                        lblcandno.Text = dt.Rows[0]["Cand_No"].ToString();                     
                        lblCandName.Text = dt.Rows[0]["Cand_Name"].ToString() +" " + ",";
                        lblCandname1.Text = dt.Rows[0]["Cand_Name"].ToString() + " " + ",";
                        lblPackage.Text = dt.Rows[0]["Package"].ToString();
                        lbldesignation.Text= dt.Rows[0]["Cand_Designation"].ToString();
                        lblTermsCondition.Text = dt.Rows[0]["TermsAndCondition"].ToString();
                        lblnote.Text = dt.Rows[0]["Note"].ToString();                      
                        lblCandCreateDate.Text = dt.Rows[0]["createdate"].ToString();
                    }
        ...
        public DataTable ViewEmpCompansion()
        {
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                SqlConnection conn = new SqlConnection(strconnect);
        ...
        public void TotalMonthlyAndAnnualy()
        {
            try
            {
                Decimal AnnualSalary = Convert.ToDecimal(lblPackage.Text);
                ...
                foreach (GridViewRow gridviedrow in GridViewComponent.Rows)
                {
                    ...
                    Label lblAmount1 = (Label)gridviedrow.FindControl("lblAmount1");//monthly
                    Label lblAmountYr1 = (Label)gridviedrow.FindControl("lblAmountYr1");
                    Label lblAmount2 = GridViewComponent.FooterRow.FindControl("lblAmount2") as Label;//Annualy
        ...
        protected void BtnDeclined_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    SqlCommand cmd2 = new SqlCommand("SP_AcceptCandOfferLetter", con2);
                    cmd2.Connection = con2;
                    cmd2.CommandType = CommandType.StoredProcedure;
                    cmd2.Parameters.AddWithValue("@CandAccept", "false");
                    cmd2.Parameters.AddWithValue("@Cand_No", lblcandno.Text);
                    con2.Open();
        ...
        protected void BtnAccept_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection con2 = new SqlConnection(strconnect))
                {
                    ...
                    cmd2.Connection = con2;
                    cmd2.CommandType = CommandType.StoredProcedure;                 
                    cmd2.Parameters.AddWithValue("@CandAccept", "true");
                    cmd2.Parameters.AddWithValue("@Cand_No", lblcandno.Text);                   
                    con2.Open();
                    int i = cmd2.ExecuteNonQuery();
                    if (i < 0)
        ...
        protected void lnkbtnpdf_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _pdfPCell = new PdfPCell(new Phrase(lblcandno.Text, _fontStyle));
                _pdfPCell.Colspan = 2;
                ...
                _pdfPCell = new PdfPCell(new Phrase(lblCandName.Text, _fontStyle));
                _pdfPCell.Colspan = 5;
                _pdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
                _pdfPCell.Border = 0;
                _pdfPCell.BackgroundColor = BaseColor.WHITE;
                ...
                _fontStyle = FontFactory.GetFont("Arial", 10f, 2);
                _pdfPCell = new PdfPCell(new Phrase("Dear" + " " + lblCandName.Text + ",", _fontStyle));
                _pdfPCell.Colspan = 5;
                _pdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
                _pdfPCell.Border = 0;
                _pdfPCell.BackgroundColor = BaseColor.WHITE;
   ...
   " process. You have been selected for the position of " + lbldesignation.Text +
   ...
   "and compensation", _fontStyle));
                ...
                _fontStyle = FontFactory.GetFont("Arial", 10f, 2);
                _pdfPCell = new PdfPCell(new Phrase(lblTermsCondition.Text, _fontStyle));
                _pdfPCell.Colspan = 5;
                _pdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
                _pdfPCell.Border = 0;
                _pdfPCell.BackgroundColor = BaseColor.WHITE;
                ...
                _fontStyle = FontFactory.GetFont("Arial", 10f, 2);
                _pdfPCell = new PdfPCell(new Phrase(lblnote.Text, _fontStyle));
                _pdfPCell.Colspan = 6;
                _pdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
                _pdfPCell.Border = 0;
                _pdfPCell.BackgroundColor = BaseColor.WHITE;
                ...
                string PDFFileName = string.Format(lblCandName.Text + dTime.ToString("dd/MM/yyyy HH:mm") + ".pdf");
                Response.Clear();
        ...
        protected void LinkbtnMessage_Click(object sender, EventArgs e)
        {
