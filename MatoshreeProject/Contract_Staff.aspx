<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="Contract_Staff.aspx.cs" Inherits="MatoshreeProject.Contract_Staff" %>
    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item text-muted" aria-current="page" href="Contract_Staff.aspx">Contract Staff </li>
            </ol>
        </nav>
        <%-- BreadCrumbs --%>
        <br />
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        ...
                        <div id="addnew" runat="server">
                            <div class="row">
                                <div class="Col-md-2 col-lg-2 col-sm-2 col-xs-2">
                                    <asp:Button ID="btnNewContractStaff" runat="server" Text="New Contract Staff" CssClass="btn btn-sm btn-primary" OnClick="btnNewContractStaff_Click" />
                                </div>
                            </div>
                            <hr />
                        </div>
                ...
                <h5 class="fs-5 mt-3 mb-3">Contract Staff Summary</h5>
                <div class="row">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-auto">
                                        <span class="text-success display-6">
                                            <iconify-icon icon="arcticons:firefoxnotes" class="aside-icon"></iconify-icon>
                                        </span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">
                        <div class="card">
                            <div class="card-body">
                                <h5 cclass="font-weight-medium mt-3 mb-3">Contracts By Type</h5>
                               <%--  <asp:Chart ID="Chart2" runat="server" Height="400" Width="500" ImageLocation="~/charts_2/chart_7_0.png" ImageStorageMode="UseImageLocation"> --%> 
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="font-weight-medium mt-3 mb-3">View Contract Details</h5>
                        <hr />
                        <div class="row">
                            <div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xs-12 col-lg-12 col-sm-12">
                                <asp:GridView ID="GridviewContract1" runat="server" ScrollBars="Both" CssClass="table border table-bordered table-hover text-nowrap align-content-center" AutoGenerateColumns="false" CellPadding="4" Style="width: 100%"
                                    ClientIDMode="Static" EmptyDataText="No Records found" ShowHeaderWhenEmpty="True" EmptyDataRowStyle-ForeColor="Red" OnRowDataBound="GridviewContract1_RowDataBound" EmptyDataRowStyle-HorizontalAlign="Center" Font-Bold="false" DataKeyNames="id">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="StaffName" SortExpression="First_Name" HeaderStyle-Font-Size="12px" HeaderStyle-Width="200px">
                                            <EditItemTemplate>
                                                <asp:Label ID="lblStaff" runat="server" Text='<%#Bind("First_Name") %>' Font-Bold="false" Font-Size="12px"></asp:Label>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblStaff1" runat="server" Text='<%#Bind("First_Name") %>' Font-Bold="false" Font-Size="12px"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="ContracType" SortExpression="Contractype" HeaderStyle-Font-Size="12px">
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Status" SortExpression="Description" Visible="false">
                                            <EditItemTemplate>
