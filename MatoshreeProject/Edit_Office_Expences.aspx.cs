...
{
    public partial class Edit_Office_Expences : System.Web.UI.Page
    {
        ...
        public void GetOfficeExpensesDataByID()
        {
            try
            {
                using (SqlConnection UserCon = new SqlConnection(strconnect))
                {
                    ...
                    SqlCommand cmd = new SqlCommand("[SP_GetOfficeExpensesDetailsByID]", UserCon);
        ...
        protected void btnupdateOfficeExpense_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("SP_UpdateOfficeExpenses", con);
                    cmd.Connection = con;
                    cmd.CommandType = CommandType.StoredProcedure;
                    ...
                    if (Result < 0)
                    {
                        ...
                        Response.Redirect("~/Office_Expences.aspx?edit1=" + edit + "", false);
                    }
                    else
                    {
                        Toasteralert.Visible = false;
                        deleteToaster.Visible = true;
                        lblMesDelete.Text = "Office Expenses Details Not Edit Successfully";
                    }
                    Calculatefilldata();
                    ViewFileExpensesDetails();
                }
        ...
        {
            Response.Redirect("~/Office_Expences.aspx", false);
        }
        ...
        public void GetTotalAmount()
        {
            ...
            {
                SqlConnection conn = new SqlConnection(strconnect);
                SqlCommand cmd = new SqlCommand("SP_GetTotalAmountBillItemOfficeExpenses", conn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@OfiiceExpID", lblexpid2.Text);
                cmd.Parameters.AddWithValue("@Belong", "Office Expenses");
                SqlDataAdapter sda = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                if (dt.Rows.Count > 0)
        ...
        public DataTable ViewFileExpensesDetails()
        {
            ...
            using (SqlConnection con1 = new SqlConnection(strconnect))
            {
                SqlCommand com = new SqlCommand("SP_ViewFileOfficeExpensesDetails", con1);
                com.CommandType = CommandType.StoredProcedure;
                com.Parameters.AddWithValue("@OfficeID", lblexpid2.Text);
                com.Parameters.AddWithValue("@BelongTo", "Office Expenses");
                SqlDataAdapter da = new SqlDataAdapter(com);
                DataTable dt = new DataTable();
                da.Fill(dt);
