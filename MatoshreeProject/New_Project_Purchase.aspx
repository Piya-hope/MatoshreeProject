<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="New_Project_Purchase.aspx.cs" Inherits="MatoshreeProject.New_Project_Purchase" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                <h5 class="font-weight-medium  mb-0">New Project Purchase</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item text-muted" href="#">Expenses</li>
                        <li class="breadcrumb-item">
                            <a class="text-muted text-decoration-none" href="Project_Purchase.aspx">Project Purchase
                            </a>
                        </li>
                        <li class="breadcrumb-item text-muted" aria-current="page" href="#">New Project Purchase</li>
                    </ol>
                </nav>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-2">
                                ...
                                <asp:TextBox ID="txtPurchaseName" runat="server" placeholder="Enter Purchase Name" class="form-control"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldPurchase" runat="server" ErrorMessage="Enter Purchase Name" ControlToValidate="txtPurchaseName" ForeColor="Red" Font-Bold="false" ValidationGroup="Expense" Font-Size="12px"></asp:RequiredFieldValidator>
                            </div>

                            <div class="mb-2">
                                <asp:Label ID="lblNote" runat="server" Text="Note" CssClass="form-label"></asp:Label>&nbsp; 
                                <asp:TextBox ID="txtNote" runat="server" placeholder="Enter Purchase Note" class="form-control" TextMode="MultiLine"></asp:TextBox>
                                <%--<asp:RequiredFieldValidator ID="RequiredFieldNote" runat="server" ErrorMessage="Enter Purchase Note" ControlToValidate="txtNote" ForeColor="Red" Font-Bold="false" ValidationGroup="Purchase"  Font-Size="12px"></asp:RequiredFieldValidator>--%>
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                <asp:Label ID="lblPurchasesDate" runat="server" Text="Expense Date" CssClass="form-label"></asp:Label>&nbsp;<span style="color: #FF0000">*</span>
                                <asp:TextBox ID="txtPurchaseDate" type="date" CssClass="form-control" Style="display: inline-block;" runat="server" placeholder="Enter Purchases Date(mm/dd/yyyy)"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredPurchasestDate" runat="server" ErrorMessage="Enter Purchases Date" ControlToValidate="txtPurchaseDate" ForeColor="Red" Font-Bold="false" ValidationGroup="Expense" Font-Size="12px"></asp:RequiredFieldValidator>
                            </div>
                            <div class="mb-2">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldBillno" runat="server" ErrorMessage="Enter Expenses Bill Number" ControlToValidate="txtBillno" ForeColor="Red" Font-Bold="false" ValidationGroup="Expense" Font-Size="12px"></asp:RequiredFieldValidator>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <asp:UpdatePanel ID="UpdatePanelddlState" runat="server">
                                    <ContentTemplate>
                                        <div class="mb-2">
                                            ...
                                            <asp:DropDownList ID="ddlCustomer" runat="server" CssClass="form-control form-select" OnSelectedIndexChanged="ddlCustomer_SelectedIndexChanged" Placeholder="Select Customer" AutoPostBack="true">
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredCustomer" runat="server" ErrorMessage="Select Customer" ControlToValidate="ddlCustomer" ForeColor="Red" Font-Bold="false" ValidationGroup="Expense" InitialValue="0" Display="Dynamic" Font-Size="12px"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="mb-2">
                                            <asp:Label ID="lblProject" runat="server" Text="Project" CssClass="form-label"></asp:Label>&nbsp;<span style="color: #FF0000">*</span>
                                            <asp:DropDownList ID="ddlProject" runat="server" CssClass="form-control form-select" Placeholder="Select Project" AutoPostBack="true" OnSelectedIndexChanged="ddlProject_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        ...
                                        <div class="mb-2">
                                            <asp:Label ID="lblTenderid" runat="server" Text="Tender" CssClass="form-label"></asp:Label>&nbsp;<span style="color: #FF0000">*</span>
                                            <asp:DropDownList ID="ddlTenderNumber" runat="server" OnSelectedIndexChanged="ddlTenderNumber_SelectedIndexChanged" AutoPostBack="true" CssClass="form-control form-select" Placeholder="Select Tender">
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredTender" runat="server" ErrorMessage="Select Tender" ControlToValidate="ddlTenderNumber" ForeColor="Red" Font-Bold="false" ValidationGroup="Expense" InitialValue="0" Display="Dynamic" Font-Size="12px"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="mb-2">
                                            <asp:Label ID="lblWorkOrder" runat="server" Text="WorkOrder" CssClass="form-label"></asp:Label>&nbsp;<span style="color: #FF0000">*</span>
                                            <asp:DropDownList ID="ddlWorkOrderNumber" runat="server" CssClass="form-control form-select" OnSelectedIndexChanged="ddlWorkOrderNumber_SelectedIndexChanged" AutoPostBack="true" Placeholder="Select WorkOrder">
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Select WorkOrder" ControlToValidate="ddlWorkOrderNumber" ForeColor="Red" Font-Bold="false" ValidationGroup="Expense" InitialValue="0" Display="Dynamic" Font-Size="12px"></asp:RequiredFieldValidator>
                                        </div>
                                        <div id="vendorParameter" runat="server">
                                            <div class="mb-2">
                                                <div class="row">
                                                    <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">

                                                        <asp:Label ID="lblVenderName" runat="server" Text="VenderName:" CssClass="form-label"></asp:Label>
                                                    ...
                                                    <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                                                        ...
                                                        <asp:DropDownList ID="ddlVenName" runat="server" CssClass="form-control form-select" OnSelectedIndexChanged="ddlVenName_SelectedIndexChanged" AutoPostBack="true" Placeholder="Select VendorName"></asp:DropDownList>
                                            ...
                                            <div class="mb-2">
                                                <div class="row">
                                                    <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                                                        ...
                                                        <asp:Label ID="lblGstNo" runat="server" Text="GstNo:" CssClass="form-label"></asp:Label>

                                                        <asp:Label ID="lblGstNo1" runat="server" Text="" Font-Size="13.5px"></asp:Label>

                                                    </div>
                                                    <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                                                        <asp:Label ID="lblVenAddress" runat="server" Text="Address:" CssClass="form-label"></asp:Label>

                                                        <asp:Label ID="lblVenAddress1" runat="server" Text="" Font-Size="13.5px"></asp:Label>
                                                    </div>
                                                </div>
                                    ...
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="ddlVenName" EventName="SelectedIndexChanged" />
                                        <asp:AsyncPostBackTrigger ControlID="ddlWorkOrderNumber" EventName="SelectedIndexChanged" />
                                        <asp:AsyncPostBackTrigger ControlID="ddlTenderNumber" EventName="SelectedIndexChanged" />
                                ...
                                <div class="mb-2">
                                    <asp:Button ID="btnSavePurchase" runat="server" Text="Next" CssClass="btn btn-success btn-sm" ValidationGroup="Expense" OnClick="btnSavePurchase_Click" />
                                        ...
                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                            <div class="table-responsive">
                                                <asp:GridView ID="GridViewOffice" runat="server" ScrollBars="Both" CssClass="table border table-bordered table-hover text-nowrap align-content-center" AutoGenerateColumns="false" CellPadding="4" Style="width: 100%"
                                                    ClientIDMode="Static" Font-Bold="false" HeaderStyle-BackColor="#f8f9fa" HeaderStyle-ForeColor="Blue" HeaderStyle-Font-Bold="true" ShowFooter="true">
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <FooterTemplate>
                                                                <asp:LinkButton ID="btnAddProjectPItem" runat="server" CssClass="btn btn-sm btn-rounded btn-info" Text="" TabIndex="9" OnClick="btnAddProjectPItem_Click" ValidationGroup="ItemTender"><i class="ti ti-check"></i></asp:LinkButton>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                    ...
                                    <div class="container-fluid ">
                                        <div class="row">
                                            <asp:Table ID="Table2" runat="server" CssClass="col-md-12 col-sm-12 col-lg-12  font-bold">
                                                <asp:TableRow ID="TableRow3" runat="server" class="form-group">
                                                    <asp:TableCell CssClass="col-md-6 col-sm-6 col-lg-6">
                                                    </asp:TableCell>
                                                    <asp:TableCell CssClass="col-md-3 col-sm-3 col-lg-3">
                                                        <asp:Label ID="lblSubTotal" CssClass="float:left ms-2" runat="server" Text="Total Amount :"></asp:Label>
                                                    </asp:TableCell>
                                                    <asp:TableCell CssClass="col-md-3 col-sm-3 col-lg-3">
