...
{
    public partial class NewContactCustomer : System.Web.UI.Page
    {
        ...
        protected void btnSaveContacts_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                try
                {
                    ...
                    {
                        SqlCommand UserCommand = new SqlCommand("SP_SaveContactsDetails", UserCon);
                        UserCommand.Connection = UserCon;
                        UserCommand.CommandType = CommandType.StoredProcedure;
                        UserCommand.Parameters.AddWithValue("@Cust_ID", lblCustID1.Text);
