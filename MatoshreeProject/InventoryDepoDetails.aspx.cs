...
{
    public partial class InventoryDepoDetails : System.Web.UI.Page
    {
        ...
        public DataTable ViewInventoryDepoDetailsByEmpID(int UserID)
        {
            DataTable table = new DataTable();
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                SqlCommand cmd = new SqlCommand("SP_InventoryDepoDetailsByEmpID", con);
                cmd.CommandTimeout = 600;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@EmpID", UserID);
                SqlDataAdapter ad = new SqlDataAdapter(cmd);
                ad.Fill(table);
                GridDepo.DataSource = table;
                GridDepo.DataBind();
                ViewState["DataDepo"] = table;
            }
            return table;
        }

        public void InventoryDepoCountByEmpID(int UserID)
        {
            try
            {
                //-------------TotalCount----------------------//
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetTotalInventoryDepoCountbyEmpID", con);
                ...
                {
                    con1.Open();
                    SqlCommand command = new SqlCommand("SP_GetActiveInventoryDepoCountbyEmpID", con1);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@EmpID", UserID);
                ...
                {
                    con2.Open();
                    SqlCommand command = new SqlCommand("SP_GetInActiveInventoryDepoCountbyEmpID", con2);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@EmpID", UserID);
        ...
        public DataTable ViewInventoryDepoDetails()
        {
            DataTable table = new DataTable();
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                using (SqlDataAdapter ad = new SqlDataAdapter("SP_InventoryDepo_Details", con))
                {
                    ad.Fill(table);
                    GridDepo.DataSource = table;
                    GridDepo.DataBind();
        ...
        public void InventoryDepoCount()
        {
            try
            {
                //-------------TotalCount----------------------//
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetTotalInventoryDepoCount", con);
                    command.CommandType = CommandType.StoredProcedure;
                    int totalVendorsCount = (int)command.ExecuteScalar();
                ...
                {
                    con1.Open();
                    SqlCommand command = new SqlCommand("SP_GetActiveInventoryDepoCount", con1);
                    command.CommandType = CommandType.StoredProcedure;
                    int activeVendorsCount = (int)command.ExecuteScalar();
                ...
                {
                    con2.Open();
                    SqlCommand command = new SqlCommand("SP_GetInactiveInventoryDepoCount", con2);
                    command.CommandType = CommandType.StoredProcedure;
                    int inactiveVendorsCount = (int)command.ExecuteScalar();
        ...
        public void StaffOperationPermission()
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(strconnect))
                {
                    ...
                    command.Parameters.AddWithValue("@SubModule", "InventoryDepo");
                    DataTable dt = new DataTable();
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        {
                            ViewInventoryDepoDetailsByEmpID(UserId);
                            InventoryDepoCountByEmpID(UserId);
                            GetCompanyAddress();
        ...
        protected void btnNewDepo_Click(object sender, EventArgs e)
        {
            Response.Redirect("NewInventory_Depo.aspx");
        }
        ...
        protected void lnkbtnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    DataTable dt = ViewInventoryDepoDetails();
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        Response.Clear();
                        Response.Buffer = true;
                        Response.ContentType = "application/ms-excel";
                        Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "InventoryDepo_Details " + DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss") + ".xls"));
                        ...
                        dtExport.Columns.Add("GSTNo");
                        dtExport.Columns.Add("ShopKeeper");
                        dtExport.Columns.Add("Address");
                        dtExport.Columns.Add("Status");
                        dtExport.Columns.Add("CreatedDate");
                        ...
                        foreach (DataRow row in dt.Rows)
                        {
                            ...
                            newRow["ID"] = row["DepoID"];
                            newRow["DepoName"] = row["DepoName"];
                            newRow["Phone"] = row["DepoContact"];
                            newRow["Email"] = row["Email"];
                            newRow["GSTNo"] = row["GST_No"];
                            newRow["ShopKeeper"] = row["ShopKeeperName"];
                            newRow["Address"] = row["Address"];
                            newRow["Status"] = row["Status"];
                            newRow["CreatedDate"] = row["Created_Date"];
                ...
                {
                    DataTable dt = (DataTable)ViewState["DataDepo"];
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        Response.Clear();
                        Response.Buffer = true;
        ...
        protected void linkbtnPDF_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
                {
                    ...
                    _document.Open();
                    _pdfPTable.SetWidths(new float[] { 4f, 10f, 11f, 11f, 14f, 7f, 11f });//column width in doc       
                    //----Header PDF--------------------------//
                    //Company Logo
                    ...
                    _fontStyle = FontFactory.GetFont("Arial", 14f, 2);
                    _pdfPCell = new PdfPCell(new Phrase("InventoryDepoList", _fontStyle));
                    _pdfPCell.Colspan = 4;
                    ...
                    _Vhrlist = ViewInventoryDepoDetails();
                    #region "Table Header"
                    ...
                    _fontStyle = FontFactory.GetFont("Tahoma", 9f, 1, BaseColor.WHITE);
                    _pdfPCell = new PdfPCell(new Phrase("ShopKeeper", _fontStyle));
                    _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                    _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                    _pdfPCell.BackgroundColor = BaseColor.GRAY;
                    _pdfPCell.ExtraParagraphSpace = 2;
                    ...
                    foreach (DataRow row in _Vhrlist.Rows)
                    {
                        ...
                        _pdfPCell = new PdfPCell(new Phrase(row["DepoContact"].ToString(), _fontStyle));
                        _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                        _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                        _pdfPCell.BackgroundColor = BaseColor.WHITE;
                        _pdfPCell.ExtraParagraphSpace = 1;
                        ...
                        _pdfPCell = new PdfPCell(new Phrase(row["ShopKeeperName"].ToString(), _fontStyle));
                        _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                        _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                        _pdfPCell.BackgroundColor = BaseColor.WHITE;
                        _pdfPCell.ExtraParagraphSpace = 1;
                    ...
                    string PDFFileName = string.Format("InventoryDepoList_" + dTime.ToString("dd/MM/yyyy HH:mm") + ".pdf");
                    Response.Clear();
        ...
        protected void BTN_Visibility_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    ...
                    using (SqlConnection con = new SqlConnection(strconnect))
                    {
                        using (SqlDataAdapter ad = new SqlDataAdapter("SP_InventoryDepoDetailsVisibility", con))
                        {
                            ad.Fill(table);
                            GridDepo.DataSource = table;
                            GridDepo.DataBind();
        ...
        protected void GridDepo_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                foreach (GridViewRow gridviewrow in GridDepo.Rows)
                {
                    // string  Status = Convert.ToString(e.Row.Cells[8].Text);

                    Label lblInventoryID1 = (Label)gridviewrow.FindControl("lblInventoryID1");
                    Label lblDepoName1 = (Label)gridviewrow.FindControl("lblDepoName1");
                    Label lblDepoContact1 = (Label)gridviewrow.FindControl("lblDepoContact1");
                    //Label lblEmail1 = (Label)gridviewrow.FindControl("lblEmail1");
                    //Label lblGST1 = (Label)gridviewrow.FindControl("lblGST1");
                      Label lblAddress1 = (Label)gridviewrow.FindControl("lblAddress1");
                    Label lblCreateDate1 = (Label)gridviewrow.FindControl("lblCreateDate1");
                    Label lblStatus1 = (Label)gridviewrow.FindControl("lblStatus1");

                    string status = ((Label)gridviewrow.FindControl("lblStatus1")).Text;
                    if (status == "True")
                    {
                        lblInventoryID1.ForeColor = System.Drawing.Color.Blue;
                        lblDepoName1.ForeColor = System.Drawing.Color.Blue;
                        lblDepoContact1.ForeColor = System.Drawing.Color.Blue;
                        //lblEmail1.ForeColor = System.Drawing.Color.Blue;
                        //lblGST1.ForeColor = System.Drawing.Color.Blue;
                        lblAddress1.ForeColor = System.Drawing.Color.Blue;
                    ...
                    else
                    {
                        ...
                        lblInventoryID1.ForeColor = System.Drawing.Color.Red;
                        lblDepoName1.ForeColor = System.Drawing.Color.Red;
                        lblDepoContact1.ForeColor = System.Drawing.Color.Red;
                        //lblEmail1.ForeColor = System.Drawing.Color.Red;
                        //lblGST1.ForeColor = System.Drawing.Color.Red;
                        
                        lblAddress1.ForeColor = System.Drawing.Color.Red;
        ...
        protected void btnEditDepo_Click1(object sender, EventArgs e)
        {
            try
            {
                DeviceCon = new SqlConnection(strconnect);
                string tableID;
                var rows = GridDepo.Rows;
                LinkButton btn = (LinkButton)sender;
                GridViewRow row = (GridViewRow)btn.NamingContainer;
                int rowindex = Convert.ToInt32(row.RowIndex);
                tableID = ((Label)rows[rowindex].FindControl("lblInventoryID1")).Text;

                Response.Redirect("~/Edit_InventoryDepo.aspx?ID=" + tableID + "", false);
            }
            catch (Exception ex)
            {
                using (SqlConnection UserCon = new SqlConnection(strconnect))
        ...
        protected void btnDeleteDepo_Click(object sender, EventArgs e)
        {
            try
            {
                RoleType = Session["LoginType"].ToString();
                ...
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    ...
                    GridViewRow row = (GridViewRow)btn.NamingContainer;
                    int rowindex = Convert.ToInt32(row.RowIndex);
                    ID = ((Label)rows[rowindex].FindControl("lblInventoryID1")).Text;

                    SqlConnection DeviceCon = new SqlConnection(strconnect);
                    SqlCommand cmd = new SqlCommand("SP_DeleteInventoryDepo", DeviceCon);
                    cmd.CommandType = CommandType.StoredProcedure;
                    ...
                    if (i < 0)
                    {
                        this.Page.ClientScript.RegisterStartupScript(this.GetType(), "alert", "alert('Inventory Depo Deleted Successfully!')", true);

                        ViewInventoryDepoDetails();
                    }
                    else
                    {
                        this.Page.ClientScript.RegisterStartupScript(this.GetType(), "alert", "alert('Inventory Depo Not Deleted!')", true);
                    }
                }
                else if (RoleType == Designation)
                {
                    ...
                    SqlConnection DeviceCon = new SqlConnection(strconnect);
                    SqlCommand cmd = new SqlCommand("SP_DeleteInventoryDepobyEmpID", DeviceCon);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", ID);
                    cmd.Parameters.AddWithValue("@Created_by", UserName);
                    cmd.Parameters.AddWithValue("@EmpID", UserId);
