...
namespace MatoshreeProject
{
    public partial class Attendence : System.Web.UI.Page
    {
        ...
        public void StaffOperationPermission()
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(strconnect))
                {
                    ...
                    command.Parameters.AddWithValue("@SubModule", "Attendance");
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        {
                            ViewAttendenceDetailsEmpID(UserId);
                            AttendenceCount();
                            GetCompanyAddress();
        ...
        public DataTable ViewAttendenceDetailsEmpID(int UserID)
        {
            DataTable table = new DataTable();
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                SqlCommand cmd = new SqlCommand("SP_ViewAttendenceByStaffID", con);
                ...
                ViewState["AttendenceData"] = table;
            }
            return table;
        }
        //---------------------------------------------------------------------------//

        public DataTable ViewAttendenceDetails()
        {
            DataTable table = new DataTable();
            using (SqlConnection con = new SqlConnection(strconnect))
            {
                using (SqlDataAdapter ad = new SqlDataAdapter("SP_ViewAttendence", con))
                {
                    ad.Fill(table);
                    GridAttendence.DataSource = table;
                    GridAttendence.DataBind();
        ...
        public void AttendenceCount()
        {
            try
            {
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetTotalStaffCount", con);
                    command.CommandType = CommandType.StoredProcedure;
                    int totalVendorsCount = (int)command.ExecuteScalar();

                    lblTotalStaffCount.Text = Convert.ToString(totalVendorsCount);
                }
                ...
                {
                    con1.Open();
                    SqlCommand command = new SqlCommand("SP_GetActiveStaffCount", con1);
                    command.CommandType = CommandType.StoredProcedure;
                    int activeVendorsCount = (int)command.ExecuteScalar();

                    lblActiveStaffCount.Text = Convert.ToString(activeVendorsCount);
                }
                ...
                {
                    con2.Open();
                    SqlCommand command = new SqlCommand("SP_GetInActiveStaffCount", con2);
                    command.CommandType = CommandType.StoredProcedure;
                    int inactiveVendorsCount = (int)command.ExecuteScalar();

                    lblInActiveStaffCount.Text = Convert.ToString(inactiveVendorsCount);
                }
                ...
                {
                    con.Open();
                    SqlCommand command = new SqlCommand("SP_GetPresentStaffTodayCount", con);
                    command.CommandType = CommandType.StoredProcedure;
                    int totalVendorsCount = (int)command.ExecuteScalar();

                    lblPresentCount.Text = Convert.ToString(totalVendorsCount);
                }
                ...
                //{
                //    con1.Open();
                //    SqlCommand command = new SqlCommand("", con1);
                //    command.CommandType = CommandType.StoredProcedure;
                //    int activeVendorsCount = (int)command.ExecuteScalar();

                //    lblLateCount.Text = Convert.ToString(activeVendorsCount);
                //}
                ...
                //{
                //    con2.Open();
                //    SqlCommand command = new SqlCommand("", con2);
                //    command.CommandType = CommandType.StoredProcedure;
                //    int inactiveVendorsCount = (int)command.ExecuteScalar();

                //    lblOnLeaveCount.Text = Convert.ToString(inactiveVendorsCount);
                //}
            }
            catch (Exception ex)
            {
        ...
        protected void lnkbtnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    DataTable dt = ViewAttendenceDetails();
                ...
                {
                    DataTable dt = (DataTable)ViewState["AttendenceData"];
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        Response.Clear();
                        Response.Buffer = true;
        ...
        protected void btnViewAttendence_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string tableID;
                var rows = GridAttendence.Rows;
                LinkButton btn = (LinkButton)sender;
                GridViewRow row = (GridViewRow)btn.NamingContainer;
                int rowindex = Convert.ToInt32(row.RowIndex);
                tableID = ((Label)rows[rowindex].FindControl("lblID1")).Text;

                Response.Redirect("~/ViewStaffAttendence.aspx?ID=" + tableID + "", false);
            }
            catch (Exception ex)
            {
                using (SqlConnection DeviceCon = new SqlConnection(strconnect))
            ...
            try
            {
                if (Session["LoginType"].ToString() == "Administrator")
                {
                    ...
                    using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
                    {
                        ...
                        _Vhrlist = ViewAttendenceDetails();
                        #region "Table Header"
                ...
                else if (RoleType == Designation)
                {
                    ...
                    using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
                    {
                        ...
                        DataTable _Vhrlist = new DataTable();
                        _Vhrlist = (DataTable)ViewState["AttendenceData"];
                        #region "Table Header"
