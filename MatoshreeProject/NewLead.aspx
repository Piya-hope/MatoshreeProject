<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="NewLead.aspx.cs" Inherits="MatoshreeProject.NewLead" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 col-sm-8 col-xl-8 col-lg-8">
                <h5 class="font-weight-medium mb-0">New Lead</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-muted" aria-current="page" href="NewLead.aspx">New Lead</li>
                    </ol>
                </nav>
                <%-- BreadCrumbs --%>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-xl-4 col-lg-4">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter Status Name" ControlToValidate="txtStatusName" ForeColor="Red" Font-Bold="false" InitialValue="0" ValidationGroup="NewLead"></asp:RequiredFieldValidator>
                                                </div>
                                            </div>
                                            <br />
                            ...
                            <asp:RequiredFieldValidator ID="Requiredstatus" runat="server" ControlToValidate="ddlStatus" ForeColor="Red" Font-Size="12px" Font-Bold="false" InitialValue="0" Display="Dynamic" ValidationGroup="NewLead" ErrorMessage="Select Satus"></asp:RequiredFieldValidator>
                        </div>

                        <div class="col-md-4 col-sm-4 col-xl-4 col-lg-4">
                            <asp:Label ID="lblSorce" runat="server" Text="Source" CssClass="form-label"></asp:Label>
                            &nbsp;<span style="color: #FF0000">*</span><br>
                            <div class="input-group">
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <hr />
                                                <div class="mb-2">
                                                    <asp:Label ID="Label1" runat="server" Text="SourceName" CssClass="form-label"></asp:Label>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredSource" runat="server" ControlToValidate="ddlSource" ForeColor="Red" Font-Size="12px" Font-Bold="false" InitialValue="0" Display="Dynamic" ValidationGroup="NewLead" ErrorMessage="Select Source"></asp:RequiredFieldValidator>
                        </div>
                        ...
                        <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="updatePanel1">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xl-6 col-lg-6">
                                        <div class="mb-2">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Display="Dynamic" ControlToValidate="txtName" ErrorMessage="Enter Name" ForeColor="Red" ValidationGroup="NewLead" Font-Size="12px"></asp:RequiredFieldValidator>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xl-6 col-lg-6">
                                        <div class="mb-2">
                                            ...
                                            <asp:RequiredFieldValidator ID="rvfEmail" runat="server" Display="Dynamic" ControlToValidate="txtEmail" ErrorMessage="Enter Email Address" ForeColor="Red" ValidationGroup="NewLead" Font-Size="12px"></asp:RequiredFieldValidator>
                                            <asp:RegularExpressionValidator ID="Regulexemail" runat="server" ControlToValidate="txtEmail" ErrorMessage="Email Address Invalid." ForeColor="Red" ValidationGroup="NewLead" ValidationExpression="^\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$" Font-Size="12px"></asp:RegularExpressionValidator>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xl-6 col-lg-6">
                                        <div class="mb-2">
                                            ...
                                            <asp:TextBox ID="txtPhone" runat="server" placeholder="Enter Phone" class=" form-control" MaxLength="10" TextMode="Phone"></asp:TextBox>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xl-6 col-lg-6">
                                        <div class="mb-2">
                                            ...
                                            <asp:TextBox ID="txtLeadValue" runat="server" placeholder="Enter Lead Value" class="form-control">0.00</asp:TextBox>
                            ...
                            <asp:CheckBox ID="chkContracted" runat="server" Text="Contracted Today" />
                                ...
                                <div class="row">
                                    <div class="mb-2">
                                        <asp:Button ID="btnSaveLead" runat="server" Text="Save" CssClass="btn btn-sm btn-primary" ValidationGroup="NewLead" OnClick="btnSaveLead_Click" />
                            ...
                            <Triggers>
                                ...
                                <asp:AsyncPostBackTrigger ControlID="btnSaveLead" EventName="Click" />
