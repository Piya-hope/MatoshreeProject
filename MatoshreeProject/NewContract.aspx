<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="NewContract.aspx.cs" Inherits="MatoshreeProject.NewContract" %>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                 ...
                 <li class="breadcrumb-item">
                    <a class="text-muted text-decoration-none" href="Contract.aspx">Contract Customer
                    </a>
                </li>
                <li class="breadcrumb-item text-muted" aria-current="page" href="#">New Contract Customer</li>
            </ol>
        </nav>
        </div>
            <%-- Toaster --%>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-2">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFielddlCustomer" runat="server" ErrorMessage="Select Customer" ControlToValidate="ddlCustomer" ForeColor="Red" Font-Bold="false" ValidationGroup="Contract" InitialValue="0" Display="Dynamic"  Font-Size="12px"></asp:RequiredFieldValidator>
                        </div>
                        <div class="mb-2">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter Contract Subject" ControlToValidate="txtSubject" ForeColor="Red" Font-Bold="false" ValidationGroup="Contract"  Font-Size="12px"></asp:RequiredFieldValidator>
                        </div>
                        <div class="row">
                            <div class="mb-2">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="txtContractValue" runat="server" placeholder="Contract Value" type="number" name="hourly_rate" value="0" class="form-control" aria-invalid="false" Style="width: 132%" MaxLength="10"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldcontractvalue" runat="server" ErrorMessage="Enter Contract Value" ControlToValidate="txtContractValue" ForeColor="Red" Font-Bold="false" ValidationGroup="Contract"  Font-Size="12px"></asp:RequiredFieldValidator>
                                    <%--<cc1:NumericUpDownExtender ID="NumericUpDownExtender1" runat="server" TargetControlID="txtContractValue" Maximum="100000000" Minimum="100" BehaviorID="txtContractValue" Width="350"/>--%>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldcontracttype" runat="server" ErrorMessage="Select Contract Type" ControlToValidate="ddlContracttype" ForeColor="Red" Font-Bold="false" ValidationGroup="Contract" InitialValue="0" Display="Dynamic"  Font-Size="12px"></asp:RequiredFieldValidator>
                        </div>
                        ...
                        <div class="mb-2">
                            <asp:Button ID="btnSaveContract" runat="server" Text="Save" CssClass="btn btn-sm btn-primary" ValidationGroup="Contract" OnClick="btnSaveContract_Click" />
                            &nbsp;&nbsp;
                                    ...
                                    <div class="row">
                                      ...
                                      <asp:LinkButton ID="LinkbtnEmail" runat="server" CssClass="btn btn-sm btn-outline-primary" title="Email"><iconify-icon icon="ph:envelope-thin"></iconify-icon> </asp:LinkButton>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                            <div class="mb-2">
                                                <asp:LinkButton ID="linkbtnMergeField" runat="server" Font-Size="12px" OnClick="linkbtnMergeField_Click">Availables Merge Fields</asp:LinkButton><br />
                                                <div class="row">
                                                    ...
                                                    <div class="table-responsive h-25">
                                                        <table class="table table-bordered" id="tblcontract" runat="server" visible="false">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-right">
                                                                    <asp:LinkButton ID="LinkButtonadmin_url" runat="server" Font-Size="12px" Text="{admin_url}" OnClick="LinkButtonadmin_url_Click"></asp:LinkButton>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-right">
                                                                    <asp:LinkButton ID="Linkclear" runat="server" Font-Size="12px" Text="{clear}" OnClick="Linkclear_Click" ForeColor="Red"></asp:LinkButton>
                                                                </td>
                                                            </tr>
