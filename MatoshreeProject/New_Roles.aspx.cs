...
{
    public partial class New_Roles : System.Web.UI.Page
    {
        ...
        public void GetPermission()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SP_GetWebPages", con);
        ...
        public void Clear()
        {
            txt_Role_Name.Text = string.Empty;
            CheckBox chkAllGlobal = (CheckBox)GridRole.HeaderRow.FindControl("chkAllGlobal");
            CheckBox chkAllView = (CheckBox)GridRole.HeaderRow.FindControl("chkAllView");
            CheckBox chkAllEdit = (CheckBox)GridRole.HeaderRow.FindControl("chkAllEdit");
            CheckBox chkAllCreate = (CheckBox)GridRole.HeaderRow.FindControl("chkAllCreate");
            CheckBox chkAllDelete = (CheckBox)GridRole.HeaderRow.FindControl("chkAllDelete");

            chkAllGlobal.Checked = false;
            chkAllView.Checked = false;
            chkAllEdit.Checked = false;
            chkAllCreate.Checked = false;
            ...
            foreach (GridViewRow gvrow in GridRole.Rows)
            {
                ...
                if (chkGlobalView != null)
                    chkGlobalView.Checked = false;
        ...
        protected void chkAllGlobal_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                CheckBox chkAllGlobal = (CheckBox)GridRole.HeaderRow.FindControl("chkAllGlobal");
                CheckBox chkAllView = (CheckBox)GridRole.HeaderRow.FindControl("chkAllView");
                foreach (GridViewRow row in GridRole.Rows)
                {
